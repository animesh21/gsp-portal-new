...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  if (!empty($teachers)) {
    ...
    if ($teacher->name_of_participant !="") {
        ...
        <div class='image'><img src='assets/img/images/feb.jpg' width='1000' height='700'></div>";
  ...
  echo  "<div class='school_name1'>". strtoupper($teacher->school_name)."</div>";
    ...
    echo "<div class='school_name'>". strtoupper($teacher->school_name). "</div>";
        ...
        echo "<div class='certificateno'>Certificate No : "."GSP Capacity Building Workshop/2021/01/0".$teacher->id." </div>
   </div> ";
    }
    }
  }
