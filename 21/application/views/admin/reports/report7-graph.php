...
<script type="text/javascript">
        Highcharts.chart('container',{
            ...
            title: {
                text: '<?php echo getStateById($state_id1); ?> Schools Performance'
            },
            tooltip: {
...
<script type="text/javascript">
        Highcharts.chart('container2',{
            ...
            title: {
                text: '<?php echo getStateById($state_id2); ?> Schools Performance'
            },
            tooltip: {
                pointFormat: '<b>{point.y} Schools ({point.percentage:.1f}%)</b>'
            },
            ...
            series: [{
                colorByPoint: true,
                data: [{name: '70% and above',color:'#00ae4f',y: <?php echo $performance_1_2; ?>}, {name: 'Between 50% to 69.9%',color:'#fcfc00',y: <?php echo $performance_2_2; ?>}, {name: 'Between 35% to 49.9%',color:'#fc9700',y: <?php echo $performance_3_2; ?>}, {name: 'Between 0% to 34.9%',color:'#fc3300',y: <?php echo $performance_4_2; ?>}]
            }]
        });
		</script>
