<div class="top-area">
        <h2>Schools Completed & Submitted The Audit<a href="<?php echo base_url('admin/audit_started/combinded_submitcount') ?>"><button class="exportBtn">Export to Excel</button></a></h2>
</div>
