<div class="top-area">
        <h2>2019 Total School Registrations <a href="<?php echo base_url('admin/audit_started/combinded_total_school') ?>"><button class="exportBtn">Export to Excel</button></a></h2>
         </div>
