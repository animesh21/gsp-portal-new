...
<ul class="list-unstyled">
  ...
  <input type="checkbox" name="Q9E1S101" id="Q9E1S101" value="<?php echo set_value('Q9E1S101', 1); ?>" <?php if (isset($data['Q9E1S101'])) echo $data['Q9E1S101'] == '1' ? "checked" : "" ?>/>
              ...
              <input type="radio" name="Q23R1" id="Q23R1" value="<?php echo set_value('Q23R1', '1') ?>" <?php if (isset($data['Q23R1'])) echo $data['Q23R1'] == '1' ? "checked" : "" ?>/>
              <label>Biogas</label>
              </div>
              ...
              <input type="radio" name="Q23R1" value="<?php echo set_value('Q23R1', '2') ?>" <?php if (isset($data['Q23R1'])) echo $data['Q23R1'] == '2' ? "checked" : "" ?>/>
              <label>Biomass</label>
              </div>
            </div>
...
if ($('#Q43E1').is(":checked"))
{
 ...
 $(document).ready(function(){
  ...
  if ($('#Q23R1').is(":checked"))
{
  $('.Q23R1_radio').css('display', 'block');
}
else{

  $('.Q23R1_radio').css('display', 'none');
}

 });

$("input[name='Q23R1']").click(function(){
