<div class="top-area">
        <h2>Schools Started The Audit But Did Not Complete<a href="<?php echo base_url('admin/audit_started_2017/excelByProgress_phase2/'); ?>"><button class="exportBtn">Export to Excel</button></a></h2>
</div>
...
<!--            <th>Reg. Date</th>-->
        ...
        <tbody>
          <?php $i=1; foreach($uncomplete as $r){ ?>
		...
		<td><?php echo $r->udise; ?></td>
                ...
                <td><?php echo $r->progress_phase_2; ?></td>
