<div class="top-area">
        <h2>Schools Did Not Start The Audit<a href="<?php echo base_url('admin/audit_started_2017/excelByProgress6_phase2') ?>"><button class="exportBtn">Export to Excel</button></a></h2>
</div>
