...
<div class="top-area">
  <h2>REGISTRATION 2019 <a href="<?php echo base_url('admin/audit_started_2017/excel_phase1') ?>">
...
<script type="text/javascript">
             ...
             else if(row.partner_status==6 && row.satya_foundation_status==1 ) {
              ...
              else if(row.partner_status==6 && row.satya_foundation_status==2 ) {
