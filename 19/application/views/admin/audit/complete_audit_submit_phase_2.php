<div class="top-area">
        <h2>Schools Completed & Submitted The Audit<a href="<?php echo base_url('admin/audit_started_2017/excelByProgress4_phase2') ?>"><button class="exportBtn">Export to Excel</button></a></h2>
</div>
...
<!--            <th>Reg. Date</th>-->
        ...
        <tbody>
          <?php $i=1; foreach($complete_submit as $r){ ?>
