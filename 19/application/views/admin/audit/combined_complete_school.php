<div class="top-area">
        <h2>2019 Total Schools Completed The Audit<a href="<?php echo base_url('admin/audit_started_2017/combinded_completecount') ?>"><button class="exportBtn">Export to Excel</button></a></h2>
</div>
