...
<td><?php 
$Q6E1=getFiled('Q6E1',$record1[$i]->userid);
if(!empty($Q6E1)){ if(strcmp($Q6E1,"Y")==0){echo "Yes";}else if(strcmp($Q6E1,"N")==0){echo "No";} }else{ echo "000.000"; } ?></td>
<td><?php 
$Q6E2=getFiled('Q6E2',$record1[$i]->userid);
if(!empty($Q6E2)){ if(strcmp($Q6E2,"Y")==0){echo "Yes";}else if(strcmp($Q6E2,"N")==0){echo "No";} }else{ echo "000.000"; } ?></td>
<td><?php 
$Q6E3=getFiled('Q6E3',$record1[$i]->userid);
if(!empty($Q6E3)){ if(strcmp($Q6E3,"Y")==0){echo "Yes";}else if(strcmp($Q6E3,"N")==0){echo "No";} }else{ echo "000.000"; } ?></td>
<td><?php 
$Q6E4=getFiled('Q6E4',$record1[$i]->userid);
if(!empty($Q6E4)){ if(strcmp($Q6E4,"Y")==0){echo "Yes";}else if(strcmp($Q6E4,"N")==0){echo "No";} }else{ echo "000.000"; } ?></td>
<td><?php 
$Q6E5=getFiled('Q6E5',$record1[$i]->userid);
if(!empty($Q6E5)){ if(strcmp($Q6E5,"Y")==0){echo "Yes";}else if(strcmp($Q6E5,"N")==0){echo "No";} }else{ echo "000.000"; } ?></td>
<td><?php 
$Q6E6=getFiled('Q6E6',$record1[$i]->userid);
if(!empty($Q6E6)){ if(strcmp($Q6E6,"Y")==0){echo "Yes";}else if(strcmp($Q6E6,"N")==0){echo "No";} }else{ echo "000.000"; } ?></td>
<td><?php 
$Q6E7=getFiled('Q6E7',$record1[$i]->userid);
if(!empty($Q6E7)){ if(strcmp($Q6E7,"Y")==0){echo "Yes";}else if(strcmp($Q6E7,"N")==0){echo "No";} }else{ echo "000.000"; } ?></td>
<td><?php 
$Q6E16=getFiled('Q6E16',$record1[$i]->userid);
if(!empty($Q6E16)){ if(strcmp($Q6E16,"Y")==0){echo "Yes";}else if(strcmp($Q6E16,"N")==0){echo "No";} }else{ echo "000.000"; } ?></td>
<td><?php 
$Q6E8=getFiled('Q6E8',$record1[$i]->userid);
if(!empty($Q6E8)){ if(strcmp($Q6E8,"Y")==0){echo "Yes";}else if(strcmp($Q6E8,"N")==0){echo "No";} }else{ echo "000.000"; } ?></td>
<td><?php 
$Q6E9=getFiled('Q6E9',$record1[$i]->userid);
if(!empty($Q6E9)){ if(strcmp($Q6E9,"Y")==0){echo "Yes";}else if(strcmp($Q6E9,"N")==0){echo "No";} }else{ echo "000.000"; } ?></td>
<td><?php 
$Q6E10=getFiled('Q6E9',$record1[$i]->userid);
if(!empty($Q6E10)){ if(strcmp($Q6E10,"Y")==0){echo "Yes";}else if(strcmp($Q6E10,"N")==0){echo "No";} }else{ echo "000.000"; } ?></td>
<td><?php 
$Q6E11=getFiled('Q6E11',$record1[$i]->userid);
if(!empty($Q6E11)){ if(strcmp($Q6E11,"Y")==0){echo "Yes";}else if(strcmp($Q6E11,"N")==0){echo "No";} }else{ echo "000.000"; } ?></td>
<td><?php 
$Q6E12=getFiled('Q6E12',$record1[$i]->userid);
if(!empty($Q6E12)){ if(strcmp($Q6E12,"Y")==0){echo "Yes";}else if(strcmp($Q6E12,"N")==0){echo "No";} }else{ echo "000.000"; } ?></td>
<td><?php 
$Q6E13=getFiled('Q6E11',$record1[$i]->userid);
if(!empty($Q6E13)){ if(strcmp($Q6E13,"Y")==0){echo "Yes";}else if(strcmp($Q6E13,"N")==0){echo "No";} }else{ echo "000.000"; } ?></td>
<td><?php 
$Q6E14=getFiled('Q6E14',$record1[$i]->userid);
if(!empty($Q6E14)){ if(strcmp($Q6E14,"Y")==0){echo "Yes";}else if(strcmp($Q6E14,"N")==0){echo "No";} }else{ echo "000.000"; } ?></td>
...
if(( $record1[$i]->Q9E1S3)!='1'){ echo '000.000'; }
?></td>
...
if(( $record1[$i]->Q9E1S4)!='1'){ echo '000.000'; }	
?></td>
...
<td><?php if($record1[$i]->Q4Wa2==1){echo "Two";}else if($record1[$i]->Q4Wa2==2){echo "Three";}else if($record1[$i]->Q4Wa2==3){echo "More than three";}else{ echo "000.000";}?></td>
...
<td><?php  
    $Q9Wa4S1=getFiled('Q9Wa4S1',$record1[$i]->userid);
	$Q9Wa4S2=getFiled('Q9Wa4S2',$record1[$i]->userid);
	$Q9Wa4S3=getFiled('Q9Wa4S3',$record1[$i]->userid);
	$Q9Wa4S4=getFiled('Q9Wa4S4',$record1[$i]->userid);
    if(!empty($Q9Wa4S1)){if($Q9Wa4S1==1){ echo "For horticultural purposes".",";}}
    if(!empty($Q9Wa4S2)){if($Q9Wa4S2==1){ echo "For school garden".",";}}
    if(!empty($Q9Wa4S3)){if($Q9Wa4S3==1){ echo "For sale".",";}}
    if(!empty($Q9Wa4S4)){if($Q9Wa4S4==1){ echo "For charity".",";}} ?></td>
...
<td><?php 
        if($record1[$i]->Q13Wa2==1){
		  echo "Kabadiwalla/ Scrapdealer";
		}elseif($record1[$i]->Q13Wa2==2){
		  echo "Taken back by manufacturer/vendor";
		}elseif($record1[$i]->Q13Wa2==3){
		  echo "Authorised dealer";
		}elseif($record1[$i]->Q13Wa2==4){
