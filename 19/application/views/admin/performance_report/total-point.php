...
<!-- new energy field start from here.... -->
				...
				<th>Non-solar-Bio-fuel-Biogas/biomass</th>
				<!-- <th>Biogas- Cooking/electricity</th> -->
				<th>Non Solar-Wind</th>
				<th>Non solar-Small hydro</th>
				<th>Non solar-Other</th>
		...
		?>
    		...
    		<td><?php echo $record1[$i]->air_points; ?></td>
			  ...
			  <td><?php echo $record1[$i]->Q4E1; ?></td>
                ...
                <td><?php echo $record1[$i]->Q16E1; ?></td>
                <td><?php echo $record1[$i]->Q19E1; ?></td>
                <td><?php  if($record1[$i]->Q9E1S1020=='1'){echo "chekbox 1, ";}
                if($record1[$i]->Q9E1S1021=='2'){echo "chekbox 2, ";}
                if($record1[$i]->Q9E1S1022=='3'){echo "chekbox 3, ";}
                if($record1[$i]->Q9E1S1023=='4'){echo "chekbox 4, ";}
                if($record1[$i]->Q9E1S1020!='1' && $record1[$i]->Q9E1S1020!='2' && $record1[$i]->Q9E1S1020!='3' && $record1[$i]->Q9E1S1020!='4'  ){echo "000.000";} ?></td>
                <td><?php echo $record1[$i]->Q9E1S101; ?></td>                 
                <td><?php echo $record1[$i]->Q9E1S102; ?></td>
                ...
                <td><?php if($record1[$i]->Q9E1S1026=='1'){echo "chekbox 1, ";}
                if($record1[$i]->Q9E1S1027=='2'){echo "chekbox 2";}
                if($record1[$i]->Q9E1S1026!='1' && $record1[$i]->Q9E1S1027!='2') { echo "000.000" ;} ?></td>
                 
                <td><?php if($record1[$i]->Q9E1S106=='1'){echo "chekbox 1, ";}
                if($record1[$i]->Q9E1S107=='2'){echo "chekbox 2, ";}
                if($record1[$i]->Q9E1S108=='3'){echo "chekbox 3, ";}
                if($record1[$i]->Q9E1S109=='4'){echo "chekbox 4, ";}
                if($record1[$i]->Q9E1S1010=='5'){echo "chekbox 5, ";}
                if($record1[$i]->Q34E1!=''){echo $record1[$i]->Q34E1;}
                if($record1[$i]->Q9E1S106!='1' && $record1[$i]->Q9E1S107!='2' && $record1[$i]->Q9E1S108!='3' && $record1[$i]->Q9E1S109!='4' && $record1[$i]->Q9E1S1010!='5'&& $record1[$i]->Q34E1=='') {echo "000.000" ;}


                echo $record1[$i]->Q9E1S106; ?></td>              
                ...
                if($record1[$i]->Q9E1S1011!='1' && $record1[$i]->Q9E1S1012!='2' && $record1[$i]->Q9E1S1013!='3') {echo "000.000" ;} ?></td>                
...
<td><?php echo  $record1[$i]->Q5W4; ?></td>
<td><?php echo  $record1[$i]->Q6W1; ?></td>
<td><?php echo  $record1[$i]->Q6W2; ?></td>
<td><?php echo  $record1[$i]->Q6W3; ?></td>
<td><?php echo  $record1[$i]->Q6W4; ?></td>
<td><?php echo  $record1[$i]->Q6W5; ?></td>
<td><?php echo  $record1[$i]->Q7W1; ?></td>
<td><?php echo  $record1[$i]->Q7W2; ?></td>
...
<td><?php echo  $record1[$i]->water_points; ?></td>
 <td><?php echo  $record1[$i]->Q4Wa1; ?></td>
        ...
        <td><?php if($record1[$i]->Q15Wa2S1=='1'){echo "Horticultural, ";}
                  if($record1[$i]->Q15Wa2S2=='1'){echo "Plastic, ";}
                  if($record1[$i]->Q15Wa2S3=='1'){echo "Tyres, ";}
                  if($record1[$i]->Q15Wa2S4=='1'){echo "Paper, ";}
                  if($record1[$i]->Q15Wa2S5=='1'){echo " Sanitary waste";}
                  if($record1[$i]->Q15Wa2S1!='1' && $record1[$i]->Q15Wa2S2!='1' && $record1[$i]->Q15Wa2S3!='1' && $record1[$i]->Q15Wa2S4!='1' && $record1[$i]->Q15Wa2S5!='1' ){echo "000.000";} 
