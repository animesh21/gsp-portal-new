      ...
      <thead>
       ...
       <th>S.No</th>
		...
		<th>Electricity Bill</th>
				...
				<th>What is the installed capacity of solar</th>
				<th>What is the connected load</th>
				<th>What is the size of invertors</th>
				<th>On-grid net metering</th>
				<th>What is the power generated by the solar</th>
				<th>Power generated by the solar(Wet cleaning at least once a week)</th>
				<th>Power generated by the solar(Dry cleaning daily)</th>
				<th>Power generated by the solar(Annual maintenance)</th>
				<th>Power generated by the solar(Regular monitoring)</th>
				<th>Biofuel</th>
				<th>Wind</th>
				<th>Small hydro</th>
				<th>Other</th>
				<th>Not applicable</th>
				<th>What is the size of invertors associated</th>
				<th>What is the installed capacity of non-solar RE</th>
				<th>What is the connected load</th>
				<th>What is the power generated by the non-solar RE</th>
				<th>What are the (O&M) practices(Annual maintenance contract)</th>
				<th>What are the (O&M) practices(Regular monitoring)</th>
				<th>What are types of biomass(Food waste)</th>
				<th>What are types of biomass(Animal solid waste)</th>
				<th>What are types of biomass(Wood chips/ pellets)</th>
				<th>What are types of biomass(Grass/straw based/dry leaves)</th>
				<th>What are types of biomass(Others)</th>
				<th>What are types of biomass(Give details)</th>
				<th>What is the amount of waste</th>
				<th>What purpose is the energy(Electricity)</th>
				<th>What purpose is the energy(Heating)</th>
				<th>What purpose is the energy(Cooking)</th>
				<th>What is the approximate capacity of the biogas</th>
				<th>What is the quantity of water</th>
				<th>What are the components of biogas unit(Inlet pipe)</th>
				<th>What are the components of biogas unit(Drum/chamber)</th>
				<th>What are the components of biogas unit(Outlet pipe)</th>
				<th>What are the components of biogas unit(Scrubber)</th>
				<th>What are the components of biogas unit(Gas outlet)</th>
				<th>What are the components of biogas unit(Gas pump)</th>
				<th>How many hours of cooking in school</th>
				<th>What other fuel sources are used for cooking</th>
				<th>How many hours of cooking by other sources</th>				
		...
		?>
    		...
    		<td><?php echo $record1[$i]->air_points; ?></td>
			  ...
			  <td><?php echo $record1[$i]->Q4E1; ?></td>
                ...
                <td><?php echo $record1[$i]->Q9E1S1020; ?></td>
                <td><?php echo $record1[$i]->Q9E1S1021; ?></td>
                <td><?php echo $record1[$i]->Q9E1S1022; ?></td>
                <td><?php echo $record1[$i]->Q9E1S1023; ?></td>
                <td><?php echo $record1[$i]->Q9E1S101; ?></td>
                <td><?php echo $record1[$i]->Q9E1S102; ?></td>
                <td><?php echo $record1[$i]->Q9E1S103; ?></td>
                <td><?php echo $record1[$i]->Q9E1S104; ?></td>
                ...
                <td><?php echo $record1[$i]->Q9E1S1026; ?></td>
                <td><?php echo $record1[$i]->Q9E1S1027; ?></td>
                <td><?php echo $record1[$i]->Q9E1S106; ?></td>
                <td><?php echo $record1[$i]->Q9E1S107; ?></td>
                <td><?php echo $record1[$i]->Q9E1S108; ?></td>
                <td><?php echo $record1[$i]->Q9E1S109; ?></td>
                <td><?php echo $record1[$i]->Q9E1S1010; ?></td>
                <td><?php echo $record1[$i]->Q34E1; ?></td>
                <td><?php echo $record1[$i]->Q38E1; ?></td>
                <td><?php echo $record1[$i]->Q9E1S1011; ?></td>
                <td><?php echo $record1[$i]->Q9E1S1012; ?></td>
                <td><?php echo $record1[$i]->Q9E1S1013; ?></td>
                <td><?php echo $record1[$i]->Q42E1; ?></td>
                <td><?php echo $record1[$i]->Q44E1; ?></td>
                <td><?php echo $record1[$i]->Q9E1S1014; ?></td>
                <td><?php echo $record1[$i]->Q9E1S1015; ?></td>
                <td><?php echo $record1[$i]->Q9E1S1016; ?></td>
                <td><?php echo $record1[$i]->Q9E1S1017; ?></td>
                <td><?php echo $record1[$i]->Q9E1S1018; ?></td>
                <td><?php echo $record1[$i]->Q9E1S1019; ?></td>
