 ...
 /*
    ...
    public function excelByProgress_phase1() {
	 ...
	 public function excelByProgress_phase2() {
	    $varProgress="a.progress_phase_2 > '5' && a.progress_phase_2 <= '75' && a.complete_status='0'";
            $this->load->dbutil();
	...
	public function excelByProgress1_phase2() {
	  $varProgress="a.progress_phase_2 >= '10' && a.progress_phase_2 <= '100' && a.complete_status ='0'";
        $this->load->dbutil();
        $row = $this->Audit_started_model->getExcelDataByProgress_phase2( $varProgress);
        $name = 'SCHOOL_THAT_STARTED_THE_AUDIT'.date('d-m-Y').'.csv';
		force_download($name, $row);
	...
	public function excelByProgress2_phase1() {
	 ...
	 $varProgress="a.progress_phase_2 ='100' && a.complete_status='0'";
         $this->load->dbutil();
         $row = $this->Audit_started_model->getExcelDataByProgress_phase2($varProgress);
...
/*
	...
	$varProgress="a.progress_phase_2 = '5'";
        $this->load->dbutil();
