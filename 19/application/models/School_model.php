...
class School_model extends CI_Model
{
    ...
    public function RegisterUser($argPost)
    {
        ...
        if ($this->db->insert('gsp_school', $update)) {
            ...
            $arrMails = array($query->schoolemail, $query->coemail, 'ranjita@cseindia.org', 'aditi.sharma@cseindia.org', 'ruchika.sharma@cseindia.org', 'studiotesseractst@gmail.com','srishti.jha@cseindia.org');
			$date = date('d M Y');
            $to = $arrMails;
