  ...
  public function getCompletedAuditButNotSubmitted_19data(){
	...
	$this->db->where("a.make_school_disabled","1");  
      ...
      public function getSubmittedTheAudit_19data(){
      	$this->db->where("d.date_on >=","2019-02-28 08:50:40");
   ...
   public function getMasterData(){
        return $this->db->select('a.name,b.school_id,b.school_name,b.state,b.district,b.data_2019,b.data_2018,b.data_2017,b.data_2016,b.data_2015')
        ->from('gsp_school AS a')
