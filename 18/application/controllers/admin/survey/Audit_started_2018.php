...
class Audit_started_2018 extends CI_Controller {
	...
	public function excel_Started_The_Audit() {
        ...
        $name = 'School that started the audit_2018.csv';
        force_download($name, $row);
    }
	...
	public function excel_school_completed_not_sumbitted() {
        ...
        $name = 'School that Completed but not sumbitted the audit_2018.csv';
        force_download($name, $row);
    }
	...
	public function excel_sumbitted_the_audit() {
        ...
        $name = 'School that sumbitted the audit_2018.csv';
        force_download($name, $row);
    }
