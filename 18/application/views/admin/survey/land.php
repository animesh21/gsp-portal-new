...
?>)</span></h1>
        ...
        <form action="http://localhost/gsp-portal-new/land/set" id="land" method="post" accept-charset="utf-8">
            ...
            <div class="form-group">
                ...
                <table class="table table-bordered table-striped">
                    <tr><th>Description</th> <th>Your school's area (m<Sup>2</Sup>)</th></tr> 
                    <tr><td>Site area in square meter (m<Sup>2</Sup>)</td> <td><?php echo (getFiled('Q4L1', $schoolUserID) != "") ? getFiled('Q4L1', $schoolUserID) : "N/A"; ?></td></tr> 
                    <tr><td colspan="2"><label><span class="cube">1A</span>Total green cover</label></td></tr>
                    <tr><td>(a) Ground coverage area</td> <td><?php echo (getFiled('Q4L2', $schoolUserID) != "") ? getFiled('Q4L2', $schoolUserID) : "N/A"; ?></td></tr> 
                    <tr><td>(b1) Green Landscaped area on ground</td> <td><?php echo (getFiled('Q4L3', $schoolUserID) != "") ? getFiled('Q4L3', $schoolUserID) : "N/A"; ?></td></tr> 
                    <tr><td>(b2) Play area that has grass on ground</td> <td><?php echo (getFiled('Q4L4', $schoolUserID) != "") ? getFiled('Q4L4', $schoolUserID) : "N/A"; ?></td></tr> 
                    <tr><td>(b3) Green area on ground</td> <td><?php echo (getFiled('Q4L5', $schoolUserID) != "") ? getFiled('Q4L5', $schoolUserID) : "N/A"; ?></td></tr> 
                    <tr><td>(c) Play area that is paved/concrete on ground</td> <td><?php echo (getFiled('Q4L6', $schoolUserID) != "") ? getFiled('Q4L6', $schoolUserID) : "N/A"; ?></td></tr> 
                    <tr><td>(d) Surface parking area</td> <td><?php echo (getFiled('Q4L7', $schoolUserID) != "") ? getFiled('Q4L7', $schoolUserID) : "N/A"; ?></td></tr> 
                    <tr><td>(e) Service area on ground</td> <td><?php echo (getFiled('Q4L8', $schoolUserID) != "") ? getFiled('Q4L8', $schoolUserID) : "N/A"; ?></td></tr> 
                    <tr><td colspan="2"><label><span class="cube">1B</span>Other General Area in Campus</label></td></tr>
                    <tr><td>(i) Roof and terrace area</td> <td><?php echo (getFiled('Q4L9', $schoolUserID) != "") ? getFiled('Q4L9', $schoolUserID) : "N/A"; ?></td></tr> 
                    <tr><td>(ii) Green cover on exposed roof and terrace</td> <td><?php echo (getFiled('Q4L10', $schoolUserID) != "") ? getFiled('Q4L10', $schoolUserID) : "N/A"; ?></td></tr> 
                    <tr><td>(iii) Total built-up/constructed area</td> <td><?php echo (getFiled('Q4L11', $schoolUserID) != "") ? getFiled('Q4L11', $schoolUserID) : "N/A"; ?></td></tr> 
                    <tr><td>(iv) Total number of floors (excluding ground floor) </td> <td><?php echo (getFiled('Q4L12', $schoolUserID) != "") ? getFiled('Q4L12', $schoolUserID) : "N/A"; ?></td></tr> 
                </table>
            </div>
    </div>
    <div class="form-group">
