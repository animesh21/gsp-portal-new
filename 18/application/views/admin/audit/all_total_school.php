<div class="top-area">
        <h2>Total School Registrations<a href="<?php echo base_url('admin/survey/audit_started_2018/excel_all_total_school') ?>"><button class="exportBtn">Export to Excel</button></a></h2>
</div>
