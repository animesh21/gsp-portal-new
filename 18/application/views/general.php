    ...
    <div class="content-form">
        ...
        <div class="form-group"> Lowest level of grade:
            <select name="Q1G1" id="Q1G1" onChange="ComputePrimary()" class="form-control"
                ...
                <option <?php echo set_value('Q1G1', 1); ?> <?php if (isset($data['Q1G1'])) echo $data['Q1G1'] == 1 ? "selected" : ""; ?>>
                    1
                </option>
                <option <?php echo set_value('Q1G1', 2); ?> <?php if (isset($data['Q1G1'])) echo $data['Q1G1'] == 2 ? "selected" : ""; ?>>
                    2
                </option>
                <option <?php echo set_value('Q1G1', 3); ?> <?php if (isset($data['Q1G1'])) echo $data['Q1G1'] == 3 ? "selected" : ""; ?>>
                    3
                </option>
                <option <?php echo set_value('Q1G1', 4); ?> <?php if (isset($data['Q1G1'])) echo $data['Q1G1'] == 4 ? "selected" : ""; ?>>
                    4
                </option>
                <option <?php echo set_value('Q1G1', 5); ?> <?php if (isset($data['Q1G1'])) echo $data['Q1G1'] == 5 ? "selected" : ""; ?>>
                    5
                </option>
                <option <?php echo set_value('Q1G1', 6); ?> <?php if (isset($data['Q1G1'])) echo $data['Q1G1'] == 6 ? "selected" : ""; ?>>
                    6
                </option>
                <option <?php echo set_value('Q1G1', 7); ?> <?php if (isset($data['Q1G1'])) echo $data['Q1G1'] == 7 ? "selected" : ""; ?>>
                    7
                </option>
                <option <?php echo set_value('Q1G1', 8); ?> <?php if (isset($data['Q1G1'])) echo $data['Q1G1'] == 8 ? "selected" : ""; ?>>
                    8
                </option>
                <option <?php echo set_value('Q1G1', 9); ?> <?php if (isset($data['Q1G1'])) echo $data['Q1G1'] == 9 ? "selected" : ""; ?>>
                    9
                </option>
                <option <?php echo set_value('Q1G1', 10); ?> <?php if (isset($data['Q1G1'])) echo $data['Q1G1'] == 10 ? "selected" : ""; ?>>
                    10
                </option>
                <option <?php echo set_value('Q1G1', 11); ?> <?php if (isset($data['Q1G1'])) echo $data['Q1G1'] == 11 ? "selected" : ""; ?>>
                    11
                </option>
                <option <?php echo set_value('Q1G1', 12); ?> <?php if (isset($data['Q1G1'])) echo $data['Q1G1'] == 12 ? "selected" : ""; ?>>
                    12
                </option>
            </select>
        </div>
        ...
        <div class="form-group"> Highest level of grade:
            <select name="Q1G2" id="Q1G2" onChange="ComputePrimary()" class="form-control"
                ...
                <option <?php echo set_value('Q1G2', 1); ?> <?php if (isset($data['Q1G2'])) echo $data['Q1G2'] == 1 ? "selected" : ""; ?>>
                    1
                </option>
                <option <?php echo set_value('Q1G2', 2); ?> <?php if (isset($data['Q1G2'])) echo $data['Q1G2'] == 2 ? "selected" : ""; ?>>
                    2
                </option>
                <option <?php echo set_value('Q1G2', 3); ?> <?php if (isset($data['Q1G2'])) echo $data['Q1G2'] == 3 ? "selected" : ""; ?>>
                    3
                </option>
                <option <?php echo set_value('Q1G2', 4); ?> <?php if (isset($data['Q1G2'])) echo $data['Q1G2'] == 4 ? "selected" : ""; ?>>
                    4
                </option>
                <option <?php echo set_value('Q1G2', 5); ?> <?php if (isset($data['Q1G2'])) echo $data['Q1G2'] == 5 ? "selected" : ""; ?>>
                    5
                </option>
                <option <?php echo set_value('Q1G2', 6); ?> <?php if (isset($data['Q1G2'])) echo $data['Q1G2'] == 6 ? "selected" : ""; ?>>
                    6
                </option>
                <option <?php echo set_value('Q1G2', 7); ?> <?php if (isset($data['Q1G2'])) echo $data['Q1G2'] == 7 ? "selected" : ""; ?>>
                    7
                </option>
                <option <?php echo set_value('Q1G2', 8); ?> <?php if (isset($data['Q1G2'])) echo $data['Q1G2'] == 8 ? "selected" : ""; ?>>
                    8
                </option>
                <option <?php echo set_value('Q1G2', 9); ?> <?php if (isset($data['Q1G2'])) echo $data['Q1G2'] == 9 ? "selected" : ""; ?>>
                    9
                </option>
                <option <?php echo set_value('Q1G2', 10); ?> <?php if (isset($data['Q1G2'])) echo $data['Q1G2'] == 10 ? "selected" : ""; ?>>
                    10
                </option>
                <option <?php echo set_value('Q1G2', 11); ?> <?php if (isset($data['Q1G2'])) echo $data['Q1G2'] == 11 ? "selected" : ""; ?>>
                    11
                </option>
                <option <?php echo set_value('Q1G2', 12); ?> <?php if (isset($data['Q1G2'])) echo $data['Q1G2'] == 12 ? "selected" : ""; ?>>
                    12
                </option>
            </select>
        </div>
        ...
        <div class="form-group" id="Q3G2">
            ...
            <div class="form-group" id="Q3G2" style="display: none;">
                ...
                <div class="form-group" id="Q3G2" style="display: none;">
                    ...
                    <?php } ?>
                    <label class="control-label"><span class="cube">3(a)</span> Select State for Board of Education:
                    </label>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-2">
                            <input class="form-control space-textbox" id="male" type="number" min="0"
                                   ...
                                   value="<?php if (isset($data['Q4G1S1'])) echo $data['Q4G1S1'] ?>"<?php if (isset($data['Q2G1'])) if ($data['Q2G1'] == 2) echo "disabled"; ?>/>
                        </div>
                        <div class="col-xs-2">
                            <input class="form-control space-textbox" id="female" type="number" min="0"
                                   ...
                                   value="<?php if (isset($data['Q4G1S2'])) echo $data['Q4G1S2'] ?>" <?php if (isset($data['Q2G1'])) if ($data['Q2G1'] == 1) echo "disabled"; ?> />
                        </div>
                        <div class="col-xs-2">
                            <input class="form-control space-textbox" id="mixed" onKeyUp="CalculateStudent()"
                                   ...
                                   value="<?php if (isset($data['Q4G1S3'])) echo $data['Q4G1S3'] ?>" readonly/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-2">
                            <input class="form-control space-textbox" id="teacherMale" onKeyUp="CalculateStudent()"
                                   ...
                                   value="<?php if (isset($data['Q4G2S1'])) echo $data['Q4G2S1'] ?>"/>
                        </div>
                        <div class="col-xs-2">
                            <input class="form-control space-textbox" id="teacherFemale" onKeyUp="CalculateStudent()"
                                   ...
                                   value="<?php if (isset($data['Q4G2S2'])) echo $data['Q4G2S2'] ?>"/>
                        </div>
                        <div class="col-xs-2">
                            <input class="form-control space-textbox" id="teacherMixed" onKeyUp="CalculateStudent()"
                                   ...
                                   value="<?php if (isset($data['Q4G2S3'])) echo $data['Q4G2S3'] ?>" readonly/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-2">
                            <input class="form-control space-textbox" id="NteacherMale" onKeyUp="CalculateStudent()"
                                   ...
                                   value="<?php if (isset($data['Q4G3S1'])) echo $data['Q4G3S1'] ?>"/>
                        </div>
                        <div class="col-xs-2">
                            <input class="form-control space-textbox" id="NteacherFemale" onKeyUp="CalculateStudent()"
                                   ...
                                   value="<?php if (isset($data['Q4G3S2'])) echo $data['Q4G3S2'] ?>"/>
                        </div>
                        <div class="col-xs-2">
                            <input class="form-control space-textbox" id="NteacherMixed" onKeyUp="CalculateStudent()"
                                   ...
                                   value="<?php if (isset($data['Q4G3S3'])) echo $data['Q4G3S3'] ?>" readonly/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-2">
                            <input class="form-control space-textbox" id="subMale" onKeyUp="CalculateStudent()"
                                   ...
                                   value="<?php if (isset($data['Q4G4S1'])) echo $data['Q4G4S1'] ?>" readonly/>
                        </div>
                        <div class="col-xs-2">
                            <input class="form-control space-textbox" id="subFemale" onKeyUp="CalculateStudent()"
                                   ...
                                   value="<?php if (isset($data['Q4G4S2'])) echo $data['Q4G4S2'] ?>" readonly/>
                        </div>
                        <div class="col-xs-2">
                            <?php
                    ...
                    <div class=" form-group">
                        ...
                        <input class="form-control" id="Q5G1" type="number" min="0" name="Q5G1"
                               ...
                               value="<?php if (isset($data['Q5G1'])) echo $data['Q5G1'] ?>"/>
                    </div>
                    <div class="clearfix">&nbsp;</div>
                    <?php
                    if (isset($other['Q1S1']))
                        ...
                        if ($other['Q1S1'] >= 3) {
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="Q5G2" type="number" min="0" name="Q5G2"
                                       ...
                                       value="<?php if (isset($data['Q5G2'])) echo $data['Q5G2'] ?>"/>
                            </div>
                            <div class="clearfix">&nbsp;</div>
                            <?php
                        }
                  ...
                  On an average, a school runs for 220-230 days in a year"><span class="badge">?</span></a> </label>
                        <input class="form-control" id="Q6G1" type="number" min="0" max="366" name="Q6G1"
                               ...
                               value="<?php if (isset($data['Q6G1'])) echo $data['Q6G1'] ?>"/>
                    </div>
                    <div class="clearfix">&nbsp;</div>
                    <div class="form-group">
