    ...
    <div class="home_container">
      <div class="mform" style="display: block;">
        ...
        <?php
                        ...
                        ?>
        <?php echo form_open('downloadLogin'); ?>
...
<footer>
  <div class="container">
    <p>Copyright © 2017 Centre for Science and Environment. For help, email <a href="mailto:ranjita@cseindia.org">support@greenschoolsprogramme.org</a> or call 011-4061600, ext – 321, 300. </p>
    <p></p>
  </div>
  <!--close container-->
</footer>
