...
<div class="container">
    ...
    <!--close log-nav-->
   <h1>Air <div style="float: right">Percentage Completion: <?php echo $sql_percentage['completeness']; ?>%</div></h1>
    <!--close progress-->
...
<input type="hidden" value="testnp" id="school_name" name="school_name"> 
        <div class="form-group"> 
            ...
            <span class="question-text">
                <h6>
	Task 1: Choose your Air Audit Team</h6>
<p>
	You would require at least five to 10 of your schoolmates in the air audit team. The teacher co-ordinator may be a science or social science teacher, with an interest in air pollution issues. Do include the school transport in-charge and the drivers of school transport in your audit team.</p>
...
<label for="answer266617X4X1973SQ001">Name of Teacher:</label>
	<span>
            ...
            <input type="text" value="<?php echo $sql_data['266617X4X1973SQ001']; ?>" id="answer266617X4X1973SQ001" name="266617X4X1973SQ001" size="20" class="text" disabled="">
...
<input type="text" value="<?php echo $sql_data['266617X4X1973SQ002']; ?>" id="answer266617X4X1973SQ002" name="266617X4X1973SQ002" size="20" class="text"  disabled="">
...
<input type="text" value="<?php echo $sql_data['266617X4X1973SQ003']; ?>" id="answer266617X4X1973SQ003" name="266617X4X1973SQ003" size="20" class="text" disabled="">
...
<tbody>
	...
	<td class="answer_cell_00SQ004 answer-item text-item">
				...
				<input type="text" value="<?php echo $sql_data['266617X4X2197SQ002_SQ004']; ?>" size="20" class="form-control" id="answer266617X4X2197SQ002_SQ004" name="266617X4X2197SQ002_SQ004" readonly="">
			</td>
	...
	<td class="answer_cell_00SQ004 answer-item text-item">
				...
				<input type="text" value="<?php echo $sql_data['266617X4X2197SQ006_SQ004']; ?>" size="20" class="form-control" id="answer266617X4X2197SQ006_SQ004" name="266617X4X2197SQ006_SQ004" readonly="">
			</td>
...
<p>
	In this section, you will maintain a record of vehicles used by your school. Two critical parameters indicate if your vehicles are eco-friendly - fuel used by each vehicle and age of the vehicle.</p>
        ...
        <div class="answer clearfix">
            ...
            <!-- <div class='text-success'><span class="questionhelp hide-tip" id="vmsg_1978"></span></div> -->
...
<label for="answer266617X4X165SQ005_SQ003" class="hide read">Total</label>
	<input type="text" value="<?php echo $sql_data['266617X4X165SQ005_SQ003']; ?>" onkeyup="fixnum_checkconditions(this.value, this.name, this.type)" title="Total" size="5" maxlength="5" id="answer266617X4X165SQ005_SQ003" name="266617X4X165SQ005_SQ003" class="multiflexitext text  em_sq_validation good form-control" readonly="">
            ...
            <div class="survey-question-help"><img align="left" alt="Help" src="/audit_new/images/help.gif"><p>
...
<input type="hidden" value="testnp" id="school_name" name="school_name"> 
        <div class="form-group"> 
            <label for="exampleInputEmail1">
            <span class="question-text">
                <span class="cube">4</span>&nbsp;Specify the type of fuel used by your school's vehicles:
