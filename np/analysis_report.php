 ...
 $sql_bonus = mysql_fetch_array(mysql_query("select SUM(bonus) as bonus from `calculation` where `token` = '".$sql_data_array['token']."'"));
  ...
  <tr>
    ...
    <td><!--LAND percentage of green area-->
      ...
      <td><?php echo number_format($sql_data_array['266617X38X2125SQ009_SQ001'],2); ?></td>
      <td><?php echo number_format($sql_data_array['266617X38X2042SQ010_SQ001'],2); ?></td>
      <td><?php echo $per_wr = number_format(($sql_data_array['266617X38X2042SQ010_SQ001']/$sql_data_array['266617X38X2125SQ009_SQ001'])*100,2);echo "%"; ?></td>
