...
//Day Scholer Query
$sql_query_dayscholer = mysql_fetch_array(mysql_query("select ltok.`266617X32X33SQ004_SQ003`, SUM(ltok.266617X38X2125SQ009_SQ001/ltok.266617X32X33SQ004_SQ003) as ag, SUM(ltok.266617X38X2042SQ010_SQ001/ltok.266617X32X33SQ004_SQ003) as recy, SUM(ltok.266617X38X2068/ltok.266617X32X33SQ004_SQ003) as decompo from lime_survey_266617 as ltok join `lime_tokens_266617` as lsur ON ltok.token=lsur.token WHERE lsur.`completed` !='N' AND lsur.`usesleft` = 0 AND ltok.`266617X34X1608SQ001` = 'Y' $state_condition"));
...
//Day Bording Query
$sql_query_daybording = mysql_fetch_array(mysql_query("select `266617X32X33SQ004_SQ003`, SUM(ltok.266617X38X2125SQ009_SQ001/ltok.266617X32X33SQ004_SQ003) as ag, SUM(ltok.266617X38X2042SQ010_SQ001/ltok.266617X32X33SQ004_SQ003) as recy, SUM(ltok.266617X38X2068/ltok.266617X32X33SQ004_SQ003) as decompo from lime_survey_266617 as ltok join `lime_tokens_266617` as lsur ON ltok.token=lsur.token WHERE lsur.`completed` !='N' AND lsur.`usesleft` = 0 AND ltok.`266617X34X1608SQ002` = 'Y' $state_condition"));
...
//Residential Query
$sql_query_residential = mysql_fetch_array(mysql_query("select `ltok.266617X32X33SQ004_SQ003`, SUM(ltok.266617X38X2125SQ009_SQ001/ltok.266617X32X33SQ004_SQ003) as ag, SUM(ltok.266617X38X2042SQ010_SQ001/ltok.266617X32X33SQ004_SQ003) as recy, SUM(ltok.266617X38X2068/ltok.266617X32X33SQ004_SQ003) as decompo from lime_survey_266617 as ltok join `lime_tokens_266617` as lsur ON ltok.token=lsur.token WHERE lsur.`completed` !='N' AND lsur.`usesleft` = 0 AND ltok.`266617X34X1608SQ003` = 'Y' $state_condition"));
...
// Final Arrays
$final_array_poss = array($possible_waste_dayscholer, $possible_waste_daybording, $possible_waste_residential);
$final_poss_data = json_encode($final_array_poss);
//print_r($final_poss_data);
//echo "<br>";

$final_array_act = array($actual_waste_dayscholer, $actual_waste_daybording, $actual_waste_residential);
$final_act_data = json_encode($final_array_act);
//print_r($final_act_data);
//echo "<br>";

$final_array_recy = array($recycled_waste_dayscholer, $recycled_waste_daybording, $recycled_waste_residential);
$final_recy_data = json_encode($final_array_recy);
//print_r($final_recy_data);
//echo "<br>";

$final_array_decomp = array($decomposed_waste_dayscholer, $decomposed_waste_daybording, $decomposed_waste_residential);
