...
<main class="bdr" style='border: none;'>
    <div class="container" style="width: 100%">
     ...
     while($states_array = mysql_fetch_array($sql_states))
     {
        ...
        //echo "SELECT sum(greencount.266617X7X1810SQ002_SQ002) as tg FROM `lime_survey_266617` as greencount,lime_tokens_266617 as takesytate where greencount.token=takesytate.token AND takesytate.usesleft='0' AND takesytate.completed !='N' AND takesytate.attribute_5='".$states_array['name']."'";
        $sql_green_landscaped = mysql_fetch_array(mysql_query("SELECT sum(greencount.266617X7X1810SQ002_SQ002) as green_land FROM `lime_survey_266617` as greencount,lime_tokens_266617 as takesytate where greencount.token=takesytate.token AND takesytate.usesleft='0' AND takesytate.completed !='N' AND takesytate.attribute_5='".$states_array['name']."'"));
        
        $sql_terrace_green = mysql_fetch_array(mysql_query("SELECT sum(greencount.266617X7X1810SQ003_SQ002) as terrace_green FROM `lime_survey_266617` as greencount,lime_tokens_266617 as takesytate where greencount.token=takesytate.token AND takesytate.usesleft='0' AND takesytate.completed !='N' AND takesytate.attribute_5='".$states_array['name']."'"));
        
        $sql_grass_play = mysql_fetch_array(mysql_query("SELECT sum(greencount.266617X7X1810SQ006_SQ002) as grass_play FROM `lime_survey_266617` as greencount,lime_tokens_266617 as takesytate where greencount.token=takesytate.token AND takesytate.usesleft='0' AND takesytate.completed !='N' AND takesytate.attribute_5='".$states_array['name']."'"));
        
        $sql_site_area = mysql_fetch_array(mysql_query("SELECT sum(greencount.266617X7X1810SQ009_SQ002) as total_site FROM `lime_survey_266617` as greencount,lime_tokens_266617 as takesytate where greencount.token=takesytate.token AND takesytate.usesleft='0' AND takesytate.completed !='N' AND takesytate.attribute_5='".$states_array['name']."'"));
        $i++;
