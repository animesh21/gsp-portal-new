...
$(document).ready(function() {
    document.title = 'All Questions Report(GSP-Audit-2015)';
    $('#example').DataTable( {
          dom: 'lBfrtip',
        buttons: [
            'excel'
...
$sql_score_waste=GetScoreBySection($token,38); //Waste Section Score  
 ...
 <!--end General Questions -->
	...
	<td><?php echo (string)((int)$sql_data_array['266617X4X2217SQ002_SQ001']); ?></td>
	<td><?php echo (string)((int)$sql_data_array['266617X4X2217SQ003_SQ001']); ?></td>
	
	<td><?php echo (string)((int)$sql_data_array['266617X4X2217SQ001_SQ002']); ?></td> <!-- petrol bus-->
	<td><?php echo (string)((int)$sql_data_array['266617X4X2217SQ002_SQ002']); ?></td> <!-- petrol Cars-->
	<td><?php echo (string)((int)$sql_data_array['266617X4X2217SQ003_SQ002']); ?></td>
	
     <!-- LPG -->
	<td><?php echo (string)((int)$sql_data_array['266617X4X2217SQ001_SQ003']); ?></td>
	<td><?php echo (string)((int)$sql_data_array['266617X4X2217SQ002_SQ003']); ?></td>
	<td><?php echo (string)((int)$sql_data_array['266617X4X2217SQ003_SQ003']); ?></td>
	
	<!-- CNG -->
	
		<td><?php echo (string)((int)$sql_data_array['266617X4X2217SQ001_SQ004']);?></td>
	<td><?php echo (string)((int)$sql_data_array['266617X4X2217SQ002_SQ004']); ?></td>
	<td><?php echo (string)((int)$sql_data_array['266617X4X2217SQ003_SQ004']); ?></td>
...
?>
     ...
     <td><?php $per_wr =(($sql_data_array['266617X38X2042SQ010_SQ001']/$sql_data_array['266617X38X2125SQ009_SQ001'])*100);
