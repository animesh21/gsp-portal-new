...
$registerd_query_east = mysql_query("SELECT `token` FROM `lime_tokens_266617` WHERE `attribute_5` IN (\"".implode('","', $east_india) . "\")");
$registerd_query_north = mysql_query("SELECT `token` FROM `lime_tokens_266617` WHERE `attribute_5` IN (\"".implode('","', $north_india) . "\")");
$registerd_query_south = mysql_query("SELECT `token` FROM `lime_tokens_266617` WHERE `attribute_5` IN (\"".implode('","', $south_india) . "\")");
$registerd_query_west = mysql_query("SELECT `token` FROM `lime_tokens_266617` WHERE `attribute_5` IN (\"".implode('","', $west_india) . "\")");
$registerd_query_north_east = mysql_query("SELECT `token` FROM `lime_tokens_266617` WHERE `attribute_5` IN (\"".implode('","', $north_east_india) . "\")");
$registerd_query_central = mysql_query("SELECT `token` FROM `lime_tokens_266617` WHERE `attribute_5` IN (\"".implode('","', $central_india) . "\")");
...
$started_query_east = mysql_query("select * from lime_survey_266617 as ltok join `lime_tokens_266617` as lsur ON ltok.token=lsur.token WHERE `lastpage` != '0' AND `attribute_5` IN (\"".implode('","', $east_india) . "\")");
$started_query_north = mysql_query("select * from lime_survey_266617 as ltok join `lime_tokens_266617` as lsur ON ltok.token=lsur.token WHERE `lastpage` != '0' AND `attribute_5` IN (\"".implode('","', $north_india) . "\")");
$started_query_south = mysql_query("select * from lime_survey_266617 as ltok join `lime_tokens_266617` as lsur ON ltok.token=lsur.token WHERE `lastpage` != '0' AND `attribute_5` IN (\"".implode('","', $south_india) . "\")");
$started_query_west = mysql_query("select * from lime_survey_266617 as ltok join `lime_tokens_266617` as lsur ON ltok.token=lsur.token WHERE `lastpage` != '0' AND `attribute_5` IN (\"".implode('","', $west_india) . "\")");
$started_query_north_east = mysql_query("select * from lime_survey_266617 as ltok join `lime_tokens_266617` as lsur ON ltok.token=lsur.token WHERE `lastpage` != '0' AND `attribute_5` IN (\"".implode('","', $north_east_india) . "\")");
$started_query_central = mysql_query("select * from lime_survey_266617 as ltok join `lime_tokens_266617` as lsur ON ltok.token=lsur.token WHERE `lastpage` != '0' AND `attribute_5` IN (\"".implode('","', $central_india) . "\")");
...
$completed_query_east = mysql_query("SELECT `token` FROM `lime_tokens_266617` WHERE `completed` != 'N' AND `usesleft` = 0 AND `attribute_5` IN (\"".implode('","', $east_india) . "\")");
$completed_query_north = mysql_query("SELECT `token` FROM `lime_tokens_266617` WHERE `completed` != 'N' AND `usesleft` = 0 AND  `attribute_5` IN (\"".implode('","', $north_india) . "\")");
$completed_query_south = mysql_query("SELECT `token` FROM `lime_tokens_266617` WHERE `completed` != 'N' AND `usesleft` = 0 AND  `attribute_5` IN (\"".implode('","', $south_india) . "\")");
$completed_query_west = mysql_query("SELECT `token` FROM `lime_tokens_266617` WHERE `completed` != 'N' AND `usesleft` = 0 AND  `attribute_5` IN (\"".implode('","', $west_india) . "\")");
$completed_query_north_east = mysql_query("SELECT `token` FROM `lime_tokens_266617` WHERE `completed` != 'N' AND `usesleft` = 0 AND  `attribute_5` IN (\"".implode('","', $north_east_india) . "\")");
$completed_query_central = mysql_query("SELECT `token` FROM `lime_tokens_266617` WHERE `completed` != 'N' AND `usesleft` = 0 AND  `attribute_5` IN (\"".implode('","', $central_india) . "\")");
