      ...
      <div class="form-group">
        ...
        <p class="formanswertext">
            ...
            if($sql_data['266617X34X1608SQ001'] == "Y")
															{
																		$combined[] = "Day Scholar (6 hours)";
															} 
            if($sql_data['266617X34X1608SQ002'] == "Y")
															{
																			$combined[] = "Day Boarding (8 hours)";
															}
            if($sql_data['266617X34X1608SQ003'] == "Y")
														{
																		$combined[] =  "Residential (24 hours)";
														}
