        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown <?php echo $ActiveClass5; ?>"><a  href="performance_report.php">PERFORMANCE REPORT</a>
			 
			  </li>
              <li class="dropdown <?php echo $ActiveClass6; ?>"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">ANALYTICS<span class="caret"></span></a>
                <ul class="dropdown-menu">
              ...
              <li class="dropdown <?php echo $ActiveClass6; ?>"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">ANALYTICAL TABLES<span class="caret"></span></a>
                <ul class="dropdown-menu">
