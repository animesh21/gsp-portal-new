        ...
        <div class="container-fluid"> 
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="response_detail5.php?id=<?php echo $_REQUEST['id']; ?>">GOOD FOOD</a></li>
...
<div class="container">
    ...
    <!--close log-nav-->
   <h1>Good Food <div style="float: right">Percentage Completion: <?php echo $sql_percentage['completeness']; ?>%</div></h1>
    <!--close progress-->
...
<input type="hidden" value="testnp" id="school_name" name="school_name"> 
        <div class="form-group"> 
            ...
            <span class="question-text">
                <h6>
	Task 1: Choose your Food Audit Team</h6>
...
<label for="answer266617X4X1973SQ001">Name of Teacher:</label>
	<span>
            ...
            <input type="text" value="<?php echo $sql_data['266617X36X2016SQ001']; ?>" id="answer266617X4X1973SQ001" name="266617X4X1973SQ001" size="20" class="text" disabled="">
...
<input type="text" value="<?php echo $sql_data['266617X36X2016SQ002']; ?>" id="answer266617X4X1973SQ002" name="266617X4X1973SQ002" size="20" class="text"  disabled="">
...
<input type="text" value="<?php echo $sql_data['266617X36X2016SQ003']; ?>" id="answer266617X4X1973SQ003" name="266617X4X1973SQ003" size="20" class="text" disabled="">
	...
	Task 2:  Find out about the food service in your school.</h6>
     ...
     <div class="form-group"> 
        ...
        <div class="answer clearfix">
            ...
            <!-- <div class='text-success'><span class="questionhelp hide-tip" id="vmsg_1871"></span></div> -->
...
&lt;!--
    $('#question1871 .question').delegate('input[type=text]:visible:enabled','blur keyup',function(event){
...
<tbody>
	...
	<td class="answer_cell_00SQ001 answer-item text-item">
				<label for="answer266617X36X2239SQ001_SQ001" class="hide read">Number of plates sold when on the menu</label>
				<input type="hidden" id="java266617X36X2239SQ001_SQ001" name="java266617X36X2239SQ001_SQ001" class="form-control">
	...
	<tr class="array1 subquestion-list questions-list" id="javatbd266617X36X2239SQ002">
			<th class="answertext">
				Idli/vada
				<input type="hidden" value="" id="java266617X36X2239SQ002" name="java266617X36X2239SQ002" class="form-control">
			</th>
	<td class="answer_cell_00SQ001 answer-item text-item">
				<label for="answer266617X36X2239SQ002_SQ001" class="hide read">Number of plates sold when on the menu</label>
				<input type="hidden" id="java266617X36X2239SQ002_SQ001" name="java266617X36X2239SQ002_SQ001" class="form-control">
	...
	<tr class="array2 subquestion-list questions-list" id="javatbd266617X36X2239SQ003">
			<th class="answertext">
				Sambhar
				<input type="hidden" value="" id="java266617X36X2239SQ003" name="java266617X36X2239SQ003" class="form-control">
			</th>
	<td class="answer_cell_00SQ001 answer-item text-item">
				<label for="answer266617X36X2239SQ003_SQ001" class="hide read">Number of plates sold when on the menu</label>
				<input type="hidden" id="java266617X36X2239SQ003_SQ001" name="java266617X36X2239SQ003_SQ001" class="form-control">
				<input type="text" value="<?php echo number_format($sql_data['266617X36X2239SQ003_SQ001']); ?>" size="20" class="form-control" id="answer266617X36X2239SQ003_SQ001" name="266617X36X2239SQ003_SQ001" readonly="">
			</td>
	...
	<tr class="array1 subquestion-list questions-list" id="javatbd266617X36X2239SQ004">
			<th class="answertext">
				Pav bhaji
				<input type="hidden" value="" id="java266617X36X2239SQ004" name="java266617X36X2239SQ004" class="form-control">
			</th>
	<td class="answer_cell_00SQ001 answer-item text-item">
				<label for="answer266617X36X2239SQ004_SQ001" class="hide read">Number of plates sold when on the menu</label>
				<input type="hidden" id="java266617X36X2239SQ004_SQ001" name="java266617X36X2239SQ004_SQ001" class="form-control">
				<input type="text" value="<?php echo number_format($sql_data['266617X36X2239SQ004_SQ001']); ?>" size="20" class="form-control" id="answer266617X36X2239SQ004_SQ001" name="266617X36X2239SQ004_SQ001" readonly="">
			</td>
	...
	<tr class="array2 subquestion-list questions-list" id="javatbd266617X36X2239SQ005">
			<th class="answertext">
				Momos
				<input type="hidden" value="" id="java266617X36X2239SQ005" name="java266617X36X2239SQ005" class="form-control">
			</th>
	<td class="answer_cell_00SQ001 answer-item text-item">
				<label for="answer266617X36X2239SQ005_SQ001" class="hide read">Number of plates sold when on the menu</label>
				<input type="hidden" id="java266617X36X2239SQ005_SQ001" name="java266617X36X2239SQ005_SQ001" class="form-control">
				<input type="text" value="<?php echo number_format($sql_data['266617X36X2239SQ005_SQ001']); ?>" size="20" class="form-control" id="answer266617X36X2239SQ005_SQ001" name="266617X36X2239SQ005_SQ001" readonly="">
			</td>
	...
	<tr class="array1 subquestion-list questions-list" id="javatbd266617X36X2239SQ006">
			<th class="answertext">
				Others
				<input type="hidden" value="" id="java266617X36X2239SQ006" name="java266617X36X2239SQ006" class="form-control">
			</th>
	<td class="answer_cell_00SQ001 answer-item text-item">
				<label for="answer266617X36X2239SQ006_SQ001" class="hide read">Number of plates sold when on the menu</label>
				<input type="hidden" id="java266617X36X2239SQ006_SQ001" name="java266617X36X2239SQ006_SQ001" class="form-control">
				<input type="text" value="<?php echo $sql_data['266617X36X2239SQ006_SQ001']; ?>" size="20" class="form-control" id="answer266617X36X2239SQ006_SQ001" name="266617X36X2239SQ006_SQ001" readonly="">
			</td>
      ...
      <div class="form-group"> 
        ...
        <div class="answer clearfix">
            ...
            <!-- <div class='text-success'><span class="questionhelp hide-tip" id="vmsg_2247"><div id='vmsg_2247_input_boxes' class='em_input_boxes emtip'>Only numbers may be entered in these fields.</div>
</span></div> -->
...
<input type="hidden" value="" id="java266617X36X2247SQ001" name="java266617X36X2247SQ001" class="form-control">
	...
	<input type="hidden" id="java266617X36X2247SQ001_SQ001" name="java266617X36X2247SQ001_SQ001" class="form-control">
<label for="answer266617X36X2247SQ001_SQ001" class="hide read">Number of servings sold when on the menu</label>
<input type="text" value="<?php echo $sql_data['266617X36X2247SQ001_SQ001'] ?>" onkeyup="fixnum_checkconditions(this.value, this.name, this.type)" title="Number of servings sold when on the menu" size="5" maxlength="5" id="answer266617X36X2247SQ001_SQ001" name="266617X36X2247SQ001_SQ001" class="multiflexitext text  empty form-control em_sq_validation good" readonly="">
	</td>
</tr>
	...
	<th width="20%" class="answertext">
Salted butter milk
<input type="hidden" value="" id="java266617X36X2247SQ002" name="java266617X36X2247SQ002" class="form-control">
	</th>
	<td class="answer_cell_00SQ001 question-item answer-item  numeric-item text-item  numberonly maxchars maxchars-5">
	<input type="hidden" id="java266617X36X2247SQ002_SQ001" name="java266617X36X2247SQ002_SQ001" class="form-control">
<label for="answer266617X36X2247SQ002_SQ001" class="hide read">Number of servings sold when on the menu</label>
	<input type="text" value="<?php echo $sql_data['266617X36X2247SQ002_SQ001'] ?>" onkeyup="fixnum_checkconditions(this.value, this.name, this.type)" title="Number of servings sold when on the menu" size="5" maxlength="5" id="answer266617X36X2247SQ002_SQ001" name="266617X36X2247SQ002_SQ001" class="multiflexitext text  empty form-control em_sq_validation good" readonly="">
	</td>
</tr>
	...
	<th width="20%" class="answertext">
Sweet lassi
<input type="hidden" value="" id="java266617X36X2247SQ003" name="java266617X36X2247SQ003" class="form-control">
	</th>
	<td class="answer_cell_00SQ001 question-item answer-item  numeric-item text-item  numberonly maxchars maxchars-5">
	<input type="hidden" id="java266617X36X2247SQ003_SQ001" name="java266617X36X2247SQ003_SQ001" class="form-control">
<label for="answer266617X36X2247SQ003_SQ001" class="hide read">Number of servings sold when on the menu</label>
