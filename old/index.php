...
if(isset($_REQUEST['submit']))
{
    ...
    if(mysql_num_rows($sql_check) > 0)
    {
        ...
        if($d_year =='2015')
        header('location:/GSP/old/2015/dashboard.php');
        else if($d_year =='2016')
        header('location:/GSP/old/2016/dashboard.php');    
...
<!--             <option value="2016" <?php //if($_POST['year']=='2016')echo "selected"; ?>>2016</option>-->
             <option value="2015" <?php //if($_POST['year']=='2015')echo "selected"; ?>>2015</option>
                 <option value="2017" <?php //if($_POST['year']=='2015')echo "selected"; ?>>2017</option>
          </select>
      </div>
