                          ...
                          <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div style="margin-right:19px;">
                                    <img src="<?php echo base_url(); ?>assets/img/picturefood.png" alt="AQI" style="margin-right:10px;">
                                </div>
                                </br>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div style="margin-right:19px;">
                                    <img src="<?php echo base_url(); ?>assets/img/picturefood2.png" alt="AQI" style="margin-right:10px;">
                                    </div>
