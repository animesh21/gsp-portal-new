...
class Wastem extends CI_Controller {
    ...
    public function index() {
        ...
        public function set()
        {
            ...
            $this->form_validation->set_rules('Q9WS1','Q9WS1','required|trim');
            $this->form_validation->set_rules('Q10WS1','Q10WS1','required|trim');

            

        if($this->form_validation->run() == false)
        {
            $this->load->view('auditfeb/wastem');
        }
        else
        {
