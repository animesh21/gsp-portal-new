		  ...
		  // ->where("b.userid IS NULL")
		   ...
		   for($t=0; $t<sizeof($certificate);++$t){
		     for($r=0;$r<sizeof($certificate[$t]);++$r){
			   $this->db->insert("tblcertificate",array("userid"=>$certificate[$t][$r]['userid'],"certificate_username"=>$certificate[$t][$r]['name'],"certificate_schoolname"=>$certificate[$t][$r]['schoolname']));
