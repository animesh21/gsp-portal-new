...
public function kvs_school_merge() {
    ...
    public function kvs_school_add() {
        ...
        $query = $this->db->select('a.*, b.email AS emailfiled, b.password, b.username, c.name AS state_name, d.name AS district_name')
            ...
            $arrMails = array($schoolemail, $coemail, 'ranjita@cseindia.org', 'studiotesseractst@gmail.com', 'srishti.jha@cseindia.org', 'tushita.rawat@cseindia.org', 'neeraj.kumar@cseindia.org');
            $date = date('d M Y');
            $to = $arrMails;
