...
class DigitalCertificateCSI extends CI_Controller{ 
    ...
    public function index(){
        $this->load->view('certificates/gsp_csi');
    }
    ...
    public function GetCSI(){
        ...
        $dataCertificate=$this->db->select("*")->from("gsp_CSI")->get()->result();
        ...
        $html = $this->load->view('certificates/gsp_csi_pdf', $data, true);
