...
class GspWorkshopHp extends CI_Controller{
    ...
    public function index(){
        $this->load->view('certificates/gspworkshophp');
    }
    ...
    public function getWorkshopHP(){
        ...
        $dataCertificate=$this->db->select("*")->from("gsp_workshop_hp")->get()->result();
        ...
        $html = $this->load->view('certificates/gsp_workshop_hp_pdf', $data, true);
