...
<header class="hdr-bdr"> 
  <div class="container">
    <figure class="logo"><a href="<?php echo base_url('admin/dash
    board') ?>"><img src="<?php echo base_url('');?>assets/img/logo.png" class="img-responsive" alt=""></a></figure>
...
<div class="container" style="padding: 20px">
  <div class="home_container" style="padding: 30px 15px 30px 15px; width: 55%;">
    <h1>GSP Online Capacity Building Workshop October 7 to 9, 2020</h1>
  ...
  <?php } ?>
    ...
    <?php echo form_open('GspWorkshopsbs/getWorkshopCertificate', array('class'=>'form-inline')); ?>
