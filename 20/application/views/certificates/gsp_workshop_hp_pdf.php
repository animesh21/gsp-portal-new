...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  if (!empty($teachers)) {
    ...
    if ($teacher->name_of_participant !="") {
        ...
        <div class='image'><img src='assets/img/images/HP workshop_certificate.jpg' width='1000' height='700'></div>";
...
.principal{ position:relative; text-align: center; top:225px;}
.school_name1{ position:relative; text-align: center; top:225px; font-size: 20px; margin-left: 25px;}
.school_name{ position:relative; text-align: center; top:225px; margin-left: 25px;}
