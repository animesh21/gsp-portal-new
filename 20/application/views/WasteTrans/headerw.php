  ...
  <div class="index-body">
    ...
    <ol>
      <li id="Nav" class="row  <?php echo ($this->router->fetch_class() == 'WasteTransformers') ? "current" : "missing"; ?>"onClick="javascript:window.location.href='<?php echo base_url("WasteTransformers") ?>';">School
		...
		<li id="Nav" class="row  <?php echo ($this->router->fetch_class() == 'Wt') ? "current" : "missing"; ?>"onClick="javascript:window.location.href='<?php echo base_url("Baseline") ?>';">Baseline
        </li>
		<li id="Nav" class="row  <?php echo ($this->router->fetch_class() == 'Wt') ? "current" : "missing"; ?>"onClick="javascript:window.location.href='<?php echo base_url("Baseline") ?>';">Action Plan
        </li>
