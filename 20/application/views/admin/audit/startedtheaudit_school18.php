<div class="top-area">
<h2>Total School That Started The Audit<a href="<?php echo base_url('admin/survey/audit_started_2018/excel_Started_The_Audit') ?>"><button class="exportBtn">Export to Excel</button></a></h2>
</div>
