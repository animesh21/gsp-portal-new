    ...
    <tbody>
	 ...
	 for($i=0;$i<sizeof($record);++$i){ ?>
      <tr>
        ...
        <td <?php  if($record[$i]->data_2020=="GREEN"){?>style='background-color: Green; color:#000;' <?php }elseif(floor($record[$i]->data_2020)=="YELLOW"){ ?>style='background:yellow; color:000;' <?php }elseif(floor($record[$i]->data_2020)=='ORANGE'){ ?> style='background:orange; color:000;'  <?php }elseif(floor($record[$i]->data_2020)=='RED'){?> style='background:red; color:000;' <?php } ?> >
