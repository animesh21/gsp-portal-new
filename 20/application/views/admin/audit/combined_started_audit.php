<div class="top-area">
        <h2>2019 Total School That Started The Audit<a href="<?php echo base_url('admin/audit_started/combinded_startedtheaudit') ?>"><button class="exportBtn">Export to Excel</button></a></h2>
</div>
