<div>
  <div class="top-area">
    <h2>ALL EXCEL DUMP Of SECONDARY PHASE-2</h2>
  </div>
  <div style="overflow: scroll">
    ...
    <th>Percentage Total of sustainable motorised Vehicle</th>
    <th>Total of Non-polluting mode</th>
    <th>Percentage Total of Non polluting mode</th>
...
<!-- new energy field start from here.... -->
        <th>State subsidy availed (Y/N)</th>
        <th>Installed capacity of solar photovoltaic (PV) panels (kW)</th>
        <th>Connected load of school</th>
        <th>Size of invertors (kVA)</th>
        <th>Operational model-solar rooftop-Off grid/On grid net metering/on grid gross metering </th>
        <th>Power generated by solar rooftop panel in a year (kWh)</th>
        <th>Operation and maintenance (O&M) practices </th>        
        <th>Are there any alternate sources of energy employed/ installed in your school? 6(a) If yes, do you use and then the options</th>   
        <th>Installed capacity of non-solar RE system</th>
        <th>Connected load of non-solar RE system</th>
        <th>Size of invertors (kVA) of non-solar RE System</th>
        <th>Power generated by non-solar RE system in a year (kWh)</th>
        <th>Operation and maintenance (O&M) practices of non-solar RE system</th>  
        <th>Biomass type used in biofuel</th>        
        <th>Waste used by  biomass plant per day (kg)</th>
        <th>Purpose energy from biofuel: Electricity/cooking/heating</th>      
        <th>Capacity of the biogas unit (in terms of m3/day)</th>
        <th>Do you add water in biogas unit?</th>
        <th>If yes, quanity of water (L) added per kg of waste</th>
        <th>Components of biogas unit </th>        
        <th>Hours of cooking done per day using biogas</th>
        <th>Other sources for cooking</th>
        <th>Hours of cooking done per day using other sources</th>  

<!-- new energy field end here.... -->
        ...
        <th>Do you have vertical gardens in your school?</th>
        <th>Total Area</th>
    ...
    <td>Classroom no bin</td>
    <td>Classroom (mixed bin)</td>
    <td>Classroom two bins</td>
    <td>Classroom three bins</td>
    <td>Classroom no.of collection points</td>
    <td>Playground no bin</td>
    <td>Playground (mixed bin)</td>
    <td>Playground (two bins)</td>
    <td>Playground three bins</td>
    <td>Playground total bins</td>
    <td>Common Area no bin</td>
    <td>Common Area mixed bin</td>
    <td>Common Area two bins</td>
    <td>Common Area three bins</td>
    <td>Common Area total bins</td>
    <td>Staffroom no bin </td>
    <td>Staffroom (mixed bin) </td>
    <td>Staffroom two bins</td>
    <td>Staffroom three bins</td>
    <td>Staffroom total bins</td>
    <td>Laboratory no bin</td>
    <td>Laboratory (mixed bin)</td>
    <td>Laboratory two bins</td>
    <td>Laboratory three bins</td>
    <td>Laboratory total bins</td>
    <td>Canteen no bin</td>
    <td>Canteen (mixed)</td>
    <td>Canteen two bins</td>
    <td>Canteen three bins</td>
    <td>Canteen total bins</td>
    <td>Clinic no bin</td>
    <td>Clinic (mixed)</td>
    <td>Clinic two bins</td>
    <td>Clinic three bins</td>
    <td>Clinic total bins</td>
    <td>Library no bin</td>
    <td>Library (mixed)</td>
    <td>Library two bins</td>
    <td>Library three bins</td>
    <td>Library total bins</td>
    <td>Toilet no bin</td>
    <td>Toilet (mixed)</td>
    <td>Toilet two bins</td>
    <td>Toilet three bins</td>
    <td>Toilet total bins</td>
    <td>Others no bin</td>
    <td>Others (mixed)</td>
    <td>Others two bins</td>
    <td>Others three bins</td>
    <td>Others total </td>
    ...
    <td>Kitchen waste—Raw generated</td>
    <td>Kitchen waste—Cooked generated</td>
    <td>Wet waste generated</td>
    <td>Total biodegradable waste generated</td>
    <td>PCPD of biodegradable</td>
    <td>Plastic generated</td>
    <td>Paper generated</td>
    <td>Wood or classroom furniture generated</td>
    <td>Glass generated</td>
    <td>Metal generated</td>
    <td>Thermocol generated</td>
    <td>Tetra packs generated</td>
    ...
    <td>Kitchen waste—Raw recycled</td>
    <td>Kitchen waste—Cooked recycled</td>
    ...
    <td>Paper recycled</td>
    <td>Wood or classroom furniture recycled</td>
    <td>Glass recycled</td>
    <td>Metal recycled</td>
    <td>Thermocol recycled</td>
    <td>Tetra packs recycled</td>
    ...
    <td>Methodology of composting</td>
    <td>Quantity of compost generated</td>
    <td>Purpose of compost</td>
    <td>Reuse textbooks</td>
    <td>Paper recycling procedures</td>
    <td>Plastic recycling procedures</td>
    <td>Horticultural waste recycling procedures</td>
    <td>E-waste recycling procedures</td>
    <td>Hazardous waste recycling procedures</td>
    <td>Wood, Glass, Metal recycling procedures</td>
    <td>Biomedical waste recycling procedures</td>
    <td>Others recycling procedures</td>
    <td>TVs BEE Star rating </td>
    <td>TVs Working</td>
    <td>TVs Non working</td>
    <td>TVs total</td>
    <td>VCR or DVD players BEE star rating </td>
    <td>VCR or DVD players working</td>
    <td>VCR or DVD players non working</td>
    <td>VCR or DVD players total</td>
    <td>Refrigerators and freezers BEE star rating</td>
    <td>Refrigerators and freezers working </td>
    <td>Refrigerators and freezers non working</td>
    <td>Refrigerators and freezers total</td>
    <td>Washing machines BEE star rating</td>
    <td>Washing machines working </td>
    <td>Washing machines non working</td>
    <td>Washing machines total</td>
    <td>Air conditioners BEE star rating</td>
    <td>Air conditioners working</td>
    <td>Air conditioners non working</td>
    <td>Air conditioners total</td>
    <td>Heaters BEE Star rating</td>
    <td>Heaters working</td>
    <td>Heaters non workin</td>
    <td>Heaters total</td>
    <td>Microwaves BEE star rating</td>
    <td>Microwaves working</td>
    <td>Microwaves non working</td>
    <td>Microwaves total</td>
    <td>Ovens BEE star rating</td>
    <td>Ovens working</td>
    <td>Ovens non working </td>
    <td>Ovens total</td>
    <td>Toasters BEE star rating </td>
    <td>Toasters working</td>
    <td>Toasters non working</td>
    <td>Toasters total</td>
    <td>Electric kettles BEE star rating</td>
    <td>Electric kettles working</td>
    <td>Electric kettles non working</td>
    <td>Electric kettles total</td>
    <td>Personal computers BEE star rating </td>
    <td>Personal computers working </td>
    <td>Personal computers non working</td>
    <td>Personal computers total</td>
    <td>Laptop BEE star rating </td>
    <td>Laptop working </td>
    <td>Laptop non working</td>
    <td>Laptop total</td>
    <td>Notebook computers BEE star rating</td>
    <td>Notebook computers working </td>
    <td>Notebook computers non working</td>
    <td>Notebook computers total</td>
    <td>Printers BEE star rating </td>
    <td>Printers working </td>
    <td>Printers non workin g</td>
    <td>Printers Total</td>
    <td>Copying equipment (photocopiers) BEE star rating </td>
    <td>Copying equipment (photocopiers) working </td>
    <td>Copying equipment (photocopiers) non working</td>
    <td>Copying equipment (photocopiers) total</td>
    <td>Projectors BEE star rating </td>
    <td>Projectors working </td>
    <td>Projectors non working </td>
    <td>Projectors total</td>
    <td>Whiteboards BEE star rating </td>
    <td>Whiteboards working</td>
    <td>Whiteboards non working </td>
    <td>Whiteboards total</td>
    <td>Electrical & electronic typewriters BEE star rating</td>
    <td>Electrical and electronic typewriters workin g</td>
    <td>Electrical and electronic typewriters non working </td>
    <td>Electrical and electronic typewriters total</td>
    <td>Pocket & desk calculators BEE star rating</td>
    <td>Pocket and desk calculators working </td>
    <td>Pocket and desk calculators non working</td>
    <td>Pocket and desk calculators total</td>
    <td>Fax machines BEE star rating</td>
    <td>Fax machines working </td>
    <td>Fax machines non working</td>
    <td>Fax machines total</td>
    <td>Telex BEE star rating</td>
    <td>Telex working </td>
    <td>Telex non-working</td>
    <td>Telex total</td>
    <td>Telephones BEE star rating</td>
    <td>Telephones working</td>
    <td>Telephones non working</td>
    <td>Telephones total</td>
    <td>Pay telephones BEE star rating</td>
    <td>Pay telephones working</td>
    <td>Pay telephones non working</td>
    <td>Pay telephones total</td>
    <td>Mobiles BEE star rating</td>
    <td>Mobiles working </td>
    <td>Mobiles non working</td>
    <td>Mobiles total</td>
    <td>Answering systems BEE star rating</td>
    <td>Answering systems working </td>
    <td>Answering systems non working</td>
    <td>Answering systems total</td>
    <td>Induction cookers BEE star rating </td>
    <td>Induction cookers working </td>
    <td>Induction cookers non working </td>
    <td>Induction cookers total</td>
    <td>Geysers/water heaters BEE star rating </td>
    <td>Geysers/water heaters working</td>
    <td>Geysers/water heaters non working </td>
    <td>Geysers/water heaters total</td>
    <td>Do you know that your e-waste can be collected by an authorized dealer or dismantler?</td>
    <td>Who collects your e-waste, when not in working condition?</td>
...
//                        );
    ...
    <td><?php echo $record1[$i]->Q6A2S3B1; ?></td>    
      ...
      if($record1[$i]->Q6A3!=="Y" && $record1[$i]->Q6A3!=="N"){echo '000.000';}
        ?>
    </td>
        <td>
        <?php 
      ...
      {
          echo 'Yes';
      }if($record1[$i]->Q6A4S1=="N")
      {
           echo 'No';
      }
      if($record1[$i]->Q6A4S1!=="Y" && $record1[$i]->Q6A4S1!=="N"){echo '000.000';}
    ?>
    </td>
      ...
      <td><?php echo $record1[$i]->Q7A8S4; ?></td>
        ...
        <td><?php $total_population_smv = $record1[$i]->Q7A1S4+$record1[$i]->Q7A2S4+$record1[$i]->Q7A3S4+$record1[$i]->Q7A4S4+$record1[$i]->Q7A5S4+$record1[$i]->Q7A6S4; 
      echo  ($total_population_smv*100)/$record1[$i]->population;
        ?></td>
        <td><?php echo $record1[$i]->Q7A9S4+$record1[$i]->Q7A10S4+$record1[$i]->Q7A11S4 ; ?></td>
        <td><?php $total_population_npm = $record1[$i]->Q7A9S4+$record1[$i]->Q7A10S4+$record1[$i]->Q7A11S4; 
      echo  ($total_population_npm*100)/$record1[$i]->population;
        ?></td>
      ...
      }else if($record1[$i]->Q9A2=="N")
      {
        ...
        <td><?php if($record1[$i]->Q4E1=="Y"){ echo "Yes"; }
        if($record1[$i]->Q4E1=="N"){ echo "No"; }
        if($record1[$i]->Q4E1==""){ echo "000.000"; } ?></td>
        <td><?php if($record1[$i]->Q5E1=="Y"){ echo "Yes"; }
        if($record1[$i]->Q5E1=="N"){ echo "No"; }
        if($record1[$i]->Q5E1==""){ echo "000.000"; } ?></td>
        <td><?php echo $record1[$i]->Q6E1S1; ?></td>
        <td><?php echo $record1[$i]->Q6E2S1; ?></td>
        <td><?php echo $record1[$i]->Q6E3S1; ?></td>
        <td><?php echo $record1[$i]->Q6E4S1 ; ?></td>
        <td><?php echo $record1[$i]->Q6E5S1; ?></td>
        <td><?php echo $record1[$i]->Q6E6S1; ?></td>
        <td><?php echo $record1[$i]->Q6E7S1; ?></td>
        <td><?php echo $record1[$i]->Q6E16S1; ?></td>
        <td><?php echo $record1[$i]->Q6E8S1; ?></td>
        <td><?php echo $record1[$i]->Q6E9S1; ?></td>
        <td><?php echo $record1[$i]->Q6E10S1; ?></td>
        <td><?php echo $record1[$i]->Q6E11S1; ?></td>
        <td><?php echo $record1[$i]->Q6E12S1; ?></td>
        <td><?php echo $record1[$i]->Q6E13S1; ?></td>
        <td><?php echo $record1[$i]->Q6E14S1; ?></td>
        <td><?php echo $record1[$i]->Q6E1S2; ?></td>
        <td><?php echo $record1[$i]->Q6E2S2; ?></td>
        <td><?php echo $record1[$i]->Q6E3S2; ?></td>
        <td><?php echo $record1[$i]->Q6E4S2; ?></td>
        <td><?php echo $record1[$i]->Q6E5S2; ?></td>
        <td><?php echo $record1[$i]->Q6E6S2; ?></td>
        <td><?php echo $record1[$i]->Q6E7S2; ?></td>
        <td><?php echo $record1[$i]->Q6E16S2; ?></td>
        <td><?php echo $record1[$i]->Q6E8S2; ?></td>
        <td><?php echo $record1[$i]->Q6E9S2; ?></td>
        <td><?php echo $record1[$i]->Q6E10S2; ?></td>
        <td><?php echo $record1[$i]->Q6E11S2; ?></td>
        <td><?php echo $record1[$i]->Q6E12S2; ?></td>
        <td><?php echo $record1[$i]->Q6E13S2; ?></td>
        <td><?php echo $record1[$i]->Q6E14S2; ?></td>
        <td><?php echo $record1[$i]->Q6E15S2 ; ?></td>
        <td><?php echo $record1[$i]->per_capta_energy_consumption ; ?></td>
        ...
        <td><?php if(($record1[$i]->Q9E1S1)==1){ echo 'Solar';}        
        if(($record1[$i]->Q9E1S1)!='1'){ echo '000.000';} ?></td>
        <td><?php if(($record1[$i]->Q9E1S2)==1){ echo 'Wind'; }        
        if(($record1[$i]->Q9E1S2)!='1'){ echo '000.000'; } ?></td>
        <td><?php if(( $record1[$i]->Q9E1S3)==1){ echo 'Hydro'; }        
        if(( $record1[$i]->Q9E1S3)!='1'){ echo '000.000'; } ?></td>
        <td><?php if(( $record1[$i]->Q9E1S5)==1){ echo 'Biogas Plant'; }
        if(( $record1[$i]->Q9E1S5)!='1'){ echo '000.000'; } ?></td>
        <td><?php if(( $record1[$i]->Q9E1S4)==1){ echo 'Combination of solar and wind'; } 
        if(( $record1[$i]->Q9E1S4)!='1'){ echo '000.000'; } ?></td>
               <td><?php if($record1[$i]->Q10E1=="Y"){ echo "Yes"; }
                if($record1[$i]->Q10E1=="N"){ echo "No"; }
                if($record1[$i]->Q10E1==""){ echo "000.000"; } ?></td>
                <td><?php if($record1[$i]->Q11E1=="Y"){ echo "Yes"; }
                if($record1[$i]->Q11E1=="N"){ echo "No"; }
                if($record1[$i]->Q11E1==""){ echo "000.000"; } ?></td>
                <td><?php echo $record1[$i]->Q13E1; ?></td>
                <td><?php echo $record1[$i]->Q14E1; ?></td>
                <td><?php echo $record1[$i]->Q15E1; ?></td>
                <td><?php if($record1[$i]->Q16E1=='1'){echo "Off-grid" ;}
                elseif($record1[$i]->Q16E1=='2'){echo "On-grid net metering" ;}
                elseif($record1[$i]->Q16E1=='3'){echo "On-grid gross metering" ;} 
                else{echo '000.000';}
                ?></td>
                <td><?php echo $record1[$i]->Q19E1; ?></td>
                <td><?php  if($record1[$i]->Q9E1S1020=='1'){echo "Wet cleaning at least once a week., ";}
                if($record1[$i]->Q9E1S1021=='2'){echo "Dry cleaning daily, ";}
                if($record1[$i]->Q9E1S1022=='3'){echo "Annual maintenance contract with the vendor, ";}
                if($record1[$i]->Q9E1S1023=='4'){echo "Regular monitoring of the integrated software";}
                if($record1[$i]->Q9E1S1020!='1' && $record1[$i]->Q9E1S1021!='2' && $record1[$i]->Q9E1S1022!='3' && $record1[$i]->Q9E1S1023!='4'){echo '000.000';} ?></td>
                <td><?php if($record1[$i]->Q9E1S101=='1'){echo "Biofuel, ";}
                elseif($record1[$i]->Q9E1S1024=='1'){echo "Biogas, ";}
                elseif($record1[$i]->Q9E1S1025=='2'){echo "Biomass, ";}
                elseif($record1[$i]->Q9E1S102=='2'){echo "Wind, ";}
                elseif($record1[$i]->Q9E1S103=='3'){echo "Small hydro, ";}
                elseif($record1[$i]->Q27E3=='4'){echo "Other, ";}
                elseif($record1[$i]->Q27E3!=''){echo ", ". $record1[$i]->Q27E1;}
                elseif($record1[$i]->Q27E2=='5'){echo "Not applicable";}
                else{echo '000.000';}?></td>                 
                              
                <td><?php echo $record1[$i]->Q29E1; ?></td>
                <td><?php echo $record1[$i]->Q30E1; ?></td>
                <td><?php echo $record1[$i]->Q33E1; ?></td>
                <td><?php echo $record1[$i]->Q31E1; ?></td>
                <td><?php if($record1[$i]->Q9E1S1026=='1'){echo "Annual maintenance contract with the vendor, ";}
                if($record1[$i]->Q9E1S1027=='2'){echo "Regular monitoring of the integrated software";}
                if($record1[$i]->Q9E1S1026!='1' && $record1[$i]->Q9E1S1027!='2' ) { echo '000.000' ;} ?></td>
                 
                <td><?php if($record1[$i]->Q9E1S106=='1'){echo "Food waste, ";}
                if($record1[$i]->Q9E1S107=='2'){echo "Animal solid waste (cow dung, etc.), ";}
                if($record1[$i]->Q9E1S108=='3'){echo "Wood chips/ pellets, ";}
                if($record1[$i]->Q9E1S109=='4'){echo "Grass/straw based/dry leaves, ";}
                if($record1[$i]->Q9E1S1010=='5'){echo "Others, ";}
                if($record1[$i]->Q34E1!=='000.000'){echo $record1[$i]->Q34E1;}
                if($record1[$i]->Q9E1S106!='1' && $record1[$i]->Q9E1S107!='2' && $record1[$i]->Q9E1S108!='3' && $record1[$i]->Q9E1S109!='4' && $record1[$i]->Q9E1S1010!='5') {echo '000.000' ;} ?></td>              
                <td><?php echo $record1[$i]->Q38E1; ?></td>
                <td><?php if($record1[$i]->Q9E1S1011=='1'){echo "Electricity, ";}
                if($record1[$i]->Q9E1S1012=='2'){echo "Heating, ";}
                if($record1[$i]->Q9E1S1013=='3'){echo "Cooking, ";}
                if($record1[$i]->Q9E1S1011!='1' && $record1[$i]->Q9E1S1012!='2' && $record1[$i]->Q9E1S1013!='2') {echo '000.000' ;} ?></td>                
                <td><?php echo $record1[$i]->Q42E1; ?></td>
                <td><?php echo $record1[$i]->Q43E1; ?></td>
                <td><?php echo $record1[$i]->Q44E1; ?></td>
                <td><?php if($record1[$i]->Q9E1S1014=='1'){echo "Inlet pipe, ";}
                if($record1[$i]->Q9E1S1015=='2'){echo "Drum/chamber, ";}
                if($record1[$i]->Q9E1S1016=='3'){echo "Outlet pipe, ";}
                if($record1[$i]->Q9E1S1017=='4'){echo "Scrubber, ";}
                if($record1[$i]->Q9E1S1018=='5'){echo "Gas outlet, ";}
                if($record1[$i]->Q9E1S1019=='6'){echo "Gas pump, ";}
                if($record1[$i]->Q9E1S1014!='1' && $record1[$i]->Q9E1S1015!='2' && $record1[$i]->Q9E1S1016!='3' && $record1[$i]->Q9E1S1017!='4' && $record1[$i]->Q9E1S1018!='5' && $record1[$i]->Q9E1S1019!='6') {echo '000.000' ;}  
                ?></td>
                <td><?php echo $record1[$i]->Q51E1; ?></td>
                <td><?php echo $record1[$i]->Q52E1; ?></td>
                <td><?php echo $record1[$i]->Q53E1; ?></td>
                ...
                <td><?php if($record1[$i]->Q5F1S1=="Y"){ echo "Yes"; }
                if($record1[$i]->Q5F1S1=="N"){ echo "No"; }
                ...
                <td><?php echo $record1[$i]->Q6F4S3; ?></td>
                <td><?php echo $record1[$i]->Q6F5S1; ?></td>
                <td><?php echo $record1[$i]->Q6F5S2; ?></td>
                <td><?php echo $record1[$i]->Q6F5S3; ?></td>
                <td><?php echo $record1[$i]->Q6F6S1; ?></td>
                <td><?php echo $record1[$i]->Q6F6S2; ?></td>
                <td><?php echo $record1[$i]->Q6F6S3; ?></td>
                <td><?php echo $record1[$i]->Q6F7S1; ?></td>
                <td><?php echo $record1[$i]->Q6F7S2; ?></td>
                <td><?php echo $record1[$i]->Q6F7S3; ?></td>
                <td><?php echo $record1[$i]->Q6F8S1; ?></td>
                <td><?php echo $record1[$i]->Q6F8S2; ?></td>
                <td><?php echo $record1[$i]->Q6F8S3; ?></td>
                <td><?php echo $record1[$i]->Q6F9S1; ?></td>
                <td><?php echo $record1[$i]->Q6F9S2; ?></td>
                <td><?php echo $record1[$i]->Q6F9S3; ?></td>
                <td><?php echo $record1[$i]->Q6F10S1; ?></td>
                <td><?php echo $record1[$i]->Q6F10S2; ?></td>
                <td><?php echo $record1[$i]->Q6F10S3 ; ?></td>
                <td><?php if($record1[$i]->Q7F1=="Y"){ echo "Yes"; }
                elseif($record1[$i]->Q7F1=="N"){ echo "No"; }
                else{ echo $record1[$i]->Q7F1; } ?></td>
                <td><?php echo $record1[$i]->Q7F1S1; ?></td>
                <td><?php echo $record1[$i]->Q7F1S2; ?></td>
                <td><?php echo $record1[$i]->Q7F1S3; ?></td>
                <td><?php echo $record1[$i]->Q7F1S4; ?></td>
                <td><?php echo $record1[$i]->Q7F1S5; ?></td>
                <td><?php echo $record1[$i]->Q7F3S1; ?></td>
                <td><?php if($record1[$i]->Q8F1=="Y"){ echo "Yes"; }
                elseif($record1[$i]->Q8F1=="N"){ echo "No"; }
                else{ echo $record1[$i]->Q8F1; } ?></td>
                <td><?php echo $record1[$i]->Q8F1S1; ?></td>
                <td><?php echo $record1[$i]->Q8F1S2; ?></td>
                <td><?php echo $record1[$i]->Q8F1S3; ?></td>
                <td><?php echo $record1[$i]->Q8F1S4; ?></td>
                <td><?php echo $record1[$i]->Q8F1S5; ?></td>
                <td><?php if($record1[$i]->Q9F1=="Y"){ echo "Yes"; }
                if($record1[$i]->Q9F1=="N"){ echo "No"; }
                if($record1[$i]->Q9F1==""){ echo "000.000"; } ?></td>
                <td><?php echo $record1[$i]->Q9F2; ?></td>
                ...
                <td><?php echo $record1[$i]->Q11F3; ?></td>
                <td><?php if($record1[$i]->Q12F1=="Y"){ echo "Yes"; }
                if($record1[$i]->Q12F1=="N"){ echo "No"; }
                if($record1[$i]->Q12F1==""){ echo "000.000"; } ?></td>                
                <td><?php if(( $record1[$i]->Q12F2)==1){ echo 'Monthly'; }                
                if(($record1[$i]->Q12F2)==2){ echo 'Quarterly'; } 
                if(( $record1[$i]->Q12F2)==3){ echo 'Bi-annually'; }                
                if(( $record1[$i]->Q12F2)==4){ echo 'Annually '; } 
                if(( $record1[$i]->Q12F2)!=1&&2&&3&&4){ echo '000.000 '; }                
                ?></td>                
...
<td><?php if($record1[$i]->Q2V1=="Y"){ echo "Yes"; }
if($record1[$i]->Q2V1=="N"){ echo "No"; }
if($record1[$i]->Q2V1==""){ echo "000.000"; } ?></td>
<td><?php echo $record1[$i]->Q4L1; ?></td>
<td><?php echo $record1[$i]->Q4L5; ?></td>
...
<td><?php if($record1[$i]->Q6W1=='1'){echo "Municipality";} else{ echo'000.000';} ?></td>
<td><?php if($record1[$i]->Q6W2=='1'){echo "Panchayat";} else{ echo'000.000';} ?></td>
<td><?php if($record1[$i]->Q6W3=='1'){echo "Public Health Engineering Department (PHED)";} else{ echo'000.000';} ?></td>
<td><?php if($record1[$i]->Q6W4=='1'){echo "Private supplier";} else{ echo'000.000';} ?></td>
<td><?php if($record1[$i]->Q6W5=='1'){echo "School’s own supply (bore well, rainwater harvesting facility, etc)";} else{ echo'000.000';} ?></td>
...
<td><?php if($record1[$i]->Q8W1S1=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W1S1=="N"){ echo "No"; }
if($record1[$i]->Q8W1S1==""){ echo "000.000"; } ?></td>
<td><?php if($record1[$i]->Q8W1S2=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W1S2=="N"){ echo "No"; }
if($record1[$i]->Q8W1S2==""){ echo "000.000"; } ?></td>
<td><?php if($record1[$i]->Q8W1S3=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W1S3=="N"){ echo "No"; }
if($record1[$i]->Q8W1S3==""){ echo "000.000"; } ?></td>
<td><?php if($record1[$i]->Q8W1S4=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W1S4=="N"){ echo "No"; }
if($record1[$i]->Q8W1S4==""){ echo "000.000"; } ?></td>
<td><?php if($record1[$i]->Q8W1S5=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W1S5=="N"){ echo "No"; }
if($record1[$i]->Q8W1S5==""){ echo "000.000"; } ?></td>
<td><?php if($record1[$i]->Q8W1S6=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W1S6=="N"){ echo "No"; }
if($record1[$i]->Q8W1S6==""){ echo "000.000"; } ?></td>
<td><?php if($record1[$i]->Q8W1S7=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W1S7=="N"){ echo "No"; }
if($record1[$i]->Q8W1S7==""){ echo "000.000"; } ?></td>
<td><?php if($record1[$i]->Q8W1S8=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W1S8=="N"){ echo "No"; }
if($record1[$i]->Q8W1S8==""){ echo "000.000"; } ?></td>
<td><?php if($record1[$i]->Q8W1S9=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W1S9=="N"){ echo "No"; }
if($record1[$i]->Q8W1S9==""){ echo "000.000"; } ?></td>
<td><?php if($record1[$i]->Q8W1S10=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W1S10=="N"){ echo "No"; }
if($record1[$i]->Q8W1S10==""){ echo "000.000"; } ?></td>
<td><?php if($record1[$i]->Q8W1S11=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W1S11=="N"){ echo "No"; }
if($record1[$i]->Q8W1S11==""){ echo "000.000"; } ?></td>
<td><?php if($record1[$i]->Q8W2=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W2=="N"){ echo "No"; }
if($record1[$i]->Q8W2==""){ echo "000.000"; } ?></td>
<td><?php if($record1[$i]->Q8W2S1=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W2S1=="N"){ echo "No"; }
if($record1[$i]->Q8W2S1==""){ echo "000.000"; } ?></td>
...
<td><?php if($record1[$i]->QSW2S2W1=='1'){echo "Drinking, ";}
if($record1[$i]->QSW2S2W2=='1'){echo "Gardening, ";}
if($record1[$i]->QSW2S2W3=='1'){echo "Mopping, ";}
if($record1[$i]->QSW2S2W4=='1'){echo "Toilets, ";}
if($record1[$i]->QSW2S2W5=='1'){echo "Washing vehicles, ";}
if($record1[$i]->QSW2S2W6=='1'){echo "Kitchen (Cooking/Washing vegetables and utensils), ";}
if($record1[$i]->QSW2S2W7=='1'){echo "Shower, Brushing teeth, Bathing, Hand washing, ";}
if($record1[$i]->QSW2S2W8=='1'){echo "Swimming Pool, ";}
if($record1[$i]->QSW2S2W9=='1'){echo "Fire fighting, ";}
if($record1[$i]->QSW2S2W10=='1'){echo "Desert coolers";}
if($record1[$i]->QSW2S2W1!='1' && $record1[$i]->QSW2S2W2!='1' && $record1[$i]->QSW2S2W3!='1' && $record1[$i]->QSW2S2W4!='1' && $record1[$i]->QSW2S2W5!='1' && $record1[$i]->QSW2S2W6!='1' && $record1[$i]->QSW2S2W7!='1' && $record1[$i]->QSW2S2W8!='1' && $record1[$i]->QSW2S2W9!='1' && $record1[$i]->QSW2S2W10!='1'){echo '000.000' ;}  ?></td>
<td><?php if($record1[$i]->Q8W2S2S2=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W2S2S2=="N"){ echo "No"; }
if($record1[$i]->Q8W2S2S2==""){ echo "000.000"; } ?></td>
<td><?php if($record1[$i]->Q8W2S2S7=="Y"){ echo "Yes"; }
elseif($record1[$i]->Q8W2S2S7=="N"){ echo "No"; }
else{ echo $record1[$i]->Q8W2S2S7; } ?></td>
<td><?php if($record1[$i]->Q8W2S2S10=="1"){ echo "Storage = Recharge"; }
elseif($record1[$i]->Q8W2S2S10=="2"){ echo "Storage > Storag"; }
elseif($record1[$i]->Q8W2S2S10=="3"){ echo "Recharge > Storag"; }
elseif($record1[$i]->Q8W2S2S10=="4"){ echo "Only recharge"; }
elseif($record1[$i]->Q8W2S2S10=="5"){ echo "Only storage"; }
else{ echo $record1[$i]->Q8W2S2S10; } ?></td>
<td><?php if($record1[$i]->Q8W2S4=='1'){echo "10 to 20 per cent";}
...
?></td>
<td><?php if($record1[$i]->Q8W2S4S1=="1"){ echo "Before storage tank"; }
...
else{ echo $record1[$i]->Q8W2S4S1; } ?></td>
<td><?php echo  $record1[$i]->Q8W2S4S22; ?></td>
<td><?php if($record1[$i]->Q8W2S5=='1'){echo "Good";}
elseif($record1[$i]->Q8W2S5=='2'){echo "Average";}
elseif($record1[$i]->Q8W2S5=='3'){echo "Poor";}
else{echo '000.000' ;}
?></td>
<td><?php if($record1[$i]->Q8W2S61=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W2S61=="N"){ echo "No"; }
if($record1[$i]->Q8W2S61==""){ echo "000.000"; } ?></td>
<td><?php if($record1[$i]->Q8W2S7=='1'){echo "Pre-monsoon";}
elseif($record1[$i]->Q8W2S7=='2'){echo "Post-monsoon";}
elseif($record1[$i]->Q8W2S7=='3'){echo "Do not follow any such pattern";}
else{echo '000.000' ;}?></td>
<td><?php if($record1[$i]->Q8W2S8=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W2S8=="N"){ echo "No"; }
if($record1[$i]->Q8W2S8==""){ echo "000.000"; } ?></td>
<td><?php if($record1[$i]->Q8W2S9=='1'){echo "Pre-monsoon";}
elseif($record1[$i]->Q8W2S9=='2'){echo "Post-monsoon";}
elseif($record1[$i]->Q8W2S9=='3'){echo "Do not follow any such pattern";}
else{echo '000.000' ;} ?></td>
<td><?php if($record1[$i]->Q8W2S10=='1'){echo "If there was a decrease, please specify";}
elseif($record1[$i]->Q8W2S10=='2'){echo "If there was an increase, please specify";}
elseif($record1[$i]->Q8W2S10=='3'){echo "No change";} 
else{echo '000.000' ;}
?></td>
<td><?php if($record1[$i]->Q8W2S12=='1'){echo "Less than a metre annually";}
elseif($record1[$i]->Q8W2S12=='2'){echo "1-5 metre annually";}
elseif($record1[$i]->Q8W2S12=='3'){echo "More than 5 metres annually";} 
else{echo '000.000' ;}
?></td>
<td><?php if($record1[$i]->Q8W2S13=="Y"){ echo "Yes"; }
if($record1[$i]->Q8W2S13=="N"){ echo "No"; }
if($record1[$i]->Q8W2S13==""){ echo "000.000"; } ?></td>
...
<td><?php if($record1[$i]->Q21W1=="Y"){ echo "Yes"; }
if($record1[$i]->Q21W1=="N"){ echo "No"; }
if($record1[$i]->Q21W1==""){ echo "000.000"; } ?></td>
...
<td><?php $ventilated1 = getFiledValue('Q20W2',$record1[$i]->userid); if($ventilated1[0]->answer=="1"){echo "Gardening, ";}
$ventilated2 = getFiledValue('Q20W21',$record1[$i]->userid); if($ventilated2[0]->answer=="2"){echo "Flushing, ";}
$ventilated3 = getFiledValue('Q20W22',$record1[$i]->userid); if($ventilated3[0]->answer=="3"){echo "Recharge Ground Water, ";}
$ventilated4 = getFiledValue('Q20W23',$record1[$i]->userid); if($ventilated4[0]->answer=="4"){echo "Cleaning (mopping, washing vehicles, etc)";}
if($ventilated1[0]->answer=="" && $ventilated2[0]->answer=="" && $$ventilated3[0]->answer=="" && $ventilated4[0]->answer==""){
    echo "000.000";
} 
...
if($record1[$i]->Q4Wa1==""){ echo "000.000"; } ?></td>
        ...
        <td><?php if($record1[$i]->e_waste_recycling_procedures!='') {echo $record1[$i]->e_waste_recycling_procedures;} else {echo '000.000';} ?></td>
        <td><?php if($record1[$i]->hazardous_waste_recycling_procedures!='') {echo $record1[$i]->hazardous_waste_recycling_procedures;} else {echo '000.000';} ?></td>
        <td><?php if($record1[$i]->wood_glass_metal_recycling_procedures!='') {echo $record1[$i]->wood_glass_metal_recycling_procedures;} else {echo '000.000';} ?></td>
        <td><?php if($record1[$i]->biomedical_waste_recycling_procedures!='') {echo $record1[$i]->biomedical_waste_recycling_procedures;} else {echo '000.000';} ?></td>
        <td><?php if($record1[$i]->others_recycling_procedures!='') {echo $record1[$i]->others_recycling_procedures;} else {echo '000.000';} ?></td>
