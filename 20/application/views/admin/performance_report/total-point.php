      ...
      <thead>
       ...
       <th>S.No</th>
		...
		<th>Electricity Bill</th>
				...
				<th>Per capita per day Energy Consumption of Schools</th>
				<th>Per capita per day Energy Consumption Point</th>
		...
		?>
    		...
    		<td><?php echo $record1[$i]->air_points; ?></td>
			  ...
			  <td><?php echo $record1[$i]->Q4E1; ?></td>
				...
				<td><?php echo $record1[$i]->per_day_energy_consumption ; ?></td>
				<td><?php echo $record1[$i]->per_day_energy_point ; ?></td>
