...
.principal{ position:relative; text-align: center; top:300px;}
.school_name1{ position:relative; text-align: center; top:305px; font-size: 20px; margin-left: 25px;}
.school_name{ position:relative; text-align: center; top:305px; margin-left: 25px;}
