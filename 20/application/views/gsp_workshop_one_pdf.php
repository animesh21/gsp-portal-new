...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  if (!empty($teachers)) {
    ...
    if ($teacher->name_of_participant !="") {
        ...
        <div class='image'><img src='assets/img/images/certificate_workshop_one.jpg' width='1000' height='700'></div>";
...
.school_name1{ position:relative; text-align: center; top:255px; font-size: 20px; margin-left: 25px;}
