...
class School_model extends CI_Model
{
    ...
    public function RegisterUser($argPost)
    {
        ...
        if ($this->db->insert('gsp_school', $update)) {
            ...
            $msg .= "Given the current health crisis, GSP Audit 2020 will now open after July 2020. We will inform you as and when it opens. Please stay tuned to our email updates. To participate, please remember to save your username and password given below.<br><br>";
