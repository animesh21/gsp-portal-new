...
?>)</span></h1>
        ...
        <div class="form-group" id="ebill">
            ...
            <br>
            <?php
            $arrImages = getUploadData(str_replace(' ', '_', $school->name) . '_Electricity_Bill_', $schoolUserID);
            if (!empty($arrImages)) {
                ?>
        ...
        <div class="form-group">
            ...
            <table class="table table-bordered question uploadedfiles">
                <tr><th>Source of energy</th><th>Quantity consumed/monthly average</th><th>Energy consumed in Megajoules (mj)</th><th>Type of use</th></tr>
                <tr><th>Electricity from the board (kwh)</th><th><?php echo (getFiled('Q6E1S1', $schoolUserID) != "") ? getFiled('Q6E1S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E1S2', $schoolUserID) != "") ? getFiled('Q6E1S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E1S3', $schoolUserID) != "") ? getFiled('Q6E1S3', $schoolUserID) : "N/A"; ?></th></tr>

                <tr>
                    <th>
                        Electricity from generator (diesel) (litres)</th><th><?php echo (getFiled('Q6E2S1', $schoolUserID) != "") ? getFiled('Q6E2S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E2S2', $schoolUserID) != "") ? getFiled('Q6E2S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E2S3', $schoolUserID) != "") ? getFiled('Q6E2S3', $schoolUserID) : "N/A"; ?></th></tr>

                <tr>
                    <th>
                        Petrol (litres)</th><th><?php echo (getFiled('Q6E3S1', $schoolUserID) != "") ? getFiled('Q6E3S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E3S2', $schoolUserID) != "") ? getFiled('Q6E3S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E3S3', $schoolUserID) != "") ? getFiled('Q6E3S3', $schoolUserID) : "N/A"; ?></th></tr>


                <tr>
                    <th>
                        Diesel (litres)</th><th><?php echo (getFiled('Q6E4S1', $schoolUserID) != "") ? getFiled('Q6E4S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E4S2', $schoolUserID) != "") ? getFiled('Q6E4S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E4S3', $schoolUserID) != "") ? getFiled('Q6E4S3', $schoolUserID) : "N/A"; ?></th></tr>

                <tr>
                    <th>
                        CNG (kilogrammes)</th><th><?php echo (getFiled('Q6E5S1', $schoolUserID) != "") ? getFiled('Q6E5S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E5S2', $schoolUserID) != "") ? getFiled('Q6E5S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E5S3', $schoolUserID) != "") ? getFiled('Q6E5S3', $schoolUserID) : "N/A"; ?></th></tr>


                <tr>
                    <th>
                        Kerosene (litres)</th><th><?php echo (getFiled('Q6E6S1', $schoolUserID) != "") ? getFiled('Q6E6S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E6S2', $schoolUserID) != "") ? getFiled('Q6E6S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E6S3', $schoolUserID) != "") ? getFiled('Q6E6S3', $schoolUserID) : "N/A"; ?></th></tr>


                <tr>
                    <th>
                        Coal (kilogrammes)</th><th><?php echo (getFiled('Q6E7S1', $schoolUserID) != "") ? getFiled('Q6E7S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E7S2', $schoolUserID) != "") ? getFiled('Q6E7S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E7S3', $schoolUserID) != "") ? getFiled('Q6E7S3', $schoolUserID) : "N/A"; ?></th></tr>


                <tr>
                    <th>
                        Wood (kilogrammes)</th><th><?php echo (getFiled('Q6E16S1', $schoolUserID) != "") ? getFiled('Q6E16S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E16S2', $schoolUserID) != "") ? getFiled('Q6E16S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E16S3', $schoolUserID) != "") ? getFiled('Q6E16S3', $schoolUserID) : "N/A"; ?></th></tr>

                <tr>
                    <th>
                        Animal waste (kilogrammes)</th><th><?php echo (getFiled('Q6E8S1', $schoolUserID) != "") ? getFiled('Q6E8S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E8S2', $schoolUserID) != "") ? getFiled('Q6E8S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E8S3', $schoolUserID) != "") ? getFiled('Q6E8S3', $schoolUserID) : "N/A"; ?></th></tr>


                <tr>
                    <th>
                        Solar (kwh)</th><th><?php echo (getFiled('Q6E9S1', $schoolUserID) != "") ? getFiled('Q6E9S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E9S2', $schoolUserID) != "") ? getFiled('Q6E9S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E9S3', $schoolUserID) != "") ? getFiled('Q6E9S3', $schoolUserID) : "N/A"; ?></th></tr>


                <tr>
                    <th>
                        Wind (kwh)</th><th><?php echo (getFiled('Q6E10S1', $schoolUserID) != "") ? getFiled('Q6E10S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E10S2', $schoolUserID) != "") ? getFiled('Q6E10S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E10S3', $schoolUserID) != "") ? getFiled('Q6E10S3', $schoolUserID) : "N/A"; ?></th></tr>

                <tr>
                    <th>
                        LPG (kilogrammes)</th><th><?php echo (getFiled('Q6E11S1', $schoolUserID) != "") ? getFiled('Q6E11S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E11S2', $schoolUserID) != "") ? getFiled('Q6E11S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E11S3', $schoolUserID) != "") ? getFiled('Q6E11S3', $schoolUserID) : "N/A"; ?></th></tr>

                <tr>
                    <th>

                        Piped Natural Gas (kilogrammes)</th><th><?php echo (getFiled('Q6E12S1', $schoolUserID) != "") ? getFiled('Q6E12S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E12S2', $schoolUserID) != "") ? getFiled('Q6E12S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E12S3', $schoolUserID) != "") ? getFiled('Q6E12S3', $schoolUserID) : "N/A"; ?></th></tr>

                <tr>
                    <th>

                        Biogas</th><th><?php echo (getFiled('Q6E13S1', $schoolUserID) != "") ? getFiled('Q6E13S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E13S2', $schoolUserID) != "") ? getFiled('Q6E13S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E13S3', $schoolUserID) != "") ? getFiled('Q6E13S3', $schoolUserID) : "N/A"; ?></th></tr>


                <tr>
                    <th>

                        Others (specify)</th><th><?php echo (getFiled('Q6E14S1', $schoolUserID) != "") ? getFiled('Q6E14S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E14S2', $schoolUserID) != "") ? getFiled('Q6E14S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E14S3', $schoolUserID) != "") ? getFiled('Q6E14S3', $schoolUserID) : "N/A"; ?></th></tr>


                <tr>
                    <th>

                        Total</th><th><?php echo (getFiled('Q6E15S1', $schoolUserID) != "") ? getFiled('Q6E15S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q6E15S2', $schoolUserID) != "") ? getFiled('Q6E15S2', $schoolUserID) : "N/A"; ?></th><th></th></tr>
        ...
        <div class="form-group">
            ...
            <?php
            $arrImages = getUploadData(str_replace(' ', '_', $school->name) . '_Fuels_Bills_', $schoolUserID);
            if (!empty($arrImages)) {
                ?>
                <table width="100%" class="table">
                    <thead>
        ...
        <div class="form-group">
            ...
            <?php
            $arrImages = getUploadData(str_replace(' ', '_', $school->name) . '_Five_Star_Appliances_', $schoolUserID);
            if (!empty($arrImages)) {
                ?>
                <table width="100%" class="table">
                    <thead>
        ...
        <div class="form-group" id="alternativeEnergy">
            ...
            <br>
            <?php
            $arrImages = getUploadData(str_replace(' ', '_', $school->name) . '_Alternative_Source_of_Energy_', $schoolUserID);
            if (!empty($arrImages)) {
                ?>
                <table width="100%" class="table">
                    <thead>
        ...
        <div class="text-center">
            ...
            <a class="btn org-btn" href="<?php echo base_url('admin/audit_started_2017/food/' . $id) ?>">NEXT</a>
        </div>
    </div>
</div>
</div>
