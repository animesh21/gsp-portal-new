        ...
        <form action="http://localhost/gsp-portal-new/food/set" id="food" method="post" accept-charset="utf-8">
            <div class="form-group">
                ...
                <div class="form-group" id="meals1">
                    ...
                    <?php
                    $arrImages = getUploadData(str_replace(' ', '_', $school->name) . '_Mid_Day_Meal_', $schoolUserID);
                    if (!empty($arrImages)) {
                        ?>
...
<!--<input type="text" id="Q5F1S3A" name="Q5F1S3" class="form-control space-textbox" placeholder="" value="">-->
                        ...
                        <tbody>
                            <?php foreach ($midDayMeal as $f) { ?>
                                <tr id="index<?php echo $f->id; ?>">
                                    ...
                                    <td><a href="<?php echo base_url() ?>admin/audit_started_2017/download_file/<?php echo $f->file_name ?>"><span class="glyphicon glyphicon-download-alt"></span></a></td>
    ...
    <div class="form-group" id="Q13F2" style="display:block">
        ...
        <br/>
<?php echo (getFiled('Q13F2', $schoolUserID) != "") ? getFiled('Q13F2', $schoolUserID) : "N/A"; ?>
    ...
    <div class="form-group">
        ...
        size per document should not  exceed 500 KB.<br>
