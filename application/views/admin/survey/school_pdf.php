<html>
    ...
    <body>
        ...
        <div class="cover">
            ...
            <img src="<?php echo base_url() ?>assets/img/images/logo.png" width="436" height="118" class="logo">
            <h1>Responses For Green Schools Programme Audit 2015</h1>
            <div class="school-detail">
                <p><span>School Name:</span>
                    <span><?php echo $school->name; ?></span></p>
                <p><span>Address:</span>
                    <span><?php echo $school->address1; ?>, <?php echo $school->address2; ?></span></p>
                <p><span>Coordinator Name:</span>
                    <span><?php echo $school->coname; ?></span></p>
            </div>
            <div class="address-wrap">
                <img src="<?php echo base_url() ?>assets/img/images/cover.png" width="100%">
              ...
              <!--  <li>
                ...
                <li>
                    ...
                    <table class="table">
                        ...
                        <tr><td>
                            ...
                            <td>
                                <?php echo (getFiled('Q4G1S1', $schoolUserID) != "") ? getFiled('Q4G1S1', $schoolUserID) : "N/A"; ?>

                            </td>
                            <td>
                                <?php echo (getFiled('Q4G1S2', $schoolUserID) != "") ? getFiled('Q4G1S2', $schoolUserID) : "N/A"; ?>

                            </td>
                            <td>
                                <?php echo (getFiled('Q4G1S3', $schoolUserID) != "") ? getFiled('Q4G1S3', $schoolUserID) : "N/A"; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo (getFiled('Q4G2S1', $schoolUserID) != "") ? getFiled('Q4G2S1', $schoolUserID) : "N/A"; ?>

                            </td>
                            <td>
                                <?php echo (getFiled('Q4G2S2', $schoolUserID) != "") ? getFiled('Q4G2S2', $schoolUserID) : "N/A"; ?>

                            </td>
                            <td>
                                <?php echo (getFiled('Q4G2S3', $schoolUserID) != "") ? getFiled('Q4G2S3', $schoolUserID) : "N/A"; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo (getFiled('Q4G3S1', $schoolUserID) != "") ? getFiled('Q4G3S1', $schoolUserID) : "N/A"; ?>

                            </td>
                            <td>
                                <?php echo (getFiled('Q4G3S2', $schoolUserID) != "") ? getFiled('Q4G3S2', $schoolUserID) : "N/A"; ?>

                            </td>
                            <td>
                                <?php echo (getFiled('Q4G3S3', $schoolUserID) != "") ? getFiled('Q4G3S3', $schoolUserID) : "N/A"; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo (getFiled('Q4G4S1', $schoolUserID) != "") ? getFiled('Q4G4S1', $schoolUserID) : "N/A"; ?>

                            </td>
                            <td>
                                <?php echo (getFiled('Q4G4S2', $schoolUserID) != "") ? getFiled('Q4G4S2', $schoolUserID) : "N/A"; ?>

                            </td>
                            <td>
                                <?php echo (getFiled('Q4G4S3', $schoolUserID) != "") ? getFiled('Q4G4S3', $schoolUserID) : "N/A"; ?>
                ...
                <li>
                    <p class="orange"><span class="cube">4(c)</span>How many family members stay in the
                        school campus? </p>
                    <p><?php echo (getFiled('Q5G2', $schoolUserID) != "") ? getFiled('Q5G2', $schoolUserID) : "N/A"; ?>
                    </p>
        ...
        <h2 class="heading section air page_break"><img src="<?php echo base_url() ?>assets/img/images/air.png" width="94" height="94">Air</h2>
        ...
        <p class="orange"><span>5.1</span><span> How many students suffer from respiratory ailments ?</span></p>
        <p><?php echo (getFiled('Q8A1', $schoolUserID) != "") ? getFiled('Q8A1', $schoolUserID) : "N/A"; ?></p>


        <p class="orange"><span>5.2</span><span> Does the school laboratory have air quality monitoring equipment?</span></p>
        ...
        <p>
            ...
            <br>Please upload all supporting documents related to this section here. Note: files must be in one of the
    ...
    <div class="form-group" id="lab" style="display: block;">6(a)If No, is there an air quality monitoring station(private or government) close to your school?</label>
...
<h2 class="heading section energy page_break"><img src="<?php echo base_url() ?>assets/img/images/energy.png" width="94" height="94">Energy</h2>
<div class="wrapper">
    <div class="task-area">
        ...
        <ul class="list">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td><?php echo (getFiled('Q6E1S2', $schoolUserID) != "") ? getFiled('Q6E1S2', $schoolUserID) : "N/A"; ?>
                    </td><td><?php echo (getFiled('Q6E1S3', $schoolUserID) != "") ? getFiled('Q6E1S3', $schoolUserID) : "N/A"; ?>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><?php echo (getFiled('Q6E16S1', $schoolUserID) != "") ? getFiled('Q6E16S1', $schoolUserID) : "N/A"; ?>
                    </td><td><?php echo (getFiled('Q6E16S2', $schoolUserID) != "") ? getFiled('Q6E16S2', $schoolUserID) : "N/A"; ?></td>
            ...
            <li>
                ...
                <table class="table">
                    <tr><th>Appliances/Equipments</th><th>Number</th><th>Size</th><th>BEE Star Rating</th></tr>
                    <tr><th>Air Conditioners</th><th><?php echo (getFiled('Q7E2S1', $schoolUserID) != "") ? getFiled('Q7E2S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q7E2S2', $schoolUserID) != "") ? getFiled('Q7E2S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q7E2S3', $schoolUserID) != "") ? getFiled('Q7E2S3', $schoolUserID) : "N/A"; ?></th></tr>
                    <tr><th>Refrigerator</th><th><?php echo (getFiled('Q7E3S1', $schoolUserID) != "") ? getFiled('Q7E3S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q7E3S2', $schoolUserID) != "") ? getFiled('Q7E3S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q7E3S3', $schoolUserID) != "") ? getFiled('Q7E3S3', $schoolUserID) : "N/A"; ?></th></tr>
                    <tr><th>Microwave</th><th><?php echo (getFiled('Q7E4S1', $schoolUserID) != "") ? getFiled('Q7E4S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q7E4S2', $schoolUserID) != "") ? getFiled('Q7E4S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q7E4S3', $schoolUserID) != "") ? getFiled('Q7E4S3', $schoolUserID) : "N/A"; ?></th></tr>
                    <tr><th>Tube Lights</th><th><?php echo (getFiled('Q7E5S1', $schoolUserID) != "") ? getFiled('Q7E5S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q7E5S2', $schoolUserID) != "") ? getFiled('Q7E5S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q7E5S3', $schoolUserID) != "") ? getFiled('Q7E5S3', $schoolUserID) : "N/A"; ?></th></tr>
                    <tr><th>CFL Bulbs</th><th><?php echo (getFiled('Q7E6S1', $schoolUserID) != "") ? getFiled('Q7E6S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q7E6S2', $schoolUserID) != "") ? getFiled('Q7E6S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q7E6S3', $schoolUserID) != "") ? getFiled('Q7E6S3', $schoolUserID) : "N/A"; ?></th></tr>
                    <tr><th>LED Lights</th><th><?php echo (getFiled('Q7E7S1', $schoolUserID) != "") ? getFiled('Q7E7S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q7E7S2', $schoolUserID) != "") ? getFiled('Q7E7S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q7E7S3', $schoolUserID) != "") ? getFiled('Q7E7S3', $schoolUserID) : "N/A"; ?></th></tr>
                    <tr><th>Fans</th><th><?php echo (getFiled('Q7E8S1', $schoolUserID) != "") ? getFiled('Q7E8S1', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q7E8S2', $schoolUserID) != "") ? getFiled('Q7E8S2', $schoolUserID) : "N/A"; ?></th><th><?php echo (getFiled('Q7E8S3', $schoolUserID) != "") ? getFiled('Q7E8S3', $schoolUserID) : "N/A"; ?></th></tr>
    ...
    <div class="task-area">
        ...
        <p class="orange"><span>3.1</span><span> What is the average number of sunny days in your area?</span></p>
...
<h2 class="heading section food page_break"><img src="<?php echo base_url() ?>assets/img/images/food.png" width="94" height="94">Food</h2>
<div class="wrapper">
    <div class="task-area">
    ...
    <div class="task-area">
        ...
        <ul class="list">
            ...
            <li>
                <p class="orange"><label class="control-label">Please upload picture of Mid-day meal being served</label><p>
                <table class="table">
                    <tr>
                        <th>image</th>
                        <th>File name</th>
    ...
    <div class="task-area">
        ...
        <ul class="list">
            <p class="orange"><span>3.1</span>What  kind of food is being served / sold in your school?</p>
            <table class="table">
                <tr>
            ...
            <li>
                <p class="orange"><span>3.2</span>Does your school serve traditional Indian snacks?</p>
                <p><?php echo (getFiled('Q7F1', $schoolUserID) != "") ? (getFiled('Q7F1', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p> 					   

            </li>
            <p class="orange"><span>3.2(a)</span>Please provide the details: </p>
            <table class="table">
                <tr>
            ...
            <p class="orange"><span>3.2(b)</span>Give descriptions for rare local snacks served in your school:</p>
            <p><?php echo (getFiled('Q7F3S1', $schoolUserID) != "") ? getFiled('Q7F3S1', $schoolUserID) : "N/A"; ?>                                                                                               
            </p>
            <p class="orange"><span>4</span>Doesyourschool serve traditional Indian  beverages?</p>
            <p> <?php echo (getFiled('Q8F1', $schoolUserID) != "") ? (getFiled('Q8F1', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>                                                                                                </ul>

        <p class="orange"><span>4(a)</span>Please provide details: </p>
        <table class="table">
            <tr>
    ...
    <div class="task-area">
        ...
        <p class="orange"><span>4.1</span>Does the school distribute packaged food items as rewards during schools events?</p>
        <p> <?php echo (getFiled('Q9F1', $schoolUserID) != "") ? (getFiled('Q9F1', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>																									

        <p class="orange"><span>4.1.a</span>Please provide details: </p>
        <p><?php echo (getFiled('Q9F2', $schoolUserID) != "") ? getFiled('Q9F2', $schoolUserID) : "N/A"; ?></p>																									

        <p class="orange"><span>4.2</span>Does the school distribute chocolates/similar
        ...
        <p class="orange"><span>4.2.a</span>Please provide the names:</p>
    ...
    <div class="support_files_head">
        <label class="orange">Please upload pictures your Audit Team doing the survey</label>
        <p>
...
<div style="text-align: center; padding: 0;">&nbsp;&nbsp;&nbsp;&nbsp;</div>
<h2 class="heading section land page_break"><img src="<?php echo base_url() ?>assets/img/images/land.png" width="94" height="94">Land</h2>
...
<div class="wrapper">
    ...
    <div class="task-area">
        ...
        <p class="orange"><span>2.1</span> What is the total site/plot area of your school?</p>
        <table class="table">
            <tr><th>Description</th> 
                <th>Your school's area (m<Sup>2</Sup>)</th></tr> 
            <tr><td>Site area in square meter (m<Sup>2</Sup>)</td> 
                <td><?php echo (getFiled('Q4L1', $schoolUserID) != "") ? getFiled('Q4L1', $schoolUserID) : "N/A"; ?></td></tr> 
            <tr><td colspan="2"><label><span class="cube">1A</span>Total green cover</label></td></tr>
            <tr><td>(a) Ground coverage area</td>
                <td><?php echo (getFiled('Q4L2', $schoolUserID) != "") ? getFiled('Q4L2', $schoolUserID) : "N/A"; ?></td></tr> 
            <tr><td>(b1) Green Landscaped area on ground</td> 
                <td><?php echo (getFiled('Q4L3', $schoolUserID) != "") ? getFiled('Q4L3', $schoolUserID) : "N/A"; ?></td></tr> 
            <tr><td>(b2) Play area that has grass on ground</td> 
                <td><?php echo (getFiled('Q4L4', $schoolUserID) != "") ? getFiled('Q4L4', $schoolUserID) : "N/A"; ?></td></tr> 
            <tr><td>(b3) Green area on ground</td> 
                <td><?php echo (getFiled('Q4L5', $schoolUserID) != "") ? getFiled('Q4L5', $schoolUserID) : "N/A"; ?></td></tr> 
            <tr><td>(c) Play area that is paved/concrete on ground</td> 
                <td><?php echo (getFiled('Q4L6', $schoolUserID) != "") ? getFiled('Q4L6', $schoolUserID) : "N/A"; ?></td></tr> 
            <tr><td>(d) Surface parking area</td> 
                <td><?php echo (getFiled('Q4L7', $schoolUserID) != "") ? getFiled('Q4L7', $schoolUserID) : "N/A"; ?></td></tr> 
            <tr><td>(e) Service area on ground</td>
                <td><?php echo (getFiled('Q4L8', $schoolUserID) != "") ? getFiled('Q4L8', $schoolUserID) : "N/A"; ?></td></tr> 
            <tr><td colspan="2"><label><span class="cube">1B</span>Other General Area in Campus</label></td></tr>
            <tr><td>(i) Roof and terrace area</td> 
                <td><?php echo (getFiled('Q4L9', $schoolUserID) != "") ? getFiled('Q4L9', $schoolUserID) : "N/A"; ?></td></tr> 
            <tr><td>(ii) Green cover on exposed roof and terrace</td>
                <td><?php echo (getFiled('Q4L10', $schoolUserID) != "") ? getFiled('Q4L10', $schoolUserID) : "N/A"; ?></td></tr> 
            <tr><td>(iii) Total built-up/constructed area</td> 
                <td><?php echo (getFiled('Q4L11', $schoolUserID) != "") ? getFiled('Q4L11', $schoolUserID) : "N/A"; ?></td></tr> 
            <tr><td>(iv) Total number of floors (excluding ground floor) </td> 
                <td><?php echo (getFiled('Q4L12', $schoolUserID) != "") ? getFiled('Q4L12', $schoolUserID) : "N/A"; ?></td></tr> 
        </table>
    </div>    
    <div class="task-area">
        ...
        <p class="orange"><span>3.1</span> How many species of plants and animals exist in your school?</p>
        ...
        <table class="table">
            ...
            <tr>
                <td>Plants</td>
                <td>
                    <?php echo (getFiled('Q5L1S1', $schoolUserID) != "") ? getFiled('Q5L1S1', $schoolUserID) : "N/A"; ?>
                </td>
                <td>
                    <?php echo (getFiled('Q5L1S2', $schoolUserID) != "") ? getFiled('Q5L1S2', $schoolUserID) : "N/A"; ?>
                </td>
                <td>
                    <?php echo (getFiled('Q5L1S3', $schoolUserID) != "") ? getFiled('Q5L1S3', $schoolUserID) : "N/A"; ?>
                </td>
            </tr>
            <tr>
                <td>Animals</td>
                <td>
                    <?php echo (getFiled('Q5L2S1', $schoolUserID) != "") ? getFiled('Q5L2S1', $schoolUserID) : "N/A"; ?>
                </td>
                <td><?php echo (getFiled('Q5L2S2', $schoolUserID) != "") ? getFiled('Q5L2S2', $schoolUserID) : "N/A"; ?>
                </td>
                <td><?php echo (getFiled('Q5L2S3', $schoolUserID) != "") ? getFiled('Q5L2S3', $schoolUserID) : "N/A"; ?>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="task-area">
        ...
        <p class="orange"><span>4.1</span>Do you use chemical-based pesticides in your school green cover?</p>
        <p> <?php echo (getFiled('Q6L1', $schoolUserID) != "") ? (getFiled('Q6L1', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>

    </div>
    <div class="support_files_head">
        <label class="orange">Please Upload supporting documents</label>
...
<h2 class="heading section waterpage_break"><img src="<?php echo base_url() ?>assets/img/images/water.png" width="94" height="94">Water</h2>
<div class="wrapper">
    <div class="task-area">
            ...
            <li>        
                ...
                <ul>
                    <li> If water from water storage tank is used with hose pipes then measure the capacity of storage tank.
                        ...
                        the tank. Subtract the quantity of water left in the tank by total storage capacity of the tank.&nbsp;
                    </li>
                    ...
                    <li> If sprinkler irrigation is used to water garden, then measure the quantity of water released by the
                        sprinklers and multiply it by the time the sprinkler system &nbsp;works.&nbsp;
                    </li>
                </ul>
    ...
    <div class="task-area">
        <h3>Task 3: What Are The Sources, Supply and Storage of Water in your School? <a class="kplink" href="http://www.greenschoolsprogramme.org/knowledge-bank/water/#sourceOfWater" target="_blank"> </a>
        </h3>
        <p> To understand water, it is important to know the source of water in your school premises. As you know,
            ...
            forced to source water from further and further away. This is expensive.
        </p>
        ...
        <p class="orange"><span>3.3</span> Does your school get daily water supply?</p>
        <p> <?php echo (getFiled('Q7W1', $schoolUserID) != "") ? (getFiled('Q7W1', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>

        <p class="orange"><span>3.3.(a)</span> Does your school get daily water supply?</p>
        <ul class="list-unstyled">
            <p> <?php
        ...
        <p class="orange"><span>3.3.(b)</span> Does your school get daily water supply?</p>
        <ul>
            <p> <?php
    ...
    <div class="task-area">
        ...
        <p class="orange"><span>4.1</span> What are the water conservation practices your school follows 
        <table class="table">
            <tr>
    ...
    <div class="task-area">
        ...
        <p class="orange"><span>5.1</span>Do you have Rainwater harvesting (RWH) system in your school?</p>
        <p> <?php echo (getFiled('Q8W2', $schoolUserID) != "") ? (getFiled('Q8W2', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p> 

        <p class="orange"><span>5.1.(a)</span>Does your school harvest different catchments? </p>
        <p> <?php echo (getFiled('Q8W2S1', $schoolUserID) != "") ? (getFiled('Q8W2S1', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>

        <p class="orange"><span>5.1.(a)(1)</span>Which is the catchment area being harvested by your school? </p>
        <ul>
            <?php
        ...
        <p class="orange"><span class="cube">5.1.(b)(2)</span> Does your school have rainwater storage tank?</p>
        <p> <?php echo (getFiled('Q8W2S2S2', $schoolUserID) != "") ? (getFiled('Q8W2S2S2', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>

        <p class="orange"><span class="cube">5.1.(b)(2) A</span>If yes, please provide: </p>
        ...
        <p class="orange"><span class="cube">5.1.(b)(2) B</span>If yes, please provide: </p>
        <p><strong>Total capacity of each storage tank
                (litres): </strong><br/>
            <?php echo (getFiled('Q8W2S2S4', $schoolUserID) != "") ? getFiled('Q8W2S2S4', $schoolUserID) : "N/A"; ?>
        </p>        
        <p class="orange"><span class="cube">5.1.(b)(2) C</span>Location of tanks:</p>
        <ul>
            <?php
            if (getFiled('Q8W2S2S5', $schoolUserID) == 1):
                echo "Underground";
        ...
        <p class="orange"><span class="cube">5.1.(b)(2) D</span>Material options for tanks:</p>
        ...
        <p class="orange"><span class="cube">5.1(b)(3)</span>Does your school have groundwater recharge
            structure? </p>
        <p> <?php echo (getFiled('Q8W2S2S7', $schoolUserID) != "") ? (getFiled('Q8W2S2S7', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>

        <p class="orange"><span class="cube">5.1(b)(3) A</span>If yes, please provide: </p>
        <p><strong> Please share the total number of groundwater
                recharge structures </strong><br/>
            <?php echo (getFiled('Q8W2S2S8', $schoolUserID) != "") ? getFiled('Q8W2S2S8', $schoolUserID) : "N/A"; ?>
        </p>    

        <p class="orange"><span class="cube">5.1(b)(3) B</span>Please tick the type of groundwater recharge
        ...
        <p class="orange"><label><span class="cube">5.1(b)(4)</span>If your school practices rainwater harvesting, then
                what is the ratio between storage and recharge </label></p>
        ...
        <p class="orange"><label><span class="cube">5.1(c)</span>How much area in your school is harvested?
            </label></p>
        ...
        <p class="orange"><label><span class="cube">5.1.(d)</span>Please select (from the list given below) the rainwater
        ...
        ?>     
        <p class="orange"><label><span class="cube">5.1.(d)(1)</span> Where is your filter unit? </label></p>
        <?php
        ...
        ?>
        <p class="orange"><label><span class="cube">5.1.(d)(2)</span>Types of filter used in your school: </label>
        </p>
        <?php
        ...
        ?>     
        <p class="orange"><label><span class="cube">5.1.(e)</span>Rate your catchment on cleanliness: </label></p>
        <?php
        ...
        ?>
        <p class="orange"><label>Please upload a flow chart (hand drawn) of the wastewater treatment process.<br>
            </label></p>
        <?php
        ...
        <p class="orange"><label><span class="cube">5.1.(f)</span>Does your school clean your catchment and system
            </label></p>
        <p> <?php echo (getFiled('Q8W2S61', $schoolUserID) != "") ? (getFiled('Q8W2S61', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>

        <p class="orange"><label><span class="cube">5.1.(f)(1)</span>Please specify when does your school clean the
                catchment and RWH system? </label></p>
        <?php
        ...
        ?>
        <p class="orange"><label><span class="cube">5.1.(g)</span>Does your school monitor the rainwater harvesting
                structure for its efficiency? </label></p>
        <p> <?php echo (getFiled('Q8W2S8', $schoolUserID) != "") ? (getFiled('Q8W2S8', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>

        <p class="orange"><label><span class="cube">5.1.(g)(1)</span>Please specify when does your school monitor the
                groundwater level? </label></p>
        <?php
        ...
        ?>
        <p class="orange"><label><span class="cube">5.1.(h)</span>What is the trend of groundwater level in your school
                across the year? </label></p>
        <?php
        ...
        ?>
        <p class="orange"><label><span class="cube">5.1.(h)(1)</span>Please specify how much was the decrease? </label>
        </p>
        <?php
        ...
        ?>
        <p class="orange"><label><span class="cube">5.1.(h)(2)</span>Please specify how much was the increase? </label>
        </p>
        <?php
        ...
        ?>
        <p class="orange"><label><span class="cube">5.1.(i)</span>If your school's RWH structure is more than a year old,
        ...
        <p class="orange"><label>To calculate the maximum rainwater harvesting potential:</label></p>
        ...
        <p><strong> Note:</strong> *For Average Rainfall Data refer to Knowledge Bank: <a class="kplink" href="&#10;http://www.greenschoolsprogramme.org/knowledge-bank/water/annexure-i/" target="_blank"> </a>www.greenschoolsprogramme.org
        </p>
    </div>
    ...
    <div class="task-area">
        ...
        <p class="orange"><label><span class="cube">6.1</span>Please share details about
                sanitation and hygiene practices in your school: </label></p>
        <table class="table">
        ...
        <p class="orange"><label><span class="cube">6.2</span>How many drinking water taps do you have?</label>
        </p> <p><?php echo (getFiled('Q9W1', $schoolUserID) != "") ? getFiled('Q9W1', $schoolUserID) : "N/A"; ?></p>

        <p class="orange"><label><span class="cube">6.3</span>How many hand pumps do you have?</label>
        </p><p><?php echo (getFiled('Q10W1', $schoolUserID) != "") ? getFiled('Q10W1', $schoolUserID) : "N/A"; ?></p>

        <p class="orange"><label><span class="cube">6.4</span>How many ablution taps (taps used for washing hands only)
                do you have?</label></p>
        <p><?php echo (getFiled('Q11W1', $schoolUserID) != "") ? getFiled('Q11W1', $schoolUserID) : "N/A"; ?></p>

        <p class="orange"><label><span class="cube">6.5</span>How many water closets (used for
                defecation and urination) do you have?</label></p>
        ...
        <p class="orange"><label><span class="cube">6.6</span>How many urinals (strictly used for urination only)
                do you have?</label></p>
        <p><?php echo (getFiled('Q14W1', $schoolUserID) != "") ? getFiled('Q14W1', $schoolUserID) : "N/A"; ?></p>

        <p class="orange"><label><span class="cube">6.7</span>How many other water outlets (example: taps in play
                fields, sprinklers, swimming pool) do you have?</label></p>
        <p>
            <?php echo (getFiled('Q15W1', $schoolUserID) != "") ? getFiled('Q15W1', $schoolUserID) : "N/A"; ?>
        </p>   

        <label><strong> Water supply and cleaning of toilets in your school: </strong></label>

        <p class="orange"><label ><span class="cube">6.8</span>Is there a water storage system in
                place to supply water in the toilets?</label></p>
        <p> <?php echo (getFiled('Q16W1', $schoolUserID) != "") ? (getFiled('Q16W1', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>

        <p class="orange"><label><span class="cube">6.9</span>Is the water supply
                sufficient?</label></p>
        ...
        <p class="orange"><label><span class="cube">6.10.(a)</span>If yes, please
                specify</label></p>
        <?php
    ...
    <div class="task-area">
        ...
        <p class="orange"><span class="cube">7.1</span>Does your school treat
            wastewater?</p>
        <p> <?php echo (getFiled('Q19W1', $schoolUserID) != "") ? (getFiled('Q19W1', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>

        <p class="orange"><label><span class="cube">7.2</span>Does your school reuse the
                treated wastewater?</label></p>
        <p> <?php echo (getFiled('Q20W1', $schoolUserID) != "") ? (getFiled('Q20W1', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>

        <p class="orange"><span class="cube">7.2.(a)</span>How does your
        ...
        ?>
        <p class="orange"><label><span class="cube">7.2.(b)</span>Please specify the fate of wastewater:</label></p>
        <?php
        ...
        ?>
        <p><strong>Please upload a flow chart (hand drawn) of the wastewatertreatment process.</strong>
        </p>
        <?php
    ...
    <p class="orange"><label>Please upload supportingdocuments:</label>
    <p>
        •Pictures of audit team doing survey<br>
...
<h2 class="heading section waste page_break"><img src="<?php echo base_url() ?>assets/img/images/waste.png" width="94" height="94">Waste</h2>
<div class="wrapper">
    <div class="task-area">
    ...
    <div class="task-area">
        ...
        <p>Segregation means sorting. Let’s understand the waste segregation system because the amount of waste
            ...
            house-keeping staff to know whether waste is segregated in the school and in what quantity.
        </p>
        <p class="orange"><span class="cube">2.1</span> Does your school segregate solid waste?</p>
        <p> <?php echo (getFiled('Q4Wa1', $schoolUserID) != "") ? (getFiled('Q4Wa1', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>

        <p class="orange"><span class="cube">2.1.(a)</span> Who segregates the waste at source?</p>
        <?php
        ...
        ?>
        <p class="orange"><span class="cube">2.2</span>How many categories does your school segregate waste into? </p>
        <?php
        ...
        ?>
        <p class="orange"><span class="cube">2.2.(a)</span> How many categories does your school
        ...
        <table class="table">
            ...
            <tr>
                <td>Classrooms</td>
                <td><?php echo (getFiled('Q5Wa1S1', $schoolUserID) != "") ? getFiled('Q5Wa1S1', $schoolUserID) : "N/A"; ?>
                </td>
                <td><?php echo (getFiled('Q5Wa1S2', $schoolUserID) != "") ? getFiled('Q5Wa1S2', $schoolUserID) : "N/A"; ?>
                </td>
                <td><?php echo (getFiled('Q5Wa1S3', $schoolUserID) != "") ? getFiled('Q5Wa1S3', $schoolUserID) : "N/A"; ?>
                </td>
                <td><?php echo (getFiled('Q5Wa1S4', $schoolUserID) != "") ? getFiled('Q5Wa1S4', $schoolUserID) : "N/A"; ?>
                </td>
                <td><?php echo (getFiled('Q5Wa1S5', $schoolUserID) != "") ? getFiled('Q5Wa1S5', $schoolUserID) : "N/A"; ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    <?php echo (getFiled('Q5Wa2S1', $schoolUserID) != "") ? getFiled('Q5Wa2S1', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa2S2', $schoolUserID) != "") ? getFiled('Q5Wa2S2', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa2S3', $schoolUserID) != "") ? getFiled('Q5Wa2S3', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa2S4', $schoolUserID) != "") ? getFiled('Q5Wa2S4', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa2S5', $schoolUserID) != "") ? getFiled('Q5Wa2S5', $schoolUserID) : "N/A"; ?>
            ...
            <tr>
                ...
                <td>
                    <?php echo (getFiled('Q5Wa3S1', $schoolUserID) != "") ? getFiled('Q5Wa3S1', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa3S2', $schoolUserID) != "") ? getFiled('Q5Wa3S2', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa3S3', $schoolUserID) != "") ? getFiled('Q5Wa3S3', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa3S4', $schoolUserID) != "") ? getFiled('Q5Wa3S4', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa3S5', $schoolUserID) != "") ? getFiled('Q5Wa3S5', $schoolUserID) : "N/A"; ?>
            ...
            <tr>
                ...
                <td>
                    <?php echo (getFiled('Q5Wa4S1', $schoolUserID) != "") ? getFiled('Q5Wa4S1', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa4S2', $schoolUserID) != "") ? getFiled('Q5Wa4S2', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa4S3', $schoolUserID) != "") ? getFiled('Q5Wa4S3', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa4S4', $schoolUserID) != "") ? getFiled('Q5Wa4S4', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa4S5', $schoolUserID) != "") ? getFiled('Q5Wa4S5', $schoolUserID) : "N/A"; ?>
            ...
            <tr>
                ...
                <td>
                    <?php echo (getFiled('Q5Wa5S1', $schoolUserID) != "") ? getFiled('Q5Wa5S1', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa5S2', $schoolUserID) != "") ? getFiled('Q5Wa5S2', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa5S3', $schoolUserID) != "") ? getFiled('Q5Wa5S3', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa5S4', $schoolUserID) != "") ? getFiled('Q5Wa5S4', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa5S5', $schoolUserID) != "") ? getFiled('Q5Wa5S5', $schoolUserID) : "N/A"; ?>
            ...
            <tr>
                ...
                <td>
                    <?php echo (getFiled('Q5Wa6S1', $schoolUserID) != "") ? getFiled('Q5Wa6S1', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa6S2', $schoolUserID) != "") ? getFiled('Q5Wa6S2', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa6S3', $schoolUserID) != "") ? getFiled('Q5Wa6S3', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa6S4', $schoolUserID) != "") ? getFiled('Q5Wa6S4', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa6S5', $schoolUserID) != "") ? getFiled('Q5Wa6S5', $schoolUserID) : "N/A"; ?>
            ...
            <tr>
                ...
                <td>
                    <?php echo (getFiled('Q5Wa7S1', $schoolUserID) != "") ? getFiled('Q5Wa7S1', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa7S2', $schoolUserID) != "") ? getFiled('Q5Wa7S2', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa7S3', $schoolUserID) != "") ? getFiled('Q5Wa7S3', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa7S4', $schoolUserID) != "") ? getFiled('Q5Wa7S4', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa7S5', $schoolUserID) != "") ? getFiled('Q5Wa7S5', $schoolUserID) : "N/A"; ?>
            ...
            <tr>
                ...
                <td>
                    <?php echo (getFiled('Q5Wa8S1', $schoolUserID) != "") ? getFiled('Q5Wa8S1', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa8S2', $schoolUserID) != "") ? getFiled('Q5Wa8S2', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa8S3', $schoolUserID) != "") ? getFiled('Q5Wa8S3', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa8S4', $schoolUserID) != "") ? getFiled('Q5Wa8S4', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa8S5', $schoolUserID) != "") ? getFiled('Q5Wa8S5', $schoolUserID) : "N/A"; ?>
            ...
            <tr>
                ...
                <td>
                    <?php echo (getFiled('Q5Wa9S1', $schoolUserID) != "") ? getFiled('Q5Wa9S1', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa9S2', $schoolUserID) != "") ? getFiled('Q5Wa9S2', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa9S3', $schoolUserID) != "") ? getFiled('Q5Wa9S3', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa9S4', $schoolUserID) != "") ? getFiled('Q5Wa9S4', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa9S5', $schoolUserID) != "") ? getFiled('Q5Wa9S5', $schoolUserID) : "N/A"; ?>
            ...
            <tr>
                ...
                <td>
                    <?php echo (getFiled('Q5Wa10S1', $schoolUserID) != "") ? getFiled('Q5Wa10S1', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa10S2', $schoolUserID) != "") ? getFiled('Q5Wa10S2', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa10S3', $schoolUserID) != "") ? getFiled('Q5Wa10S3', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa10S4', $schoolUserID) != "") ? getFiled('Q5Wa10S4', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa10S5', $schoolUserID) != "") ? getFiled('Q5Wa10S5', $schoolUserID) : "N/A"; ?>
            ...
            <tr>
                ...
                <td>
                    <?php echo (getFiled('Q5Wa11S1', $schoolUserID) != "") ? getFiled('Q5Wa11S1', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa11S2', $schoolUserID) != "") ? getFiled('Q5Wa11S2', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa11S3', $schoolUserID) != "") ? getFiled('Q5Wa11S3', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa11S4', $schoolUserID) != "") ? getFiled('Q5Wa11S4', $schoolUserID) : "N/A"; ?>

                </td>
                <td>
                    <?php echo (getFiled('Q5Wa11S5', $schoolUserID) != "") ? getFiled('Q5Wa11S5', $schoolUserID) : "N/A"; ?>

                </td>
            </tr>
        </table>
        <p class="orange"><label class="control-label">Please upload supporting documents:</label></p>
        <p>
    ...
    <div class="task-area">
        ...
        <p class="orange"><label><span class="cube">3.1</span>Determine the quantity of waste generated in your school. (in kilogram) </label></p>
        <table class="table">
            <thead><h6>a. Biodegradable/Wet Waste</h6></thead>  
            <tr>
        ...
        <table class="table ">
            <thead><h6>b. Dry/recyclable waste</h6></thead>   
            <tr>
        ...
        <table class="table">
            <thead><h6>C. Domestic hazardous waste</h6></thead>   
        ...
        <table class="table">
            <thead><h6>d. Biomedical waste</h6></thead>   
            <tr>
        ...
        <table class="table">
            <thead><h6>f. Sanitary waste</h6></thead>   
            <tr>
...
<table class="table">
        ...
        <?php } ?>
        <p class="orange"><label>Please upload supporting documents:</label></p>
        <p>
    ...
    <div class="task-area">
        ...
        <p><b>To Collect Data:</b> Find out whether your school has any waste recycling facility like compost
            ...
            quantity recycled.</p>
        <p class="orange"><label><span class="cube">4.1</span>Does your school recycle any generated waste? </label>
        </p>
        <p> <?php echo (getFiled('Q8Wa1', $schoolUserID) != "") ? (getFiled('Q8Wa1', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>
        <p class="orange"><label><span class="cube">4.1.(a)</span>Please provide quantity of which is applicable</label></p>            
        <table class="table">
            <thead><h6>a. Biodegradable/Wet Waste</h6></thead> 
            <tr>
        ...
        <table class="table">
            <thead><h6>e. Biomedical waste</h6></thead>
            <tr>
        ...
        <p class="orange"><label><span class="cube">4.2</span>Does your school have a composting facility?</label></p>
        ...
        <?php } ?>
        <p class="orange"><label><span class="cube">4.2.(a)</span>What is the methodology used?</label></p>
    ...
    <p class="orange"><label for="username"><span class="cube">4.2.(b)</span>What is the quantity of compost that is generated per month (in kilogram)?</label>
    </p>
    <p><?php echo (getFiled('Q9Wa3', $schoolUserID) != "") ? getFiled('Q9Wa3', $schoolUserID) : "N/A"; ?></p>
    <p class="orange"><label><span class="cube">4.2.(c)</span> What is the purpose of the compost that is generated per month?
        </label>
    </p>
    <?php
    ...
    ?>
    <p class="orange"><label><span class="cube">4.3</span>Does your school encourage students &amp; teachers to reuse textbooks? <a class="kplink" href="http://www.greenschoolsprogramme.org/knowledge-bank/waste/#chomp" target="_blank"></a></label>
    </p> 
    <p> <?php echo (getFiled('Q10Wa1', $schoolUserID) != "") ? (getFiled('Q10Wa1', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>
    <p class="orange"><label><span class="cube">4.4</span>Please fill the table to understand whether waste recycling procedures are applied to waste. <a class="kplink" href="http://www.greenschoolsprogramme.org/knowledge-bank/waste/#whatWeDo" target="_blank"> </a></label>
    </p>
    <table class="table">
        <tr>
            <td>
            ...
            <td>
                Dumped at a designated community site 
            </td>
            <td>
                Internal procedure 
            </td>
    ...
    <?php } ?>
    <p class="orange"><label><span class="cube">4.3</span>Does your school have the following? If yes, please give the numbers of items in working condition and those that are not.</label></p>                    
    <table class="table">
        <tr>
            <td>
                Item 
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa1S1', $schoolUserID) != "") ? getFiled('Q12Wa1S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa1S2', $schoolUserID) != "") ? getFiled('Q12Wa1S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa1S3', $schoolUserID) != "") ? getFiled('Q12Wa1S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa1S4', $schoolUserID) != "") ? getFiled('Q12Wa1S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa2S1', $schoolUserID) != "") ? getFiled('Q12Wa2S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa2S2', $schoolUserID) != "") ? getFiled('Q12Wa2S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa2S3', $schoolUserID) != "") ? getFiled('Q12Wa2S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa2S4', $schoolUserID) != "") ? getFiled('Q12Wa2S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa3S1', $schoolUserID) != "") ? getFiled('Q12Wa3S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa3S2', $schoolUserID) != "") ? getFiled('Q12Wa3S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa3S3', $schoolUserID) != "") ? getFiled('Q12Wa3S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa3S4', $schoolUserID) != "") ? getFiled('Q12Wa3S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa4S1', $schoolUserID) != "") ? getFiled('Q12Wa4S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa4S2', $schoolUserID) != "") ? getFiled('Q12Wa4S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa4S3', $schoolUserID) != "") ? getFiled('Q12Wa4S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa4S4', $schoolUserID) != "") ? getFiled('Q12Wa4S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa5S1', $schoolUserID) != "") ? getFiled('Q12Wa5S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa5S2', $schoolUserID) != "") ? getFiled('Q12Wa5S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa5S3', $schoolUserID) != "") ? getFiled('Q12Wa5S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa5S4', $schoolUserID) != "") ? getFiled('Q12Wa5S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa6S1', $schoolUserID) != "") ? getFiled('Q12Wa6S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa6S2', $schoolUserID) != "") ? getFiled('Q12Wa6S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa6S3', $schoolUserID) != "") ? getFiled('Q12Wa6S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa6S4', $schoolUserID) != "") ? getFiled('Q12Wa6S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa7S1', $schoolUserID) != "") ? getFiled('Q12Wa7S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa7S2', $schoolUserID) != "") ? getFiled('Q12Wa7S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa7S3', $schoolUserID) != "") ? getFiled('Q12Wa7S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa7S4', $schoolUserID) != "") ? getFiled('Q12Wa7S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa8S1', $schoolUserID) != "") ? getFiled('Q12Wa8S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa8S2', $schoolUserID) != "") ? getFiled('Q12Wa8S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa8S3', $schoolUserID) != "") ? getFiled('Q12Wa8S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa8S4', $schoolUserID) != "") ? getFiled('Q12Wa8S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa9S3', $schoolUserID) != "") ? getFiled('Q12Wa9S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa9S4', $schoolUserID) != "") ? getFiled('Q12Wa9S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa10S1', $schoolUserID) != "") ? getFiled('Q12Wa10S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa10S2', $schoolUserID) != "") ? getFiled('Q12Wa10S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa10S3', $schoolUserID) != "") ? getFiled('Q12Wa10S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa10S4', $schoolUserID) != "") ? getFiled('Q12Wa10S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa11S1', $schoolUserID) != "") ? getFiled('Q12Wa11S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa11S2', $schoolUserID) != "") ? getFiled('Q12Wa11S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa11S3', $schoolUserID) != "") ? getFiled('Q12Wa11S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa11S4', $schoolUserID) != "") ? getFiled('Q12Wa11S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa12S1', $schoolUserID) != "") ? getFiled('Q12Wa12S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa12S2', $schoolUserID) != "") ? getFiled('Q12Wa12S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa12S3', $schoolUserID) != "") ? getFiled('Q12Wa12S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa12S4', $schoolUserID) != "") ? getFiled('Q12Wa12S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa13S1', $schoolUserID) != "") ? getFiled('Q12Wa13S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa13S2', $schoolUserID) != "") ? getFiled('Q12Wa13S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa13S3', $schoolUserID) != "") ? getFiled('Q12Wa13S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa13S4', $schoolUserID) != "") ? getFiled('Q12Wa13S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa14S1', $schoolUserID) != "") ? getFiled('Q12Wa14S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa14S2', $schoolUserID) != "") ? getFiled('Q12Wa14S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa14S3', $schoolUserID) != "") ? getFiled('Q12Wa14S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa14S4', $schoolUserID) != "") ? getFiled('Q12Wa14S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa15S1', $schoolUserID) != "") ? getFiled('Q12Wa15S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa15S2', $schoolUserID) != "") ? getFiled('Q12Wa15S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa15S3', $schoolUserID) != "") ? getFiled('Q12Wa15S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa15S4', $schoolUserID) != "") ? getFiled('Q12Wa15S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa16S1', $schoolUserID) != "") ? getFiled('Q12Wa16S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa16S2', $schoolUserID) != "") ? getFiled('Q12Wa16S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa16S3', $schoolUserID) != "") ? getFiled('Q12Wa16S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa16S4', $schoolUserID) != "") ? getFiled('Q12Wa16S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa17S1', $schoolUserID) != "") ? getFiled('Q12Wa17S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa17S2', $schoolUserID) != "") ? getFiled('Q12Wa17S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa17S3', $schoolUserID) != "") ? getFiled('Q12Wa17S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa17S4', $schoolUserID) != "") ? getFiled('Q12Wa17S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa18S1', $schoolUserID) != "") ? getFiled('Q12Wa18S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa18S2', $schoolUserID) != "") ? getFiled('Q12Wa18S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa18S3', $schoolUserID) != "") ? getFiled('Q12Wa18S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa18S4', $schoolUserID) != "") ? getFiled('Q12Wa18S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa19S1', $schoolUserID) != "") ? getFiled('Q12Wa19S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa19S2', $schoolUserID) != "") ? getFiled('Q12Wa19S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa19S3', $schoolUserID) != "") ? getFiled('Q12Wa19S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa19S4', $schoolUserID) != "") ? getFiled('Q12Wa19S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa20S1', $schoolUserID) != "") ? getFiled('Q12Wa20S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa20S2', $schoolUserID) != "") ? getFiled('Q12Wa20S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa20S3', $schoolUserID) != "") ? getFiled('Q12Wa20S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa20S4', $schoolUserID) != "") ? getFiled('Q12Wa20S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa21S1', $schoolUserID) != "") ? getFiled('Q12Wa21S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa21S2', $schoolUserID) != "") ? getFiled('Q12Wa21S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa21S3', $schoolUserID) != "") ? getFiled('Q12Wa21S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa21S4', $schoolUserID) != "") ? getFiled('Q12Wa21S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa22S1', $schoolUserID) != "") ? getFiled('Q12Wa22S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa22S2', $schoolUserID) != "") ? getFiled('Q12Wa22S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa22S3', $schoolUserID) != "") ? getFiled('Q12Wa22S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa22S4', $schoolUserID) != "") ? getFiled('Q12Wa22S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa23S1', $schoolUserID) != "") ? getFiled('Q12Wa23S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa23S2', $schoolUserID) != "") ? getFiled('Q12Wa23S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa23S3', $schoolUserID) != "") ? getFiled('Q12Wa23S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa23S4', $schoolUserID) != "") ? getFiled('Q12Wa23S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa24S1', $schoolUserID) != "") ? getFiled('Q12Wa24S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa24S2', $schoolUserID) != "") ? getFiled('Q12Wa24S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa24S3', $schoolUserID) != "") ? getFiled('Q12Wa24S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa24S4', $schoolUserID) != "") ? getFiled('Q12Wa24S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa25S1', $schoolUserID) != "") ? getFiled('Q12Wa25S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa25S2', $schoolUserID) != "") ? getFiled('Q12Wa25S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa25S3', $schoolUserID) != "") ? getFiled('Q12Wa25S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa25S4', $schoolUserID) != "") ? getFiled('Q12Wa25S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa26S1', $schoolUserID) != "") ? getFiled('Q12Wa26S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa26S2', $schoolUserID) != "") ? getFiled('Q12Wa26S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa26S3', $schoolUserID) != "") ? getFiled('Q12Wa26S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa26S4', $schoolUserID) != "") ? getFiled('Q12Wa26S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa27S1', $schoolUserID) != "") ? getFiled('Q12Wa27S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa27S2', $schoolUserID) != "") ? getFiled('Q12Wa27S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa27S3', $schoolUserID) != "") ? getFiled('Q12Wa27S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa27S4', $schoolUserID) != "") ? getFiled('Q12Wa27S4', $schoolUserID) : "N/A"; ?>
        ...
        <tr>
            ...
            <td>
                <?php echo (getFiled('Q12Wa28S1', $schoolUserID) != "") ? getFiled('Q12Wa28S1', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa28S2', $schoolUserID) != "") ? getFiled('Q12Wa28S2', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa28S3', $schoolUserID) != "") ? getFiled('Q12Wa28S3', $schoolUserID) : "N/A"; ?>

            </td>
            <td>
                <?php echo (getFiled('Q12Wa28S4', $schoolUserID) != "") ? getFiled('Q12Wa28S4', $schoolUserID) : "N/A"; ?>
    ...
    <?php } ?>
    <p class="orange"><label><span class="cube">9</span>Do you know that your e-waste can be collected by an authorized dealer or dismantler? </label></p>
    <p> <?php echo (getFiled('Q13Wa1', $schoolUserID) != "") ? (getFiled('Q13Wa1', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>
    <p class="orange"><label ><span class="cube">9(a)</span>Who collects your e-waste, when not in working condition?</label></p>
    <?php
    ...
    <p class="orange"><label>Other: &nbsp;</label></p>
...
<div class="task-area">
    ...
    <p class="orange"><label class="control-label"><span class="cube">5.1</span>What is the final destination for waste from your
            school that is disposed of externally? </label></p>
    ...
    <?php } ?>
    <p class="orange"><label class="control-label"><span class="cube">5.2</span>Does your school burn waste? </label></p>
    <p> <?php echo (getFiled('Q15Wa1', $schoolUserID) != "") ? (getFiled('Q15Wa1', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>

    <p class="orange"><label class="control-label">Please upload supporting documents:</label>
    </p><p>
        • Pictures of burning waste</p>
    ...
    <?php } ?>
    <p class="orange"><label class="control-label"><span class="cube">5.2.(a)</span>Where does your school burn
            waste?</label></p>
    <?php
    ...
    ?>
    <p class="orange"><label class="control-label"><span class="cube">5.2.(b)</span>What kind of waste is burnt/ncinerated?</label></p>
    <?php
    ...
    <p class="orange"><label class="control-label"><span class="cube">5.3</span>Do you know that your E-waste can be collected by an authorised dealer or dismantler? </label></p>
...
<div class="task-area">
    ...
    <p>It is important to appreciate the initiatives taken by the management on issues related to waste. The
        ...
        questions:</p>
    <p class="orange"><label class="control-label"><span class="cube">6.1</span>Does the school have a policy on waste?</label></p>
    <p> <?php echo (getFiled('Q17Wa1', $schoolUserID) != "") ? (getFiled('Q17Wa1', $schoolUserID) == "Y") ? "Yes" : "No" : "N/A"; ?></p>
    <p class="orange"><label class="control-label">Please upload supporting documents:</label></p>
    <p>• Waste Policy</p>

    <p class="orange"><label class="control-label"><span class="cube">6.2</span>Are there awareness drives with regard to Reduce,
            Recycle and Reuse? <a class="kplink" href="http://www.greenschoolsprogramme.org/knowledge-bank/waste/#partnerInOperation" target="_blank"></a></label></p>
    ...
    <p class="orange"> <label class="control-label"><span class="cube">6.2.(a)</span>What form do these awareness drives
            take? </label></p>
    <?php
    ...
    ?>
    <p class="orange"><label class="control-label"><span class="cube">6.3</span>Is the study of the environment integrated into the
            curriculum?</label></p>
