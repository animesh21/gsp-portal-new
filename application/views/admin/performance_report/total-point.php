...
<td><?php if(!$record1[$i]->population): echo  $record1[$i]->population/$record1[$i]->Q9W1; else: echo "Wrong Population"; endif;  ?></td>
<td><?php echo  $record1[$i]->Q10W1; ?></td>
<td><?php echo  $record1[$i]->Q11W1; ?></td>
<td><?php  if(!$record1[$i]->population): echo  $record1[$i]->population/$record1[$i]->Q11W1; else: echo "Wrong Population"; endif; ?></td>
...
<td><?php  if(!$record1[$i]->population): echo  $record1[$i]->population/$record1[$i]->Q13W1S4; else: echo "Wrong Population"; endif; ?></td>
