...
<td><?php echo  $record1[$i]->population/$record1[$i]->Q4W11; ?></td>
...
<td><?php echo  $record1[$i]->population/$record1[$i]->Q9W1; ?></td>
<td><?php echo  $record1[$i]->Q10W1; ?></td>
<td><?php echo  $record1[$i]->Q11W1; ?></td>
<td><?php echo  $record1[$i]->population/$record1[$i]->Q11W1; ?></td>
...
<td><?php echo  $record1[$i]->population/$record1[$i]->Q13W1S4; ?></td>
