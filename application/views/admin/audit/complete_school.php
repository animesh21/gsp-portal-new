<div class="top-area">
        <h2>Schools Completed The Audit<a href="<?php echo base_url('admin/audit_started_2017/excelByProgress2_phase1') ?>"><button class="exportBtn">Export to Excel</button></a></h2>
</div>
