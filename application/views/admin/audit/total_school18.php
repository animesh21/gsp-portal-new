<div class="top-area">
        <h2>Total School Registrations ( AUDIT PHASE 1 )<a href="<?php echo base_url('admin/survey/audit_started_2018/excel_total_school') ?>"><button class="exportBtn">Export to Excel</button></a></h2>
</div>
