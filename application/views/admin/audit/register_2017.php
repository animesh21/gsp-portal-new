<div class="top-area">
        <h2>2017 Registration ( AUDIT PHASE 1 )<a href="<?php echo base_url('admin/audit_started_2017/excelByProgress7_phase1') ?>"><button class="exportBtn">Export to Excel</button></a></h2>
         </div>
