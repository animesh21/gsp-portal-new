<div class="top-area">
        <h2>Schools Started The Audit But Did Not Complete<a href="<?php echo base_url('admin/audit_started_2017/excelByProgress') ?>"><button class="exportBtn">Export to Excel</button></a></h2>
</div>
