...
<div class="content-form">
  ...
  <div class="form-group">
    ...
    <div class="answer-item radio-item">
      <label class="radio">
      <input type="radio" class="radio" onClick="StateValidation(1)" name="Q3G1" value="<?php echo set_value('Q3G1',1)?>" <?php if(isset($data['Q3G1'])) echo $data['Q3G1'] == 1 ?"checked":"" ?>>
    ...
    <div class="radio">
      ...
      International Baccalaureate (IB)/International General Certificate of Secondary Education (IGCSE) combination </label>
    </div>
    <div class="radio">
      <label>
      <input type="radio" name="Q3G1" onClick="StateValidation(3)" value="<?php echo set_value('Q3G1',5)?>" <?php if(isset($data['Q3G1'])) echo $data['Q3G1'] == 5 ?"checked":"" ?>>
      Others </label>
      <input type="text" id="Q3G1O" name="Q3G1O" placeholder="<?php if(isset($data['Q3G1O'])) echo $data['Q3G1O'] ?>" value="<?php echo set_value('Q3G1O'); ?>"<?php 
      if(isset($data['Q3G1'])) 
          echo "readonly"; ?>/>
    </div>
  </div>
  ...
  <?php
    ...
    <div class="form-group row">
      <?php if(empty($data["Q3G2"])) $data['Q3G2']=0; echo form_dropdown('Q3G2', $states,set_value('Q3G2',$data["Q3G2"]), array('class' => 'form-control', 'id' => 'select')); ?>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="form-group row">
      ...
      <div class="col-xs-2">
        <input class="form-control space-textbox" id="male" type="number" min="0" onKeyUp="CalculateStudent()" onChange="CalculateStudent()" name="Q4G1S1" placeholder="<?php if(isset($data['Q4G1S1'])) echo $data['Q4G1S1'] ?>" value="<?php echo set_value('Q4G1S1'); ?>"<?php if(isset($data['Q2G1'])) if($data['Q2G1'] == 2) echo "disabled"; ?>/>
      </div>
      <div class="col-xs-2">
        <input class="form-control space-textbox" id="female" type="number" min="0" onKeyUp="CalculateStudent()" onChange="CalculateStudent()" name="Q4G1S2" placeholder="<?php if(isset($data['Q4G1S2'])) echo $data['Q4G1S2'] ?>" value="<?php echo set_value('Q4G1S2'); ?>" <?php if(isset($data['Q2G1'])) if($data['Q2G1'] == 1) echo "disabled"; ?> />
      </div>
      <div class="col-xs-2">
        <input class="form-control space-textbox" id="mixed" onKeyUp="CalculateStudent()" onChange="CalculateStudent()" type="number" min="0" name="Q4G1S3" placeholder="<?php if(isset($data['Q4G1S3'])) echo $data['Q4G1S3'] ?>" value="<?php echo set_value('Q4G1S3'); ?>" readonly/>
      </div>
    </div>
    <div class="form-group row">
      <div class="col-xs-2">
      ...
      <div class="col-xs-2">
        <input class="form-control space-textbox" id="teacherMale" onKeyUp="CalculateStudent()" onChange="CalculateStudent()" type="number" min="0" name="Q4G2S1" placeholder="<?php if(isset($data['Q4G2S1'])) echo $data['Q4G2S1'] ?>" value="<?php echo set_value('Q4G2S1'); ?>"/>
      </div>
      <div class="col-xs-2">
        <input class="form-control space-textbox" id="teacherFemale" onKeyUp="CalculateStudent()" onChange="CalculateStudent()" type="number" min="0" name="Q4G2S2" placeholder="<?php if(isset($data['Q4G2S2'])) echo $data['Q4G2S2'] ?>" value="<?php echo set_value('Q4G2S2'); ?>"/>
      </div>
      <div class="col-xs-2">
        <input class="form-control space-textbox" id="teacherMixed" onKeyUp="CalculateStudent()" onChange="CalculateStudent()" type="number" min="0" name="Q4G2S3" placeholder="<?php if(isset($data['Q4G2S3'])) echo $data['Q4G2S3'] ?>" value="<?php echo set_value('Q4G2S3'); ?>" readonly/>
      </div>
    </div>
    <div class="form-group row">
      <div class="col-xs-2">
      ...
      <div class="col-xs-2">
        <input class="form-control space-textbox" id="NteacherMale" onKeyUp="CalculateStudent()" onChange="CalculateStudent()" type="number" min="0" name="Q4G3S1" placeholder="<?php if(isset($data['Q4G3S1'])) echo $data['Q4G3S1'] ?>" value="<?php echo set_value('Q4G3S1'); ?>"/>
      </div>
      <div class="col-xs-2">
        <input class="form-control space-textbox" id="NteacherFemale" onKeyUp="CalculateStudent()" onChange="CalculateStudent()" type="number" min="0" name="Q4G3S2" placeholder="<?php if(isset($data['Q4G3S2'])) echo $data['Q4G3S2'] ?>" value="<?php echo set_value('Q4G3S2'); ?>"/>
      </div>
      <div class="col-xs-2">
        <input class="form-control space-textbox" id="NteacherMixed" onKeyUp="CalculateStudent()" onChange="CalculateStudent()" type="number" min="0" name="Q4G3S3" placeholder="<?php if(isset($data['Q4G3S3'])) echo $data['Q4G3S3'] ?>" value="<?php echo set_value('Q4G3S3'); ?>" readonly/>
      </div>
    </div>
    <div class="form-group row">
      <div class="col-xs-2">
      ...
      <div class="col-xs-2">
        <input class="form-control space-textbox" id="subMale" onKeyUp="CalculateStudent()" onChange="CalculateStudent()" type="number" min="0" name="Q4G4S1" placeholder="<?php if(isset($data['Q4G4S1'])) echo $data['Q4G4S1'] ?>" value="<?php echo set_value('Q4G4S1'); ?>" readonly/>
      </div>
      <div class="col-xs-2">
        <input class="form-control space-textbox" id="subFemale" onKeyUp="CalculateStudent()" onChange="CalculateStudent()" type="number" min="0" name="Q4G4S2" placeholder="<?php if(isset($data['Q4G4S2'])) echo $data['Q4G4S2'] ?>" value="<?php echo set_value('Q4G4S2'); ?>" readonly/>
      </div>
      <div class="col-xs-2">
        <?php
    ...
    <div class="clearfix">&nbsp;</div>
      <div class=" form-group">
        ...
        <input class="form-control" id="Q5G1" type="number" min="0" name="Q5G1" placeholder="<?php if(isset($data['Q5G1'])) echo $data['Q5G1'] ?>" value="<?php echo set_value('Q5G1'); ?>"/>
      </div>
    <div class="clearfix">&nbsp;</div>
    <?php 
            if(isset($other['Q1S1'])) 
      ...
      <div class="form-group">
        ...
        <input class="form-control" id="Q5G2" type="number" min="0" name="Q5G2" placeholder="<?php if(isset($data['Q5G2'])) echo $data['Q5G2'] ?>" value="<?php echo set_value('Q5G2'); ?>"/>
      </div>
    <div class="clearfix">&nbsp;</div>
    <?php
              }
    ...
    <div class="form-group">
      ...
      <input class="form-control" id="Q6G1" type="number" min="0" max="366" name="Q6G1" placeholder="<?php if(isset($data['Q6G1'])) echo $data['Q6G1'] ?>" value="<?php echo set_value('Q6G1'); ?>"/>
    </div>
    <div class="clearfix">&nbsp;</div>
    <div class="form-group">
    ...
    <div class="text-center">
      ...
      <button type="button" class="org-btn" id="generalprevious" value="movenext" onClick="javasript:window.location.href='<?php echo base_url('school'); ?>'" >Previous</button>
