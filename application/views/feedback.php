  ...
  <div class="content-form">
    ...
    <div class="form-group">
      ...
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <th><label class="radio-inline">
              <input type="radio" name="Q8Fe2" value="<?php echo set_value('Q8Fe2',1)?>" <?php if(isset($data['Q8Fe2'])) echo $data['Q8Fe2'] == 1?"checked":"" ?>>
          	Good</label></th>
          <th><label class="radio-inline">
              <input type="radio" name="Q8Fe2" value="<?php echo set_value('Q8Fe2',2)?>" <?php if(isset($data['Q8Fe2'])) echo $data['Q8Fe2'] == 2?"checked":"" ?>>
          	Average</label></th>
          <th><label class="radio-inline">
              <input type="radio" name="Q8Fe2" value="<?php echo set_value('Q8Fe2',3)?>" <?php if(isset($data['Q8Fe2'])) echo $data['Q8Fe2'] == 3?"checked":"" ?>>
          	Bad</label></th>
        </tr>
        <tr>
          <th>Sequencing of questions</th>
          <th><label class="radio-inline">
              <input type="radio" name="Q8Fe3" value="<?php echo set_value('Q8Fe3',1)?>" <?php if(isset($data['Q8Fe3'])) echo $data['Q8Fe3'] == 1?"checked":"" ?>>
          	Good</label></th>
          <th><label class="radio-inline">
              <input type="radio" name="Q8Fe3" value="<?php echo set_value('Q8Fe3',2)?>" <?php if(isset($data['Q8Fe3'])) echo $data['Q8Fe3'] == 2?"checked":"" ?>>
          	Average</label></th>
          <th><label class="radio-inline">
              <input type="radio" name="Q8Fe3" value="<?php echo set_value('Q8Fe3',3)?>" <?php if(isset($data['Q8Fe3'])) echo $data['Q8Fe3'] == 3?"checked":"" ?>>
          	Bad</label></th>
        </tr>
        <tr>
          <th>Sequencing of questions</th>
          <th><label class="radio-inline">
              <input type="radio" name="Q8Fe4" value="<?php echo set_value('Q8Fe4',1)?>" <?php if(isset($data['Q8Fe4'])) echo $data['Q8Fe4'] == 1?"checked":"" ?>>
          	Good</label></th>
          <th><label class="radio-inline">
              <input type="radio" name="Q8Fe4" value="<?php echo set_value('Q8Fe4',2)?>" <?php if(isset($data['Q8Fe4'])) echo $data['Q8Fe4'] == 2?"checked":"" ?>>
          	Average</label></th>
          <th><label class="radio-inline">
              <input type="radio" name="Q8Fe4" value="<?php echo set_value('Q8Fe4',3)?>" <?php if(isset($data['Q8Fe4'])) echo $data['Q8Fe4'] == 3?"checked":"" ?>>
          	Bad</label></th>
        </tr>
      </table>
    </div>
    <div class="form-group">
      ...
      <ul class="list-inline">
        <li>
          <label class="radio-inline">
          <input type="radio" name="Q1Fe7" value="<?php echo set_value('Q1Fe7','Y')?>" <?php if(isset($data['Q1Fe7'])) echo $data['Q1Fe7'] == 'Y'?"checked":"" ?>>
          Yes</label>
        </li>
        <li>
          <label class="radio-inline">
          <input type="radio" name="Q1Fe7" value="<?php echo set_value('Q1Fe7','N')?>" <?php if(isset($data['Q1Fe7'])) echo $data['Q1Fe7'] == 'N'?"checked":"" ?>>
          No</label>
        </li>
      </ul>
    </div>
    ...
    <div class="form-group">
      ...
      <ul class="list-inline">
        <li>
          <label class="radio-inline">
          <input type="radio" name="Q1Fe8" value="<?php echo set_value('Q1Fe8','Y')?>" <?php if(isset($data['Q1Fe8'])) echo $data['Q1Fe8'] == 'Y'?"checked":"" ?>>
          Yes</label>
        </li>
        <li>
          <label class="radio-inline">
          <input type="radio" name="Q1Fe8" value="<?php echo set_value('Q1Fe8','N')?>" <?php if(isset($data['Q1Fe8'])) echo $data['Q1Fe8'] == 'N'?"checked":"" ?>>
          No</label>
        </li>
      </ul>
    </div>
    <div class="form-group">
      ...
      <ul class="list-inline">
        <li>
          <label class="radio-inline">
          <input type="radio" name="Q1Fe9" value="<?php echo set_value('Q1Fe1',1)?>" <?php if(isset($data['Q1Fe1'])) echo $data['Q1Fe1'] == 1?"checked":"" ?>>
          Never</label>
        </li>
        <li>
          <label class="radio-inline">
          <input type="radio" name="Q1Fe9" value="<?php echo set_value('Q1Fe1',2)?>" <?php if(isset($data['Q1Fe1'])) echo $data['Q1Fe1'] == 2?"checked":"" ?>>
          Once</label>
        </li>
        <li>
          <label class="radio-inline">
          <input type="radio" name="Q1Fe9" value="<?php echo set_value('Q1Fe1',3)?>" <?php if(isset($data['Q1Fe1'])) echo $data['Q1Fe1'] == 3?"checked":"" ?>>
          Twice</label>
        </li>
        <li>
          <label class="radio-inline">
          <input type="radio" name="Q1Fe9" value="<?php echo set_value('Q1Fe1',4)?>" <?php if(isset($data['Q1Fe1'])) echo $data['Q1Fe1'] == 4?"checked":"" ?>>
