...
<li><a class="lptext" title="Change Password Form" data-toggle="modal" data-target="#ChangePass" href="#ChangePass" rel="shadowbox;width=580;height=500;">Change Password</a></li>
    ...
    <div class="intro">
    <h1>WASTE</h1>
	<div class="video"> <a class="lptext" href="#" data-toggle="modal" data-target="#videoModal"><img src="http://greenschoolsprogramme.org/audit2015/upload/templates/tfr_responsive/images/video-icon.png" style="width: 45px; height: 40px;"></a></div>
	</div>
    ...
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="ex3" type="text" name="Q3Wa10S3" placeholder="<?php if(isset($data['Q3Wa10S3'])) echo $data['Q3Wa10S3'] ?>" value="<?php echo set_value('Q3Wa10S3'); ?>"/>
          ...
          <div class="form-group">
            ...
            <br>
            Segregation means sorting. Let’s understand the waste segregation system because the amount of waste recycled or reused will depend on the method of collection. To understand the waste segregation system of your school, fill the table below.<br><br>

            <b>To collect data:</b> Students will have to survey the waste collection area and talk to the house-keeping staff to know whether waste is segregated in the school and in what quantity.
            ...
            if(isset($data['Q4Wa1']))
              if($data['Q4Wa1'] == 'Y')
              {
                ...
                <div class="form-group row" id="Q1A">
                  ...
                  <div class="">
                    <label><input type="checkbox" name="Q4Wa2S1" value="<?php echo set_value('Q4Wa2S1',1); ?>" <?php if(isset($data['Q4Wa2S1'])) echo "checked" ?>>Students and teachers</label>
                  </div>
                  <div class="">
                    <label><input type="checkbox" name="Q4Wa2S2" value="<?php echo set_value('Q4Wa2S2',1); ?>" <?php if(isset($data['Q4Wa2S2'])) echo "checked" ?>>Housekeeping (Sweeper)</label>
                  </div>
                  <div class="">
                    <label><input type="checkbox" name="Q4Wa2S3" value="<?php echo set_value('Q4Wa2S3',1); ?>" <?php if(isset($data['Q4Wa2S3'])) echo "checked" ?>>Gardener</label>
                  </div>
                  <div class=">
                    <label><input type="checkbox" name="Q4Wa2S4" value="<?php echo set_value('Q4Wa2S4',1); ?>" <?php if(isset($data['Q4Wa2S4'])) echo "checked" ?>>Ragpickers</label>
                  </div>
                  <div class="">
                    <label>Other: &nbsp <input type="text" name="Q4Wa2S5" value="<?php echo set_value('Q4Wa2S5'); ?>" placeholder="<?php if(isset($data['Q4Wa2S5'])) echo $data['Q4Wa2'] ?>"></label>
                  </div>
                </div>
                <?php
              }
              ...
              <div class="form-group">
                ...
                <div class="form-group row">
                 ...
                 <div class="col-xs-2">
                  <label >No. of waste collection points with no bin
                  </label>
                </div>
                <div class="col-xs-2">
                  <label >No. of waste collection points with one bin (mixed waste)

                  </label>
                </div>
                <div class="col-xs-2">
                  <label >No. of waste collection points with two bins (wet & dry)

                  </label>
                </div>
                <div class="col-xs-2">
                  <label >No. of waste collection points with three bins or more

                  </label>
                </div>
                <div class="col-xs-2">
                  <label >Total no. of waste collection points
                  </label>
                </div>
...
<br>
<div class="form-group">
  <label class="control-label">Please upload supporting documents:</label><br>
  • Pictures of dustbins in classroom showing segregation at source<br>
  • Pictures of playground with more than two dustbins<br>
  Kindly attach the aforementioned documents along with the survey<br><br>

   <button class="btn uploadbtn upload" data-id="Segregation Source Classrooms" data-toggle="modal" data-target="#airModal" type="button">UPLOAD FILES</button>  <br><br>
     
</div>    


<div class="form-group">
  <label><h6>Task 3: How much waste does your school generate?</h6></label>
  <br>
  There is nothing known as waste – waste is just a misplaced resource. Therefore ideally, a school should not generate any waste. But there is waste, as most human activities result in some waste. Wastes are of many types such as bio-degradable and non-biodegradable, hazardous and non-hazardous, etc. Each of these categories has to be handled carefully. Please wear gloves, masks while handling waste. E-waste should be handled by adults.<br><br>
...
<div class="form-group">
  ...
  <div class="form-group row">
    <div class="col-xs-6">
      <label >HOW MUCH WASTE DOES YOUR SCHOOL GENERATE?
      </label> 
    </div>
    <div class="col-xs-6">
      <label >Quantity of solid waste generated(monthly average in kg)
      </label>
    </div>
  ...
  <div class="form-group row">
    <div class="col-xs-6">
      <label >Garden/horticulture waste 
      </label> 
    </div>
    <div class="col-xs-6">
  ...
  <div class="form-group row">
    <div class="col-xs-6">
      <label >Wet waste from classrooms etc.
      </label> 
    </div>
    <div class="col-xs-6">
  ...
  <div class="form-group row">
    <div class="col-xs-6">
      <label >Per capita waste generation A:
      </label> 
    </div>
    <div class="col-xs-6">
...
<div class="form-group">
  ...
  <div class="form-group row">
    <div class="col-xs-6">
      <label >Wood or classroom furniture  
      </label> 
    </div>
    <div class="col-xs-6">
  ...
  <div class="form-group row">
    <div class="col-xs-6">
      <label >Per capita waste generation B:
      </label> 
    </div>
    <div class="col-xs-6">
...
<div class="form-group">
  ...
  <div class="form-group row">
    <div class="col-xs-6">
      <label >Hazardous and toxic waste(Paints, lab waste, etc)
  ...
  <div class="form-group row">
    <div class="col-xs-6">
      <label >Per capita waste generation C.
      </label> 
    </div>
    <div class="col-xs-6">
...
<div class="form-group">
  ...
  <div class="form-group row">
    <div class="col-xs-6">
      <label >Per capita waste generation D:
      </label> 
    </div>
    <div class="col-xs-6">
...
<div class="form-group">
  ...
  <div class="form-group row">
    <div class="col-xs-6">
      <label >Biomedical waste such as syringes, band–aids, expired medicines etc. 
      </label> 
    </div>
    <div class="col-xs-6">
  ...
  <div class="form-group row">
    <div class="col-xs-6">
      <label >Per capita waste generation E:
      </label> 
    </div>
    <div class="col-xs-6">
...
<div class="form-group">
  ...
  <div class="form-group row">
    <div class="col-xs-6">
      <label >Per capita waste generation F:
      </label> 
    </div>
    <div class="col-xs-6">
...
<div class="form-group">
  ...
  <div class="form-group row">
    <div class="col-xs-6">
      <label >Per capita waste generation G:
      </label> 
    </div>
    <div class="col-xs-6">
...
<div class="form-group">
  ...
  Kindly attach the aforementioned documents along with the survey<br><br>
   ...
   <button class="btn uploadbtn upload" data-id="Audit Team Weighing Solid Waste" data-toggle="modal" data-target="#airModal" type="button">UPLOAD FILES</button>  <br><br>
     
</div>    

<div class="form-group">
  <label><h6>Task 4: How much waste does your school treat/recycle?</h6> </label>
  <br>
...
if(isset($data['Q8Wa1']))
  ...
  <div class="form-group row">
    <div class="col-xs-6">
      <label >HOW MUCH WASTE DOES YOUR SCHOOL REUSE/RECYCLE?
      </label> 
    </div>
    <div class="col-xs-6">
      <label >Quantity of solid waste reuse/recycled (monthly average in kg)
      </label>
    </div>
...
<br>
  ...
  <div class="form-group">
    <label class="control-label">Please upload supporting documents:</label><br>
    • Pictures of recycling units - composting pit<br><br>

	<button class="btn uploadbtn upload" data-id="Composting Pit" data-toggle="modal" data-target="#airModal" type="button">UPLOAD FILES</button>  <br><br>
  ...
  if(isset($data['Q9Wa1']))
    if($data['Q9Wa1'] == 'Y')
    {
      ...
      <div class="form-group row" id="Q9Wa2">
        ...
        <div class="text-gray">
          <label><input type="checkbox" name="Q9Wa2S1" value="<?php echo set_value('Q9Wa2S1',1); ?>" <?php if(isset($data['Q9Wa2S1'])) echo "checked" ?>>Natural composting without added microbes</label>
        </div>
        <div class="text-gray">
          <label><input type="checkbox" name="Q9Wa2S2" value="<?php echo set_value('Q9Wa2S2',1); ?>" <?php if(isset($data['Q9Wa2S2'])) echo "checked" ?>>Vermi composting</label>
        </div>
        <div class="text-gray">
          <label><input type="checkbox" name="Q9Wa2S3" value="<?php echo set_value('Q9Wa2S3',1); ?>" <?php if(isset($data['Q9Wa2S3'])) echo "checked" ?>>Mechanical composting</label>
        </div>
        <div class="text-gray">
          <label>Other: &nbsp <input type="text" name="Q9Wa2S4" value="<?php echo set_value('Q9Wa2S4'); ?>" placeholder="<?php if(isset($data['Q9Wa2S4'])) echo $data['Q9Wa2S4'] ?>"></label>
        </div>
      </div>
    ...
    <div class="form-group row" id="Q9Wa4">
      ...
      <div class="form-group row">
        <label><input type="checkbox" name="Q9Wa4S1" value="<?php echo set_value('Q9Wa4S1',1); ?>" <?php if(isset($data['Q9Wa4S1'])) echo "checked" ?>>For horticultural purposes
        </label>
      </div>
      <div class="form-group row">
        <label><input type="checkbox" name="Q9Wa4S2" value="<?php echo set_value('Q9Wa4S2',1); ?>" <?php if(isset($data['Q9Wa4S2'])) echo "checked" ?>>For school garden</label>
      </div>
      <div class="form-group row">
        <label><input type="checkbox" name="Q9Wa4S3" value="<?php echo set_value('Q9Wa4S3',1); ?>" <?php if(isset($data['Q9Wa4S3'])) echo "checked" ?>>For sale</label>
      </div>
      <div class="form-group row">
        <label><input type="checkbox" name="Q9Wa4S4" value="<?php echo set_value('Q9Wa4S4',1); ?>" <?php if(isset($data['Q9Wa4S4'])) echo "checked" ?>>For charity</label>
      </div>
  ...
  <div class="form-group" id="Q9Wa3" style="display: none;">
    <label for="username" class="control-label"><span class="cube">5(b)</span>What is the quantity of compost that is generated per month (in kilogram)?</label>
    <br>
    <input type="text" id="WindowRatio" name="Q9Wa3" class="form-control space-textbox" placeholder="<?php if(isset($data['Q9Wa3'])) echo $data['Q9Wa3'] ?>" value="<?php echo set_value('Q9Wa3'); ?>">
  </div>
  ...
  <div class="form-group row" id="Q9Wa4" style="display: none;">
    <label><span class="cube">5(c)</span> What is the purpose of the compost that is generated per month? </label>
    <div class="text-gray">
      <label><input type="checkbox" name="Q9Wa3S1" value="<?php echo set_value('Q9Wa3S1',1); ?>" <?php if(isset($data['Q9Wa3S1'])) echo "checked" ?>>For horticultural purposes
      </label>
    </div>
    <div class="text-gray">
      <label><input type="checkbox" name="Q9Wa3S2" value="<?php echo set_value('Q9Wa3S2',1); ?>" <?php if(isset($data['Q9Wa3S2'])) echo "checked" ?>>For school garden</label>
    </div>
    <div class="text-gray">
      <label><input type="checkbox" name="Q9Wa3S3" value="<?php echo set_value('Q9Wa3S3',1); ?>" <?php if(isset($data['Q9Wa3S3'])) echo "checked" ?>>For sale</label>
    </div>
    <div class="text-gray">
      <label><input type="checkbox" name="Q9Wa3S4" value="<?php echo set_value('Q9Wa3S4',1); ?>" <?php if(isset($data['Q9Wa3S4'])) echo "checked" ?>>For charity</label>
    </div>
  ...
  <div class="form-group">
    <label class="control-label"><span class="cube">6</span>Does your school encourage students & teachers to reuse textbooks?</label>
    <div class="form-group">
      <label class="radio-inline text-gray">
  ...
  <div class="form-group">
    <label  class="control-label"><span class="cube">7</span>Please fill the table to understand whether waste recycling procedures are applied to waste. </label>
    <div class="form-group row">
      <div class="col-xs-2">
     ...
     <div class="col-xs-2">
      <label >Local scrap collector (kabadiwala)
      </label>
    </div>
    <div class="col-xs-2">
    ...
    <div class="col-xs-2">
      <label >Dumped at a designated community site
      </label>
    </div>
    <div class="col-xs-2">
  ...
  <div class="form-group row">
   ...
   <div class="col-xs-2">
	 <input type="checkbox" id="Q11Wa1S1" name="Q11Wa1S1" value="<?php echo set_value('Q11Wa1S1',1); ?>" <?php if(isset($data['Q11Wa1S1'])) if($data['Q11Wa1S1'] == 1) echo set_checkbox('Q11Wa1S1', '1', true); ?>>
   </div>
   <div class="col-xs-2">
	
	<input class="form-control space-textbox" id="Q11Wa1S2" type="checkbox" name="Q11Wa1S2" value="<?php echo set_value('Q11Wa1S2',1); ?>" <?php if(isset($data['Q11Wa1S2'])) if($data['Q11Wa1S2'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
   <div class="col-xs-2">
   <input class="form-control space-textbox" id="Q11Wa1S3" type="checkbox" name="Q11Wa1S3" value="<?php echo set_value('Q11Wa1S3',1); ?>" <?php if(isset($data['Q11Wa1S3'])) if($data['Q11Wa1S3'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
   <div class="col-xs-2">
   <input class="form-control space-textbox" id="Q11Wa1S4" type="checkbox" name="Q11Wa1S4" value="<?php echo set_value('Q11Wa1S4',1); ?>" <?php if(isset($data['Q11Wa1S4'])) if($data['Q11Wa1S4'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 ...
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa2S1" type="checkbox" name="Q11Wa2S1" value="<?php echo set_value('Q11Wa2S1',1); ?>" <?php if(isset($data['Q11Wa2S1'])) if($data['Q11Wa2S1'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa2S2" type="checkbox" name="Q11Wa2S2" value="<?php echo set_value('Q11Wa2S2',1); ?>" <?php if(isset($data['Q11Wa2S2'])) if($data['Q11Wa2S2'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
<input class="form-control space-textbox" id="Q11Wa2S3" type="checkbox" name="Q11Wa2S3" value="<?php echo set_value('Q11Wa2S3',1); ?>" <?php if(isset($data['Q11Wa2S3'])) if($data['Q11Wa2S3'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
    </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa2S4" type="checkbox" name="Q11Wa2S4" value="<?php echo set_value('Q11Wa2S4',1); ?>" <?php if(isset($data['Q11Wa2S4'])) if($data['Q11Wa2S4'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>

</div>
<div class="form-group row">
  <div class="col-xs-2">
   <label >Horticultural waste

   </label> 
 </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa3S1" type="checkbox" name="Q11Wa3S1" value="<?php echo set_value('Q11Wa3S1',1); ?>" <?php if(isset($data['Q11Wa3S1'])) if($data['Q11Wa3S1'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa3S2" type="checkbox" name="Q11Wa3S2" value="<?php echo set_value('Q11Wa3S2',1); ?>" <?php if(isset($data['Q11Wa3S2'])) if($data['Q11Wa3S2'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa3S3" type="checkbox" name="Q11Wa3S3" value="<?php echo set_value('Q11Wa3S3',1); ?>" <?php if(isset($data['Q11Wa3S3'])) if($data['Q11Wa3S3'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa3S4" type="checkbox" name="Q11Wa3S4" value="<?php echo set_value('Q11Wa3S4',1); ?>" <?php if(isset($data['Q11Wa3S4'])) if($data['Q11Wa3S4'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
...
<div class="form-group row">
 ...
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa4S1" type="checkbox" name="Q11Wa4S1" value="<?php echo set_value('Q11Wa4S1',1); ?>" <?php if(isset($data['Q11Wa4S1'])) if($data['Q11Wa4S1'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa4S2" type="checkbox" name="Q11Wa4S2" value="<?php echo set_value('Q11Wa4S2',1); ?>" <?php if(isset($data['Q11Wa4S2'])) if($data['Q11Wa4S2'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa4S3" type="checkbox" name="Q11Wa4S3" value="<?php echo set_value('Q11Wa4S3',1); ?>" <?php if(isset($data['Q11Wa4S3'])) if($data['Q11Wa4S3'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa4S4" type="checkbox" name="Q11Wa4S4" value="<?php echo set_value('Q11Wa4S4',1); ?>" <?php if(isset($data['Q11Wa4S4'])) if($data['Q11Wa4S4'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
...
<div class="form-group row">
 ...
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa5S1" type="checkbox" name="Q11Wa5S1" value="<?php echo set_value('Q11Wa5S1',1); ?>" <?php if(isset($data['Q11Wa5S1'])) if($data['Q11Wa5S1'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa5S2" type="checkbox" name="Q11Wa5S2" value="<?php echo set_value('Q11Wa5S2',1); ?>" <?php if(isset($data['Q11Wa5S2'])) if($data['Q11Wa5S2'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa5S3" type="checkbox" name="Q11Wa5S3" value="<?php echo set_value('Q11Wa5S3',1); ?>" <?php if(isset($data['Q11Wa5S3'])) if($data['Q11Wa5S3'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa5S4" type="checkbox" name="Q11Wa5S4" value="<?php echo set_value('Q11Wa5S4',1); ?>" <?php if(isset($data['Q11Wa5S4'])) if($data['Q11Wa5S4'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
</div>
<div class="form-group row">
  <div class="col-xs-2">
   <label >Wood, glass, metal
   </label> 
 </div>
 <div class="col-xs-2">
<input class="form-control space-textbox" id="Q11Wa6S1" type="checkbox" name="Q11Wa6S1" value="<?php echo set_value('Q11Wa6S1',1); ?>" <?php if(isset($data['Q11Wa6S1'])) if($data['Q11Wa6S1'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
    </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa6S2" type="checkbox" name="Q11Wa6S2" value="<?php echo set_value('Q11Wa6S2',1); ?>" <?php if(isset($data['Q11Wa6S2'])) if($data['Q11Wa6S2'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa6S3" type="checkbox" name="Q11Wa6S3" value="<?php echo set_value('Q11Wa6S3',1); ?>" <?php if(isset($data['Q11Wa6S3'])) if($data['Q11Wa6S3'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa6S4" type="checkbox" name="Q11Wa6S4" value="<?php echo set_value('Q11Wa6S4',1); ?>" <?php if(isset($data['Q11Wa6S4'])) if($data['Q11Wa6S4'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
...
<div class="form-group row">
 ...
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa7S1" type="checkbox" name="Q11Wa7S1" value="<?php echo set_value('Q11Wa7S1',1); ?>" <?php if(isset($data['Q11Wa7S1'])) if($data['Q11Wa7S1'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa7S2" type="checkbox" name="Q11Wa7S2" value="<?php echo set_value('Q11Wa7S2',1); ?>" <?php if(isset($data['Q11Wa7S2'])) if($data['Q11Wa7S2'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa7S3" type="checkbox" name="Q11Wa7S3" value="<?php echo set_value('Q11Wa7S3',1); ?>" <?php if(isset($data['Q11Wa7S3'])) if($data['Q11Wa7S3'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa7S4" type="checkbox" name="Q11Wa7S4" value="<?php echo set_value('Q11Wa7S4',1); ?>" <?php if(isset($data['Q11Wa7S4'])) if($data['Q11Wa7S4'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
...
<div class="form-group row">
  ...
  <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa8S1" type="checkbox" name="Q11Wa8S1" value="<?php echo set_value('Q11Wa8S1',1); ?>" <?php if(isset($data['Q11Wa8S1'])) if($data['Q11Wa8S1'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa8S2" type="checkbox" name="Q11Wa8S2" value="<?php echo set_value('Q11Wa8S2',1); ?>" <?php if(isset($data['Q11Wa8S2'])) if($data['Q11Wa8S2'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa8S3" type="checkbox" name="Q11Wa8S3" value="<?php echo set_value('Q11Wa8S3',1); ?>" <?php if(isset($data['Q11Wa8S3'])) if($data['Q11Wa8S3'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
 <div class="col-xs-2">
 <input class="form-control space-textbox" id="Q11Wa8S4" type="checkbox" name="Q11Wa8S4" value="<?php echo set_value('Q11Wa8S4',1); ?>" <?php if(isset($data['Q11Wa8S4'])) if($data['Q11Wa8S4'] == 1) echo set_checkbox('Q11WaS2', '1', true); ?>/>
   </div>
...
<div class="form-group">
  ...
  • Pictures of recycling units - paper recycling machine, selling paper to kabadiwala, recyclers,etc<br>
   ...
   <button class="btn uploadbtn upload" data-id="Recycling Machine" data-toggle="modal" data-target="#airModal" type="button">UPLOAD FILES</button>  <br><br>
...
<div class="form-group row">
  <div class="col-xs-4">
   <label >Personal computers (CPU, mouse, screen and keyboard included) 
   </label> 
 </div>
 <div class="col-xs-2">
...
<div class="form-group row">
  <div class="col-xs-4">
   <label >Laptop computer (CPU, mouse, screen and keyboard included)
   </label> 
 </div>
 <div class="col-xs-2">
...
<div class="form-group row">
  <div class="col-xs-4">
   <label >Copying equipment (photocopiers)
   </label> 
 </div>
 <div class="col-xs-2">
...
<div class="form-group row">
  <div class="col-xs-4">
   <label >Electrical and electronic typewriters 
   </label> 
 </div>
 <div class="col-xs-2">
...
<div class="form-group row">
  <div class="col-xs-4">
   <label >Pocket and desk calculators 
   </label> 
 </div>
 <div class="col-xs-2">
...
<div class="form-group">
  ...
  • Certificate of disposing e-waste from authorized dealer/dismantler<br><br>

   <button class="btn uploadbtn upload" data-id="E-Waste" data-toggle="modal" data-target="#airModal" type="button">UPLOAD FILES</button>  <br><br>
     
</div>    


<div class="form-group">
  <label class="control-label"><span class="cube">9</span>Do you know that your e-waste can be collected by an authorized dealer or dismantler?
  </label>
  <div class="form-group">
    <label class="radio-inline text-gray">
...
if(isset($data['Q13Wa1']))
  if($data['Q13Wa1'] == 'Y')
  {
    ...
    <div class="form-group" id="Q13Wa2">
      ...
      <div class="form-group row">
        <label>Other: &nbsp <input type="text" name="Q13Wa2" value="<?php echo set_value('Q13Wa2'); ?>" placeholder="<?php if(isset($data['Q13Wa2'])) echo $data['Q13Wa2'] ?>"></label>
      </div>
    </div><br>
  ...
  <div class="form-group">
    <label class="control-label">Please upload supporting documents:</label><br>
    •  Pictures of burning waste<br><br>

     <button class="btn uploadbtn upload" data-id="Buring Waste" data-toggle="modal" data-target="#airModal" type="button">UPLOAD FILES</button>  <br><br>
  ...
  if(isset($data['Q15Wa1']))
    ...
    <div class="form-group" id="Q15Wa3">
      ...
      <div class="form-group">
		<ul><li>
        <label class="radio-inline text-gray">
         <input type="checkbox" name="Q15Wa2S1" value="<?php echo set_value('Q15Wa2S1',1); ?>" <?php if(isset($data['Q15Wa2S1'])) echo "checked" ?>> Horticultural 
       </label>
	   </li><li>
       <label class="radio-inline text-gray">
        <input type="checkbox" name="Q15Wa2S2" value="<?php echo set_value('Q15Wa2S2',1); ?>" <?php if(isset($data['Q15Wa2S2'])) echo "checked" ?>>  Plastic
      </label>
	  </li><li>
      <label class="radio-inline text-gray">
        <input type="checkbox" name="Q15Wa2S3" value="<?php echo set_value('Q15Wa2S3',1); ?>" <?php if(isset($data['Q15Wa2S3'])) echo "checked" ?>>  Tyres
      </label>
	  </li><li>
      <label class="radio-inline text-gray">
        <input type="checkbox" name="Q15Wa2S4" value="<?php echo set_value('Q15Wa2S4',1); ?>" <?php if(isset($data['Q15Wa2S4'])) echo "checked" ?>>  Paper
      </label>
		</li></ul>
    </div>
  </div>
...
<div class="form-group">
  <label class="control-label">Please upload supporting documents:</label><br>
  • Certificate of disposing e-waste from authorised dealer/dismantler<br><br>

   <button class="btn uploadbtn upload" data-id="E-waste authorised dealer" data-toggle="modal" data-target="#airModal" type="button">UPLOAD FILES</button>  <br><br>
     
</div>    

<div class="form-group">
  <label><h6>Task 6: Choose your Waste Audit Team.</h6></label>
  <br>
  ...
  Seek an appointment with the Chairperson, Manager and Principal of your school and ask them the following questions:
</div><br>
<div class="form-group">
...
if($data['Q17Wa1'] == 'Y')
{
  ...
  <div class="form-group" id="WastePolicy">
    ...
    • Waste Policy<br><br>
     ...
     <button class="btn uploadbtn upload" data-id="Waste Policy" data-toggle="modal" data-target="#airModal" type="button">UPLOAD FILES</button>  <br><br>
...
<div class="form-group" id="WastePolicy" style="display: none;">
  ...
  • Waste Policy<br><br>
   ...
   <button class="btn uploadbtn upload" data-id="Water Policy" data-toggle="modal" data-target="#airModal" type="button">UPLOAD FILES</button>  <br>
...
if($data['Q18Wa1'] == 'Y')
{
  ...
  <div class="form-group" id="awareness">
    <label class="control-label">Please upload supporting documents:</label><br>
    • Pictures of various school initiatives e.g. rally, debate, street play, art competition, etc<br><br>
  ...
  <div class="form-group" id="Q18Wa3">
	...
	<div class="form-group">
      <label class="radio">
       <input type="checkbox" name="Q18Wa2S1" value="<?php echo set_value('Q18Wa2S1',1); ?>" <?php if(isset($data['Q18Wa2S1'])) echo "checked" ?>> As part of the curriculum 
     </label>
   </div>
   </li><li>
   <div class="form-group">
     ...
     <label class="radio">
      <input type="checkbox" name="Q18Wa2S2" value="<?php echo set_value('Q18Wa2S2',1); ?>" <?php if(isset($data['Q18Wa2S2'])) echo "checked" ?>>  As part of extracurricular activities such as guest lectures
    </label>
  </div>
  </li><li>
  <div class="form-group">
    <label class="radio">
      <input type="checkbox" name="Q18Wa2S3" value="<?php echo set_value('Q18Wa2S3',1); ?>" <?php if(isset($data['Q18Wa2S3'])) echo "checked" ?>>  By the showcasing of posters and stickers
    </label>
  </div>
  </li></ul>
...
<div class="form-group" id="WastePolicy" style="display: none;">
  ...
  • Waste Policy<br><br>
   ...
   <button class="btn uploadbtn upload" data-id="Waste Policy" data-toggle="modal" data-target="#airModal" type="button">UPLOAD FILES</button>  <br>
...
<div class="form-group" id="Q18Wa3" style="display: none;">
  ...
  <div class="form-group">
	<ul><li>
    <label class="radio-inline text-gray">
     <input type="checkbox" name="Q18Wa2S1" value="<?php echo set_value('Q18Wa2S1',1); ?>" <?php if(isset($data['Q18Wa2S1'])) echo "checked" ?>> Horticultural 
   </label>
   </li><li>
   <label class="radio-inline text-gray">
    <input type="checkbox" name="Q18Wa2S2" value="<?php echo set_value('Q18Wa2S2',1); ?>" <?php if(isset($data['Q18Wa2S2'])) echo "checked" ?>>  Plastic
  </label>
  </li><li>
  <label class="radio-inline text-gray">
    <input type="checkbox" name="Q18Wa2S3" value="<?php echo set_value('Q18Wa2S3',1); ?>" <?php if(isset($data['Q18Wa2S3'])) echo "checked" ?>>  Tyres
  </label>
  </li><li>
  <label class="radio-inline text-gray">
    <input type="checkbox" name="Q18Wa2S4" value="<?php echo set_value('Q18Wa2S4',1); ?>" <?php if(isset($data['Q18Wa2S4'])) echo "checked" ?>>  Paper
  </label>
  </li></ul>
...
<div class="form-group" id="WastePolicy">
  ...
  <br>
  File size per document should not exceed 500 KB.<br><br>
   <button class="btn uploadbtn upload" data-id="Audit Team Doing Survey Waste" data-toggle="modal" data-target="#airModal" type="button">UPLOAD FILES</button>  <br>
...
<input type="submit" class="submit button" id="movenextbtn" value="Save and Resume Later" /></div><?php echo form_close(); ?>
