  ...
  <div class="form-group row">
    ...
    <div class="col-xs-3">
      ...
      <div class="question-text">
        ...
        <p> <strong>1. Site area in square meter: </strong>Site area refers to the area or exact plot of ground on which anything is, has been, or is to be located. ‘Plot’ means a piece of land enclosed by definite boundaries.</p>
        <p> <strong>2. Ground Coverage Area</strong> will include all permanent structure buildings, such as administration block, auditorium, school building, etc. Does not include floors.</p>
        <p> <strong>3. Green cover or green, landscaped area on-ground</strong>:&nbsp; this includes areas covered by grass, trees, lawn or horticulture, flower beds, grasscrete paver tiles, etc.</p>
        <p> <strong>4. Surface parking area: </strong>refers to any parking lots directly on land.<strong> </strong></p>
        <p> <strong>5. Play area that is paved/ concrete</strong> includes all outdoor playfields such as basketball court; skating rink; assembly ground; swimming pool, etc.</p>
        <p> <strong>6. Play area covered by grass on ground </strong>includes tennis grass court, cricket/ football grounds etc.</p>
        <p> <strong>7. Service area on ground</strong> is any area on ground that is not a permanent structure, but dedicated to services such as cooling towers for air conditioning, generators, portable cabins for security guards, etc.</p>
        <p> <strong>8. Roof and terrace area: </strong>A roof is the covering on the uppermost part of a building. A terrace is an outdoor, occupiable extension of a building above ground level.<strong> </strong></p>
        <p> <strong>9. Green cover on terrace/ balconies</strong> includes terrace garden, but not potted plants.</p>
        <p> <strong>10. Total built up/ constructed area </strong>refers to the total areas of all floors of the building, including ground floors of built-up spaces, which include classrooms, labs, staff rooms, office area, auditoria, corridors, as well as balconies and terraces, multiplied by the number of floors.</p>
        <p> <strong>Others</strong> will include paved paths, and other open area that your school has, but not covered in the above list.</p>
        <p align="justify"> <strong>To collect data:</strong> The total constructed area can be sourced from the building construction plan of the school, which will be available in the school office. Or else, measure the constructed spaces and use the formula for calculating the areas of various shapes, such as a square or rectangle, to derive the data and add them all.</p>
      </div>
      </label>
