            ...
            <div class="container">
                <div class="wrapper" style="display: block;">
                    ...
                    <?php if ($this->session->flashdata('success')) { ?>
                        <div class="top-area">
                            <div class="alert alert-success" style="boredr-radius:0px !important; border: 1px solid green !important">
                    ...
                    <div class="form-group">
                        <input type="text" name="name" class="form-control name placeholder" value="<?php echo set_value('name'); ?>" placeholder="Name of the School*" id="name">
                    </div>
                    <div class="form-group">
                        <input type="text" name="address1" id="address1" class="form-control address placeholder" value="<?php echo set_value('address1'); ?>" placeholder="Address Line 1*">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="district state">
                            <select class="form-control" id="city-select" name="district"><option value="">Select District</option></select>
                        </div>
