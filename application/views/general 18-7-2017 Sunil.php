...
<div class="content-form">
  ...
  <input type="hidden"  id="primary" name="Q2G1" value="<?php echo set_value('Primary')?>"/>
  ...
  <div class="form-group">
    ...
    <div class="text-center"> <a href="<?php echo base_url('waste'); ?>" id="moveprevbtn" value="moveprev" name="moveprev" accesskey="p" class="submit button" style="min-width: 138px; !important; padding: 16px 15px !important; margin: 30px 5px !important ">Previous</a>
