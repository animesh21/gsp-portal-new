...
<div id="pprg" class="newprog progress" style="text-align:center">
 <div id="samplt" class="fin-prog progress-bar" role="progressbar" style="width:30%; height: 35px;">30%</div>
</div>
<div class="intro"> 
  <h1>FOOD</h1>
   ...
   <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="form-group row">
        ...
        <div class="col-xs-3">
          <?php echo form_error('name'); ?>
          <input class="form-control space-textbox" id="Q1F1S3" type="text" name="Q1F1S3" placeholder="<?php if(isset($data['Q1F1S3'])) echo $data['Q1F1S3']; ?>" value="<?php echo set_value('Q1F1S3'); ?>"/>
        </div>

        <div class="col-xs-3">
          <?php echo form_error('email'); ?>
          <input class="form-control space-textbox" id="Q1F1S2" type="email"  name="Q1F1S2" placeholder="<?php if(isset($data['Q1F1S2'])) echo $data['Q1F1S2']; ?>" value="<?php echo set_value('Q1F1S2'); ?>"/>
        </div>
      </div>
      <div class="form-group row">
        <div class="col-xs-1"> 2 </div>
        <div class="col-xs-3">
          <input class="form-control space-textbox" id="Q1F2S1" type="text"  name="Q1F2S1" placeholder="<?php if(isset($data['Q1F2S1'])) echo $data['Q1F2S1'] ?>" value="<?php echo set_value('Q1F2S1'); ?>"/>
        </div>
        <div class="col-xs-3">
          <?php echo form_error('name'); ?>
          <input class="form-control space-textbox" id="Q1F2S3" type="text" name="Q1F2S3" placeholder="<?php if(isset($data['Q1F2S3'])) echo $data['Q1F2S3']; ?>" value="<?php echo set_value('Q1F2S3'); ?>"/>
        </div>

        <div class="col-xs-3">
          <input class="form-control space-textbox" id="Q1F2S2" type="email"  name="Q1F2S2" placeholder="<?php if(isset($data['Q1F2S2'])) echo $data['Q1F2S2'] ?>" value="<?php echo set_value('Q1F2S2'); ?>"/>
        </div>
      </div>
      <div class="form-group row">
        <div class="col-xs-1"> 3 </div>
        <div class="col-xs-3">
          <input class="form-control space-textbox" id="Q1F3S1" type="text"  name="Q1F3S1" placeholder="<?php if(isset($data['Q1F3S1'])) echo $data['Q1F3S1'] ?>" value="<?php echo set_value('Q1F3S1'); ?>"/>
        </div>
        <div class="col-xs-3">
          <?php echo form_error('name'); ?>
          <input class="form-control space-textbox" id="Q1F3S3" type="text" name="Q1F3S3" placeholder="<?php if(isset($data['Q1F3S3'])) echo $data['Q1F3S3']; ?>" value="<?php echo set_value('Q1F3S3'); ?>"/>
        </div>

        <div class="col-xs-3">
          <input class="form-control space-textbox" id="Q1F3S2" type="email"  name="Q1F3S2" placeholder="<?php if(isset($data['Q1F3S2'])) echo $data['Q1F3S2'] ?>" value="<?php echo set_value('Q1F3S2'); ?>"/>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="form-group row">
          ...
          <div class="col-xs-3">
           ...
           <input class="form-control space-textbox" id="Q2F1S1" type="text"  name="Q2F1S1" placeholder="<?php if(isset($data['Q2F1S1'])) echo $data['Q2F1S1'] ?>" value="<?php echo set_value('Q2F1S1'); ?>"/>
         </div>
         <div class="col-xs-3">
           <input class="form-control space-textbox" id="Q2F1S3" type="text"  name="Q2F1S3" placeholder="<?php if(isset($data['Q2F1S3'])) echo $data['Q2F1S3'] ?>" value="<?php echo set_value('Q2F1S3'); ?>"/>
         </div>

         <div class="col-xs-3">
           <?php echo form_error('email1'); ?>
           <input class="form-control space-textbox" id="Q2F1S2" type="email"  name="Q2F1S2" placeholder="<?php if(isset($data['Q2F1S2'])) echo $data['Q2F1S2'] ?>" value="<?php echo set_value('Q2F1S2'); ?>"/>
         </div>
       </div>
       <div class="form-group row">
        <div class="col-xs-1"> 2 </div>
        <div class="col-xs-3">
          <input class="form-control space-textbox" id="Q2F2S1" type="text"  name="Q2F2S1" placeholder="<?php if(isset($data['Q2F2S1'])) echo $data['Q2F2S1'] ?>" value="<?php echo set_value('Q2F2S1'); ?>"/>
        </div>
        <div class="col-xs-3">
         <input class="form-control space-textbox" id="Q2F2S3" type="text"  name="Q2F2S3" placeholder="<?php if(isset($data['Q2F2S3'])) echo $data['Q2F2S3'] ?>" value="<?php echo set_value('Q2F2S3'); ?>"/>
       </div>

       <div class="col-xs-3">
        <input class="form-control space-textbox" id="Q2F2S2" type="email"  name="Q2F2S2" placeholder="<?php if(isset($data['Q2F2S2'])) echo $data['Q2F2S2'] ?>" value="<?php echo set_value('Q2F2S2'); ?>"/>
      </div>
    </div>
    <div class="form-group row">
      <div class="col-xs-1"> 3 </div>
      <div class="col-xs-3">
        <input class="form-control space-textbox" id="Q2F3S1" type="text"  name="Q2F3S1" placeholder="<?php if(isset($data['Q2F3S1'])) echo $data['Q2F3S1'] ?>" value="<?php echo set_value('Q2F3S1'); ?>"/>
      </div>
      <div class="col-xs-3">
       <input class="form-control space-textbox" id="Q2F3S3" type="text"  name="Q2F3S3" placeholder="<?php if(isset($data['Q2F3S3'])) echo $data['Q2F3S3'] ?>" value="<?php echo set_value('Q2F3S3'); ?>"/>
     </div>

     <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q2F3S2" type="email"  name="Q2F3S2" placeholder="<?php if(isset($data['Q2F3S2'])) echo $data['Q2F3S2'] ?>" value="<?php echo set_value('Q2F3S2'); ?>"/>
    </div>
  </div>
  <div class="form-group row">
    <div class="col-xs-1"> 4 </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q2F4S1" type="text"  name="Q2F4S1" placeholder="<?php if(isset($data['Q2F4S1'])) echo $data['Q2F4S1']; ?>" value="<?php echo set_value('Q2F4S1'); ?>"/>
    </div>
    <div class="col-xs-3">
     <input class="form-control space-textbox" id="Q2F4S3" type="text"  name="Q2F4S3" placeholder="<?php if(isset($data['Q2F4S3'])) echo $data['Q2F4S3'] ?>" value="<?php echo set_value('Q2F4S3'); ?>"/>
   </div>

   <div class="col-xs-3">
    <input class="form-control space-textbox" id="Q2F4S2" type="email"  name="Q2F4S2" placeholder="<?php if(isset($data['Q2F4S2'])) echo $data['Q2F4S2']; ?>" value="<?php echo set_value('Q2F4S2'); ?>"/>
  </div>;
</div>
<div class="form-group row">
  <div class="col-xs-1"> 5 </div>
  <div class="col-xs-3">
    <input class="form-control space-textbox" id="Q2F5S1" type="text"  name="Q2F5S1" placeholder="<?php if(isset($data['Q2F5S1'])) echo $data['Q2F5S1'] ?>" value="<?php echo set_value('Q2F5S1'); ?>"/>
  </div>
  <div class="col-xs-3">
   <input class="form-control space-textbox" id="Q2F5S3" type="text"  name="Q2F5S3" placeholder="<?php if(isset($data['Q2F5S3'])) echo $data['Q2F5S3'] ?>" value="<?php echo set_value('Q2F5S3'); ?>"/>
 </div>

 <div class="col-xs-3">
  <input class="form-control space-textbox" id="Q2F5S2" type="email"  name="Q2F5S2" placeholder="<?php if(isset($data['Q2F5S2'])) echo $data['Q2F5S2'] ?>" value="<?php echo set_value('Q2F5S2'); ?>"/>
</div>
</div>
</div>
<div class="form-group">
    ...
    <div class="form-group row">
      ...
      <div class="col-xs-3">
       ...
       <input class="form-control space-textbox" id="Q3F1S1" type="text"  name="Q3F1S1" placeholder="<?php if(isset($data['Q3F1S1'])) echo $data['Q3F1S1'] ?>"  value="<?php echo set_value('Q3F1S1'); ?>"/>
     </div>
     <div class="col-xs-3">
       <?php echo form_error('email2'); ?>
       <input class="form-control space-textbox" id="Q3F1S2" type="text"  name="Q3F1S2" placeholder="<?php if(isset($data['Q3F1S2'])) echo $data['Q3F1S2'] ?>" value="<?php echo set_value('Q3F1S2'); ?>"/>
     </div>
     <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F1S3" type="text"  name="Q3F1S3" placeholder="<?php if(isset($data['Q3F1S3'])) echo $data['Q3F1S3'] ?>" value="<?php echo set_value('Q3F1S3'); ?>"/>
    </div>
  </div>
  <div class="form-group row">
    <div class="col-xs-1"> 2 </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F2S1" type="text"  name="Q3F2S1" placeholder="<?php if(isset($data['Q3F2S1'])) echo $data['Q3F2S1'] ?>" value="<?php echo set_value('Q3F2S1'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F2S2" type="text"  name="Q3F2S2" placeholder="<?php if(isset($data['Q3F2S2'])) echo $data['Q3F2S2'] ?>" value="<?php echo set_value('Q3F2S2'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F2S3" type="text"  name="Q3F2S3" placeholder="<?php if(isset($data['Q3F2S3'])) echo $data['Q3F2S3'] ?>" value="<?php echo set_value('Q3F2S3'); ?>"/>
    </div>
  </div>
  <div class="form-group row">
    <div class="col-xs-1"> 3 </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F3S1" type="text"  name="Q3F3S1" placeholder="<?php if(isset($data['Q3F3S1'])) echo $data['Q3F3S1'] ?>" value="<?php echo set_value('Q3F3S3'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F3S2" type="text"  name="Q3F3S2" placeholder="<?php if(isset($data['Q3F3S2'])) echo $data['Q3F3S2'] ?>" value="<?php echo set_value('Q3F3S2'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F3S3" type="text"  name="Q3F3S3" placeholder="<?php if(isset($data['Q3F3S3'])) echo $data['Q3F3S3'] ?>" value="<?php echo set_value('Q3F3S3'); ?>"/>
    </div>
  </div>
  <div class="form-group row">
    <div class="col-xs-1"> 4 </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F4S1" type="text"  name="Q3F4S1" placeholder="<?php if(isset($data['Q3F4S1'])) echo $data['Q3F4S1'] ?>" value="<?php echo set_value('Q3F4S1'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F4S2" type="text"  name="Q3F4S2" placeholder="<?php if(isset($data['Q3F4S2'])) echo $data['Q3F4S2'] ?>" value="<?php echo set_value('Q3F4S2'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F4S3" type="text"  name="Q3F4S3" placeholder="<?php if(isset($data['Q3F4S3'])) echo $data['Q3F4S3'] ?>" value="<?php echo set_value('Q3F4S3'); ?>"/>
    </div>
  </div>
  <div class="form-group row">
    <div class="col-xs-1"> 5 </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F5S1" type="text" name="Q3F5S1" placeholder="<?php if(isset($data['Q3F5S1'])) echo $data['Q3F5S1'] ?>" value="<?php echo set_value('Q3F5S1'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F5S2" type="text" name="Q3F5S2" placeholder="<?php if(isset($data['Q3F5S2'])) echo $data['Q2A5S2'] ?>" value="<?php echo set_value('Q3F5S2'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F5S3" type="text" name="Q3F5S3" placeholder="<?php if(isset($data['Q3F5S3'])) echo $data['Q3F5S3'] ?>" value="<?php echo set_value('Q3F5S3'); ?>"/>
    </div>
  </div>
  <div class="form-group row">
    <div class="col-xs-1"> 6 </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F6S1" type="text" name="Q3F6S1" placeholder="<?php if(isset($data['Q3F6S1'])) echo $data['Q3F6S1'] ?>" value="<?php echo set_value('Q3F6S1'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F6S2" type="text" name="Q3F6S2" placeholder="<?php if(isset($data['Q3F6S2'])) echo $data['Q3F6S2'] ?>" value="<?php echo set_value('Q3F6S2'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F6S3" type="text" name="Q3F6S3" placeholder="<?php if(isset($data['Q3F6S3'])) echo $data['Q3F6S3'] ?>" value="<?php echo set_value('Q3F6S3'); ?>"/>
    </div>
  </div>
  <div class="form-group row">
    <div class="col-xs-1"> 7 </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F7S1" type="text" name="Q3F7S1" placeholder="<?php if(isset($data['Q3F7S1'])) echo $data['Q3F7S1'] ?>" value="<?php echo set_value('Q3F7S1'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F7S2" type="text" name="Q3F7S2" placeholder="<?php if(isset($data['Q3F7S2'])) echo $data['Q3F7S2'] ?>" value="<?php echo set_value('Q3F7S2'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F7S3" type="text" name="Q3F7S3" placeholder="<?php if(isset($data['Q3F7S3'])) echo $data['Q3F7S3'] ?>" value="<?php echo set_value('Q3F7S3'); ?>"/>
    </div>
  </div>
  <div class="form-group row">
    <div class="col-xs-1"> 8 </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F8S1" type="text" name="Q3F8S1" placeholder="<?php if(isset($data['Q3F8S1'])) echo $data['Q3F8S1'] ?>" value="<?php echo set_value('Q3F8S1'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F8S2" type="text" name="Q3F8S2" placeholder="<?php if(isset($data['Q3F8S2'])) echo $data['Q3F8S2'] ?>" value="<?php echo set_value('Q3F8S2'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F8S3" type="text" name="Q3F8S3" placeholder="<?php if(isset($data['Q3F8S3'])) echo $data['Q3F8S3'] ?>" value="<?php echo set_value('Q3F8S3'); ?>"/>
    </div>
  </div>
  <div class="form-group row">
    <div class="col-xs-1"> 9 </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F9S1" type="text" name="Q3F9S1" placeholder="<?php if(isset($data['Q3F9S1'])) echo $data['Q3F9S1'] ?>" value="<?php echo set_value('Q3F9S1'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F9S2" type="text" name="Q3F9S2" placeholder="<?php if(isset($data['Q3F9S2'])) echo $data['Q3F9S2'] ?>" value="<?php echo set_value('Q3F9S2'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F9S3" type="text" name="Q3F9S3" placeholder="<?php if(isset($data['Q3F9S3'])) echo $data['Q3F9S3'] ?>" value="<?php echo set_value('Q3F9S3'); ?>"/>
    </div>
  </div>
  <div class="form-group row">
    <div class="col-xs-1"> 10 </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F10S1" type="text" name="Q3F10S1" placeholder="<?php if(isset($data['Q3F10S1'])) echo $data['Q3F10S1'] ?>" value="<?php echo set_value('Q3F10S1'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F10S2" type="text" name="Q3F10S2" placeholder="<?php if(isset($data['Q3F10S2'])) echo $data['Q3F10S2'] ?>" value="<?php echo set_value('Q3F10S2'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q3F10S3" type="text" name="Q3F10S3" placeholder="<?php if(isset($data['Q3F10S3'])) echo $data['Q3F10S3'] ?>" value="<?php echo set_value('Q3F10S3'); ?>"/>
    </div>
  </div>
</div>
...
<br>
  <input type="hidden" value="<?php if(isset($other['Q4G4S3'])) echo $other['Q4G4S3'];?>" id="Q4G4S3"/>
  <?php
  if(isset($data['Q5F1']))
  {  if($data['Q5F1'] == 'Y')
    {
...
if(isset($data['Q5F1S1']))
 ...
 else
 {
  ...
  ?>
   ...
   <br>
   <input type="number" min="0" name="Q5F1S2" id="Q5F1S2A" class="form-control space-textbox" placeholder="<?php if(isset($data['Q5F1S2'])) echo $data['Q5F1S2'] ?>" value="<?php echo set_value('Q5F1S2'); ?>">
 </div>
 <br>
...
if(isset($data['Q5F1S1']))
 ...
 else
 {
  ...
  ?>
   ...
   <br>
   <input type="text" id="Q5F1S3A" name="Q5F1S3" class="form-control space-textbox" placeholder="<?php if(isset($data['Q5F1S3'])) echo $data['Q5F1S3'] ?>" value="<?php echo set_value('Q5F1S3'); ?>">
 </div>
 <br>
     ...
     <div class="form-group" id="Q5F3" style="display: none;">
       ...
       <?php } else {
         ...
         <div class="form-group" id="Q5F3" style="display: none;">
           ...
           <div class="form-group">
              <input type="number" class="form-control space-textbox" id="Q5F3S1" name="Q5F3S1" value="<?php echo set_value('Q5F3S1')?>" placeholder="<?php if(isset($data['Q5F3S1'])) echo $data['Q5F3S1']; ?>"> 
          </div>
        </div>
        ...
        if(isset($data['Q4F1']))
          if($data['Q4F1'] == 'Y')
          {
           ...
           <div class=" row">
            ...
            <div class="col-xs-3">
             <input class="form-control space-textbox" id="Q6F2S1" type="number" name="Q6F2S1" placeholder="<?php if(isset($data['Q6F2S1'])) echo $data['Q6F2S1'] ?>" value="<?php echo set_value('Q6F2S1'); ?>"/>
           </div>
           <div class="col-xs-3">
             <input class="form-control space-textbox" id="Q6F2S2" type="number" name="Q6F2S2" placeholder="<?php if(isset($data['Q6F2S2'])) echo $data['Q6F2S2'] ?>" value="<?php echo set_value('Q6F2S2'); ?>" />
           </div>
           <div class="col-xs-3">
             <input class="form-control space-textbox" id="Q6F2S3" type="text" name="Q6F2S3" placeholder="<?php if(isset($data['Q6F2S3'])) echo $data['Q6F2S3'] ?>" value="<?php echo set_value('Q6F2S3'); ?>"/>
           </div>
         </div>
         <div class=" row">
          <div class="col-xs-3"> Instant Noodles like Knorr, Cup-a-noodles, Top Ramen, Wai-wai, Yippee, Foodles, Maggi, etc </div>
          <div class="col-xs-3">
           <input class="form-control space-textbox" id="Q6F3S1" type="number" name="Q6F3S1" placeholder="<?php if(isset($data['Q6F3S1'])) echo $data['Q6F3S1'] ?>" value="<?php echo set_value('Q6F3S3'); ?>"/>
         </div>
         <div class="col-xs-3">
           <input class="form-control space-textbox" id="Q6F3S2" type="number" name="Q6F3S2" placeholder="<?php if(isset($data['Q6F3S2'])) echo $data['Q6F3S2'] ?>" value="<?php echo set_value('Q6F3S2'); ?>" />
         </div>
         <div class="col-xs-3">
           <input class="form-control space-textbox" id="Q6F3S3" type="text" name="Q6F3S3" placeholder="<?php if(isset($data['Q6F3S3'])) echo $data['Q6F3S3'] ?>" value="<?php echo set_value('Q6F3S3'); ?>"/>
         </div>
       </div>
       <div class=" row">
         <div class="col-xs-3"> Potato fries and burgers </div>
         <div class="col-xs-3">
          <input class="form-control space-textbox" id="Q6F4S1" type="number" name="Q6F4S1" placeholder="<?php if(isset($data['Q6F4S1'])) echo $data['Q6F4S1'] ?>" value="<?php echo set_value('Q6F4S1'); ?>"/>
        </div>
        <div class="col-xs-3">
          <input class="form-control space-textbox" id="Q6F4S2" type="number" name="Q6F4S2" placeholder="<?php if(isset($data['Q6F4S2'])) echo $data['Q6F4S2'] ?>" value="<?php echo set_value('Q6F4S2'); ?>" />
        </div>
        <div class="col-xs-3">
          <input class="form-control space-textbox" id="Q6F4S3" type="text" name="Q6F4S3" placeholder="<?php if(isset($data['Q6F4S3'])) echo $data['Q6F4S3'] ?>" value="<?php echo set_value('Q6F4S3'); ?>"/>
        </div>
      </div>
      <div class=" row">
       <div class="col-xs-3"> Confectionery items (chocolate, candies, gums) </div>
       <div class="col-xs-3">
        <input class="form-control space-textbox" id="Q6F5S1" type="number" name="Q6F5S1" placeholder="<?php if(isset($data['Q6F5S1'])) echo $data['Q6F5S1'] ?>" value="<?php echo set_value('Q6F5S1'); ?>"/>
      </div>
      <div class="col-xs-3">
        <input class="form-control space-textbox" id="Q6F5S2" type="number" name="Q6F5S2" placeholder="<?php if(isset($data['Q6F5S2'])) echo $data['Q6F5S2'] ?>" value="<?php echo set_value('Q6F5S2'); ?>"/>
      </div>
      <div class="col-xs-3">
        <input class="form-control space-textbox" id="Q6F5S3" type="text" name="Q6F5S3" placeholder="<?php if(isset($data['Q6F5S3'])) echo $data['Q6F5S3'] ?>" value="<?php echo set_value('Q6F5S3'); ?>"/>
      </div>
    </div>
    <div class=" row">
     <div class="col-xs-3"> Ice cream </div>
     <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q6F6S1" type="number" name="Q6F6S1" placeholder="<?php if(isset($data['Q6F6S1'])) echo $data['Q6F6S1'] ?>" value="<?php echo set_value('Q6F6S1'); ?>"/>
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q6F6S2" type="number" name="Q6F6S2" placeholder="<?php if(isset($data['Q6F6S2'])) echo $data['Q6F6S2'] ?>" value="<?php echo set_value('Q6F6S2'); ?>" />
    </div>
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="Q6F6S3" type="text" name="Q6F6S3" placeholder="<?php if(isset($data['Q6F6S3'])) echo $data['Q6F6S3'] ?>" value="<?php echo set_value('Q6F6S3'); ?>"/>
    </div>
  </div>
  <div class=" row">
   <div class="col-xs-3"> Carbonated beverages </div>
   <div class="col-xs-3">
    <input class="form-control space-textbox" id="Q6F7S1" type="number" name="Q6F7S1" placeholder="<?php if(isset($data['Q6F7S1'])) echo $data['Q6F7S1'] ?>" value="<?php echo set_value('Q6F7S1'); ?>"/>
  </div>
  <div class="col-xs-3">
    <input class="form-control space-textbox" id="Q6F7S2" type="number" name="Q6F7S2" placeholder="<?php if(isset($data['Q6F7S2'])) echo $data['Q6F7S2'] ?>" value="<?php echo set_value('Q6F7S2'); ?>" />
  </div>
  <div class="col-xs-3">
    <input class="form-control space-textbox" id="Q6F7S3" type="text" name="Q6F7S3" placeholder="<?php if(isset($data['Q6F7S3'])) echo $data['Q6F7S3'] ?>" value="<?php echo set_value('Q6F7S3'); ?>"/>
  </div>
</div>
<div class=" row">
 <div class="col-xs-3"> Sugar sweetened non-carbonated beverages </div>
 <div class="col-xs-3">
  <input class="form-control space-textbox" id="Q6F8S1" type="number" name="Q6F8S1" placeholder="<?php if(isset($data['Q6F8S1'])) echo $data['Q6F8S1'] ?>" value="<?php echo set_value('Q6F8S1'); ?>"/>
</div>
<div class="col-xs-3">
  <input class="form-control space-textbox" id="Q6F8S2" type="number" name="Q6F8S2" placeholder="<?php if(isset($data['Q6F8S2'])) echo $data['Q6F8S2'] ?>" value="<?php echo set_value('Q6F8S2'); ?>" />
</div>
<div class="col-xs-3">
  <input class="form-control space-textbox" id="Q6F8S3" type="text" name="Q6F8S3" placeholder="<?php if(isset($data['Q6F8S3'])) echo $data['Q6F8S3'] ?>" value="<?php echo set_value('Q6F8S3'); ?>"/>
</div>
</div>
<div class=" row">
 <div class="col-xs-3"> Packaged/bottled nimboo paani/lassi/flavoured milk </div>
 <div class="col-xs-3">
  <input class="form-control space-textbox" id="Q6F9S1" type="number" name="Q6F9S1" placeholder="<?php if(isset($data['Q6F9S1'])) echo $data['Q6F9S1'] ?>" value="<?php echo set_value('Q6F9S1'); ?>"/>
</div>
<div class="col-xs-3">
  <input class="form-control space-textbox" id="Q6F9S2" type="number" name="Q6F9S2" placeholder="<?php if(isset($data['Q6F9S2'])) echo $data['Q6F9S2'] ?>" value="<?php echo set_value('Q6F9S2'); ?>" />
</div>
<div class="col-xs-3">
  <input class="form-control space-textbox" id="Q6F9S3" type="text" name="Q6F9S3" placeholder="<?php if(isset($data['Q6F9S3'])) echo $data['Q6F9S3'] ?>" value="<?php echo set_value('Q6F9S3'); ?>"/>
</div>
</div>
<div class=" row">
 <div class="col-xs-3"> Packaged/bottled energy drinks </div>
 <div class="col-xs-3">
  <input class="form-control space-textbox" id="Q6F10S1" type="number" name="Q6F10S1" placeholder="<?php if(isset($data['Q6F10S1'])) echo $data['Q6F10S1'] ?>" value="<?php echo set_value('Q6F10S1'); ?>"/>
</div>
<div class="col-xs-3">
  <input class="form-control space-textbox" id="Q6F10S2" type="number" name="Q6F10S2" placeholder="<?php if(isset($data['Q6F10S2'])) echo $data['Q6F10S2'] ?>" value="<?php echo set_value('Q6F10S2'); ?>" />
</div>
<div class="col-xs-3">
  <input class="form-control space-textbox" id="Q6F10S3" type="text" name="Q6F10S3" placeholder="<?php if(isset($data['Q6F10S3'])) echo $data['Q6F10S3'] ?>" value="<?php echo set_value('Q6F10S3'); ?>"/>
</div>
</div>
</div>
               ...
               if($data['Q7F1'] == 'Y')
               {
                ...
                <div class="form-group" id="traditional">
                 ...
                 <div class="form-group row">
                   ...
                   <div class="col-xs-5">
                     <input class="form-control space-textbox" id="Q7F1S1" type="number" name="Q7F1S1" placeholder="<?php if(isset($data['Q7F1S1'])) echo $data['Q7F1S1'] ?>" value="<?php echo set_value('Q7F1S1'); ?>"/>
                   </div>
                 </div>
                 <div class="form-group row">
                   <div class="col-xs-3">
                   ...
                   <div class="col-xs-5">
                     <input class="form-control space-textbox" id="Q7F1S2" type="number" name="Q7F1S2" placeholder="<?php if(isset($data['Q7F1S2'])) echo $data['Q7F1S2'] ?>" value="<?php echo set_value('Q7F1S2'); ?>"/>
                   </div>
                 </div>
                 <div class="form-group row">
                  <div class="col-xs-3">
                 ...
                 <div class="col-xs-5">
                   <input class="form-control space-textbox" id="Q7F1S3" type="number" name="Q7F1S3" placeholder="<?php if(isset($data['Q7F1S3'])) echo $data['Q7F1S3'] ?>" value="<?php echo set_value('Q7F1S3'); ?>"/>
                 </div>
               </div>
               <div class="form-group row">
                 <div class="col-xs-3">
                 ...
                 <div class="col-xs-5">
                   <input class="form-control space-textbox" id="Q7F1S4" type="number" name="Q7F1S4" placeholder="<?php if(isset($data['Q7F1S4'])) echo $data['Q7F1S4'] ?>" value="<?php echo set_value('Q7F1S4'); ?>"/>
                 </div>
               </div>
               <div class="form-group row">
                 <div class="col-xs-3">
                 ...
                 <div class="col-xs-5">
                   <input class="form-control space-textbox" id="Q7F1S5" type="number" name="Q7F1S5" placeholder="<?php if(isset($data['Q7F1S5'])) echo $data['Q7F1S5'] ?>" value="<?php echo set_value('Q7F1S5'); ?>"/>
                 </div>
               </div>
          ...
          if(isset($data['Q4F1']))
                   ...
                   if(isset($data['Q4F1']))
                    if($data['Q4F1'] == 'Y')
                     ...
                     if(isset($data['Q8F1']))
                       if($data['Q8F1'] == 'Y')
                       {
                         ...
                         <div class="form-group" id="beverages">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-xs-5">
                              <input class="form-control space-textbox" id="Q8F1S1" type="number" name="Q8F1S1" placeholder="<?php if(isset($data['Q8F1S1'])) echo $data['Q8F1S1'] ?>" value="<?php echo set_value('Q8F1S1'); ?>"/>
                            </div>
                          </div>
                          <div class="form-group row">
                            <div class="col-xs-3">
                            ...
                            <div class="col-xs-5">
                              <input class="form-control space-textbox" id="Q8F1S2" type="number" name="Q8F1S2" placeholder="<?php if(isset($data['Q8F1S2'])) echo $data['Q8F1S2'] ?>" value="<?php echo set_value('Q8F1S2'); ?>"/>
                            </div>
                          </div>
                          <div class="form-group row">
                            <div class="col-xs-3">
                            ...
                            <div class="col-xs-5">
                              <input class="form-control space-textbox" id="Q8F1S3" type="number" name="Q8F1S3" placeholder="<?php if(isset($data['Q8F1S3'])) echo $data['Q8F1S3'] ?>" value="<?php echo set_value('Q8F1S3'); ?>"/>
                            </div>
                          </div>
                          <div class="form-group row">
                            <div class="col-xs-3">
                            ...
                            <div class="col-xs-5">
                              <input class="form-control space-textbox" id="Q8F1S4" type="number" name="Q8F1S4" placeholder="<?php if(isset($data['Q8F1S4'])) echo $data['Q8F1S4'] ?>" value="<?php echo set_value('Q8F1S4'); ?>"/>
                            </div>
                          </div>
                          <div class="form-group row">
                            <div class="col-xs-3">
                            ...
                            <div class="col-xs-5">
                              <input class="form-control space-textbox" id="Q8F1S5" type="number" name="Q8F1S5" placeholder="<?php if(isset($data['Q8F1S5'])) echo $data['Q8F1S5'] ?>" value="<?php echo set_value('Q8F1S5'); ?>"/>
                            </div>
                          </div>
                       ...
                       if(isset($data['Q9F1']))
                         if($data['Q9F1'] == 'Y')
                         {
                           ...
                           <div class="form-group" id="Q9F2">
                            <label class="control-label"><span class="cube">6(a)</span>Please provide details:<a class="tt" data-tooltip="For example, Kitkat chocolate as consolation prize or food/discount coupons of Dominos/Pizza Hut" href="#"><span class="badge">?</span></a></label>
                            <textarea type="text" rows="5" id="Q9F2"  name="Q9F2" placeholder="<?php if(isset($data['Q9F2'])) echo $data['Q9F2'] ?>" value="<?php echo set_value('Q9F2'); ?>"></textarea>  <br>
                          </div>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                          <label class="radio-inline text-gray">
                           <input type="radio" id="Q10F1" name="Q10F1" onclick="ComputeChocolates(1)" value="<?php echo set_value('Q10F1','Y')?>" <?php if(isset($data['Q10F1'])) echo $data['Q10F1'] == 'Y'?"checked":"" ?>>
                           Yes </label>
                           <label class="radio-inline text-gray">
                            <input type="radio" id="Q10F1" name="Q10F1" onclick="ComputeChocolates(2)" value="<?php echo set_value('Q10F1','N')?>" <?php if(isset($data['Q10F1'])) echo $data['Q10F1'] == 'N'?"checked":"" ?>/>
                            No </label>
                          </div>
                        </div>
                        <?php
                        if(isset($data['Q10F1']))
                         if($data['Q10F1'] == 'Y')
                         {
                           ...
                           <div class="form-group" id="Q10F2">
                            ...
                            <textarea type="text" id="Q10F2" rows="5"  name="Q10F2" placeholder="<?php if(isset($data['Q10F2'])) echo $data['Q10F2'] ?>" value="<?php echo set_value('Q10F2'); ?>"></textarea>  <br>
                          </div>
                         ...
                         if(isset($data['Q11F1']))
                           if($data['Q11F1'] == 'Y')
                           {
                             ...
                             <div class="form-group" id="Q11F2">
                              ...
                              <textarea type="text" id="Q11F2" rows="5"  name="Q11F2" placeholder="<?php if(isset($data['Q11F2'])) echo $data['Q11F2'] ?>" value="<?php echo set_value('Q11F2'); ?>"></textarea>  <br>
                            </div>
                            <div class="form-group" id="Q11F3">
                              ...
                              <div class="form-group">
                                <label class="radio-inline text-gray">
                                 <input type="radio" id="Q11F3" name="Q11F3" value="<?php echo set_value('Q11F3','Y')?>" <?php if(isset($data['Q11F3'])) echo $data['Q11F3'] == 'Y'?"checked":"" ?>>
                                 Yes </label>
                                 <label class="radio-inline text-gray">
                                  <input type="radio" id="Q11F3" name="Q11F3" value="<?php echo set_value('Q11F3','N')?>" <?php if(isset($data['Q11F3'])) echo $data['Q11F3'] == 'N'?"checked":"" ?>/I>
                                  No </label>
                                </div>
                              </div>
                              <?php
                            ...
                            <div class="form-group" id="Q11F2" style="display: none;">
                              <label class="control-label"><span class="cube">8(a)</span> Please provide the names of sponsors: <a class="tt" data-tooltip="For example Complan, Quaker Oats, Cadbury, etc." href="#"><span class="badge">?</span></a></label>
                              <textarea type="text" rows="5"  id="Q11F2" name="Q11F2" placeholder="<?php if(isset($data['Q11F2'])) echo $data['Q11F2'] ?>" value="<?php echo set_value('Q11F2'); ?>"></textarea>  <br>
                            </div>
                      ...
                      <br>
                      Please upload all supporting documents related to this section here. Note: files must be in one of the following formats: PDF Document (.pdf), Word Document (.doc, .docx), Image File (.jpg, .jpeg). File size per document should not exceed 500 KB.<br/><br/>
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                           <label class="radio-inline text-gray">
                            ...
                            Yes </label>
                            <label class="radio-inline text-gray">
                             <input type="radio" name="Q13F1" onclick="ExtraCurricular(2)" value="<?php echo set_value('Q13F1','N')?>" <?php if(isset($data['Q13F1'])) echo $data['Q13F1'] == 'N'?"checked":"" ?>/>
                             No </label>
                           </div>
                         </div>
            ...
            <br>
                      ...
                      <div class="text-center">
                        <button type="button" class="org-btn" id="foodprevious" value="movenext" onClick="javasript:window.location.href='<?php echo base_url('energy'); ?>'">Previous</button>
                        <button type="submit" class="org-btn" id="foodnext" value="movenext" >Next</button>
                        <input type="button" class="org-btn" value="Save and Resume Later" class="submit button" id="foodresume" name="resume"/>
...
<div id="videoModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <iframe width="100%" height="330px" src="https://www.youtube.com/embed/9r3Lwrd9BUs" id="video" frameborder="0" allowfullscreen></iframe>
