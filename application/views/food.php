...
<div class="container">
    <div class="content-form">
        ...
        <div class="form-group">
            ...
            include the canteen in-charge in your audit team. <br><br>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <label><h6>Task 2: Find out about the food service in your school.<a class="tt"
                ...
                if (isset($other['Q1S1']) && isset($other['Q9G1']))
                    if ($other['Q1S1'] >= 3 && $other['Q9G1'] < 3) {
                        ?>
                        <div class="form-group">
                            <label class="control-label"><span class="cube">2</span>Does your school serve whole day’s
                                meals?</label>
                            <div class="form-group">
                                <label class="radio-inline text-gray">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S1"
                                                                                           value="<?php echo set_value('Q5F2S1', 'Y') ?>" <?php if (isset($data['Q5F2S1'])) echo $data['Q5F2S1'] == 'Y' ? "checked" : "" ?>/>Yes
                                                                                </label>
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S1"
                                                                                           value="<?php echo set_value('Q5F2S1', 'N') ?>" <?php if (isset($data['Q5F2S1'])) echo $data['Q5F2S1'] == 'N' ? "checked" : "" ?>>No
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S2"
                                                                                           value="<?php echo set_value('Q5F2S2', 'Y') ?>" <?php if (isset($data['Q5F2S2'])) echo $data['Q5F2S1'] == 'Y' ? "checked" : "" ?>>Yes
                                                                                </label>
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S2"
                                                                                           value="<?php echo set_value('Q5F2S2', 'N') ?>" <?php if (isset($data['Q5F2S2'])) echo $data['Q5F2S2'] == 'N' ? "checked" : "" ?>>No
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S3"
                                                                                           value="<?php echo set_value('Q5F2S3', 'Y') ?>" <?php if (isset($data['Q5F2S3'])) echo $data['Q5F2S3'] == 'Y' ? "checked" : "" ?>>Yes
                                                                                </label>
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S3"
                                                                                           value="<?php echo set_value('Q5F2S3', 'N') ?>" <?php if (isset($data['Q5F2S3'])) echo $data['Q5F2S3'] == 'N' ? "checked" : "" ?>>No
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S4"
                                                                                           value="<?php echo set_value('Q5F2S4', 'Y') ?>" <?php if (isset($data['Q5F2S4'])) echo $data['Q5F2S4'] == 'Y' ? "checked" : "" ?>>Yes
                                                                                </label>
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S4"
                                                                                           value="<?php echo set_value('Q5F2S4', 'N') ?>" <?php if (isset($data['Q5F2S4'])) echo $data['Q5F2S4'] == 'N' ? "checked" : "" ?>>No
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S5"
                                                                                           value="<?php echo set_value('Q5F2S5', 'Y') ?>" <?php if (isset($data['Q5F2S5'])) echo $data['Q5F2S5'] == 'Y' ? "checked" : "" ?>>Yes
                                                                                </label>
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S5"
                                                                                           value="<?php echo set_value('Q5F2S5', 'N') ?>" <?php if (isset($data['Q5F2S5'])) echo $data['Q5F2S5'] == 'N' ? "checked" : "" ?>>No
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S6"
                                                                                           value="<?php echo set_value('Q5F2S6', 'Y') ?>" <?php if (isset($data['Q5F2S6'])) echo $data['Q5F2S6'] == 'Y' ? "checked" : "" ?>>Yes
                                                                                </label>
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S6"
                                                                                           value="<?php echo set_value('Q5F2S6', 'N') ?>" <?php if (isset($data['Q5F2S6'])) echo $data['Q5F2S6'] == 'N' ? "checked" : "" ?>>No
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S7"
                                                                                           value="<?php echo set_value('Q5F2S7', 'Y') ?>" <?php if (isset($data['Q5F2S7'])) echo $data['Q5F2S7'] == 'Y' ? "checked" : "" ?>>Yes
                                                                                </label>
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S7"
                                                                                           value="<?php echo set_value('Q5F2S7', 'N') ?>" <?php if (isset($data['Q5F2S7'])) echo $data['Q5F2S7'] == 'N' ? "checked" : "" ?>>No
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S8"
                                                                                           value="<?php echo set_value('Q5F2S8', 'Y') ?>" <?php if (isset($data['Q5F2S8'])) echo $data['Q5F2S8'] == 'Y' ? "checked" : "" ?>>Yes
                                                                                </label>
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S8"
                                                                                           value="<?php echo set_value('Q5F2S8', 'N') ?>" <?php if (isset($data['Q5F2S8'])) echo $data['Q5F2S8'] == 'N' ? "checked" : "" ?>>No
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S9"
                                                                                           value="<?php echo set_value('Q5F2S9', 'Y') ?>" <?php if (isset($data['Q5F2S9'])) echo $data['Q5F2S9'] == 'Y' ? "checked" : "" ?>>Yes
                                                                                </label>
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S9"
                                                                                           value="<?php echo set_value('Q5F2S9', 'N') ?>" <?php if (isset($data['Q5F2S9'])) echo $data['Q5F2S9'] == 'N' ? "checked" : "" ?>>No
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S10"
                                                                                           value="<?php echo set_value('Q5F2S10', 'Y') ?>" <?php if (isset($data['Q5F2S10'])) echo $data['Q5F2S10'] == 'Y' ? "checked" : "" ?>>Yes
                                                                                </label>
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S10"
                                                                                           value="<?php echo set_value('Q5F2S10', 'N') ?>" <?php if (isset($data['Q5F2S10'])) echo $data['Q5F2S10'] == 'N' ? "checked" : "" ?>>No
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S11"
                                                                                           value="<?php echo set_value('Q5F2S11', 'Y') ?>" <?php if (isset($data['Q5F2S11'])) echo $data['Q5F2S11'] == 'Y' ? "checked" : "" ?>>Yes
                                                                                </label>
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S11"
                                                                                           value="<?php echo set_value('Q5F2S11', 'N') ?>" <?php if (isset($data['Q5F2S11'])) echo $data['Q5F2S11'] == 'N' ? "checked" : "" ?>>No
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S12"
                                                                                           value="<?php echo set_value('Q5F2S12', 'Y') ?>" <?php if (isset($data['Q5F2S12'])) echo $data['Q5F2S12'] == 'Y' ? "checked" : "" ?>>Yes
                                                                                </label>
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S12"
                                                                                           value="<?php echo set_value('Q5F2S12', 'N') ?>" <?php if (isset($data['Q5F2S12'])) echo $data['Q5F2S12'] == 'N' ? "checked" : "" ?>>No
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S13"
                                                                                           value="<?php echo set_value('Q5F2S13', 'Y') ?>" <?php if (isset($data['Q5F2S13'])) echo $data['Q5F2S13'] == 'Y' ? "checked" : "" ?>>Yes
                                                                                </label>
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S13"
                                                                                           value="<?php echo set_value('Q5F2S13', 'N') ?>" <?php if (isset($data['Q5F2S13'])) echo $data['Q5F2S13'] == 'N' ? "checked" : "" ?>>No
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S14"
                                                                                           value="<?php echo set_value('Q5F2S14', 'Y') ?>" <?php if (isset($data['Q5F2S14'])) echo $data['Q5F2S14'] == 'Y' ? "checked" : "" ?>>Yes
                                                                                </label>
                                                                                <label class="radio-inline text-gray">
                                                                                    <input type="radio" name="Q5F2S14"
                                                                                           value="<?php echo set_value('Q5F2S14', 'N') ?>" <?php if (isset($data['Q5F2S14'])) echo $data['Q5F2S14'] == 'N' ? "checked" : "" ?>>No
                                                                                </label>
                                                                            </div>
                                                                                                    ...
                                                                                                    <div class="form-group">
                                                                                                        <label class="radio-inline text-gray">
                                                                                                            <input type="radio"
                                                                                                                   ...
                                                                                                                   value="<?php echo set_value('Q7F1', 'Y') ?>" <?php if (isset($data['Q7F1'])) echo $data['Q7F1'] == 'Y' ? "checked" : "" ?>/>Yes
                                                                                                        </label>
                                                                                                        <label class="radio-inline text-gray">
                                                                                                            <input type="radio"
                                                                                                                   id="Q7F1_2"
                                                                                                                   ...
                                                                                                                   value="<?php echo set_value('Q7F1', 'N') ?>" <?php if (isset($data['Q7F1'])) echo $data['Q7F1'] == 'N' ? "checked" : "" ?>/>No
                                                                                                        </label>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <?php
