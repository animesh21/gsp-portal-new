...
1. Lighting 2. Housekeeping 3. Cooking 4. Transport 5. Teaching/ learning aid. If your school does not use a particular source of energy, enter 0."><span
      ...
      <div class="form-group">
        <label><span class="cube">3</span> What appliances does your school have? </label>
        <div class="form-group-1 row">
          <div class="col-xs-3">
...
(smart classroom)</div>
      ...
      <div class="form-group">
        <label class="control-label"><span class="cube">4</span>Are there any alternate sources of energy
      ...
      <div class="form-group" id="typeofenergy">
        <div class="form-group">
          <label><span class="cube">4(a)</span>If yes, do you use:</label>
      ...
      <div class="form-group" id="typeofenergy" style="display:none">
        <div class="form-group">
          <label><span class="cube">4(a)</span>If yes, do you use: <a class="tt" data-tooltip="Do not add solar water heater here. Consider only solar panels which give you electricity."><span class="badge">?</span></a></label>
        </div>
        <ul class="list-inline">
          <li>
            <label>Solar</label>
      ...
      <div class="form-group">
        <div class="form-group">
          <label><span class="cube">5</span>Does your school use solar water heater?</label>
          <ul class="list-inline">
            <li>
              <label>
              <input type="radio" name="Q10E1S1" id="Solar"
                                       value="<?php echo set_value('Q10E1S1'); ?>" <?php if (isset($data['Q10E1S1'])) echo "checked"; ?>/> Yes</label>
            </li>
            <li>
              <label>
              <input type="radio" name="Q10E1S1" id="Wind"
                                       value="<?php echo set_value('Q10E1S2'); ?>" <?php if (isset($data['Q10E1S2'])) echo "checked"; ?>/> No</label>
            </li>
          </ul>
        </div>
      </div>
