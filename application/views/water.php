  ...
  <div class="content-form">
    ...
    <div class="form-group">
      ...
      <div class="form-group row">
        ...
        <div class="col-xs-3">
          <input class="form-control space-textbox" id="Q3W5S2" type="text" name="Q3W5S2" placeholder="<?php if(isset($data['Q3W5S2'])) echo $data['Q2W5S2'] ?>" value="<?php echo set_value('Q3W5S2'); ?>"/>
        </div>
        <div class="col-xs-3">
    ...
    <div class="form-group">
      <label  class="control-label">Total water consumption of your school</label>
      <div class="form-group row">
        <div class="col-xs-3">
      ...
      <div class="form-group row">
        ...
        <div class="col-xs-5">
          <input class="form-control space-textbox" onkeyup="WaterConsumption()" onchange="WaterConsumption()" id="Q4W11" type="number" min="0" name="Q4W11" placeholder="<?php if(isset($data['Q4W11'])) echo $data['Q4W11'] ?>" value="<?php echo set_value('Q4W11'); ?>"/>
        </div>
      </div>
      <div class="form-group row">
        <div class="col-xs-3">
        ...
        <div class="col-xs-5">
          <input class="form-control space-textbox" onkeyup="WaterConsumption()" onchange="WaterConsumption()" id="Q4W12" type="number" min="0" name="Q4W12" placeholder="<?php if(isset($data['Q4W12'])) echo $data['Q4W12'] ?>" value="<?php echo set_value('Q4W12'); ?>"/>
        </div>
      </div>
      <div class="form-group row">
        <div class="col-xs-3">
        ...
        <div class="col-xs-5">
          <input class="form-control space-textbox" id="Q4W13" type="number" min="0" name="Q4W13" placeholder="<?php if(isset($data['Q4W13'])) echo $data['Q4W13'] ?>" value="<?php echo set_value('Q4W13'); ?>" readonly/>
        </div>
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        <label class="control-label"><span class="cube">5</span> What are the water conservation practices your school follows</label>
        <div class="form-group">
    ...
    <div class="form-group">
      <label><span class="cube">6</span>Do you have Rainwater harvesting (RWH) system in your school?</label>
      <div class="form-group">
        <label class="radio-inline text-gray">
    ...
    <div class="form-group" id="Q8W2S1"
      ...
      <div class="form-group">
        <label class="radio-inline text-gray">
        <input type="radio" name="Q8W2S1" onclick="Catchment(1)" value="<?php echo set_value('Q8W2S1','Y')?>" <?php if(isset($data['Q8W2S1'])) echo $data['Q8W2S1'] == 'Y'?"checked":"" ?>>
        Yes </label>
        <label class="radio-inline text-gray">
        <input type="radio" name="Q8W2S1" onclick="Catchment(2)" value="<?php echo set_value('Q8W2S1','N')?>" <?php if(isset($data['Q8W2S1'])) echo $data['Q8W2S1'] == 'N'?"checked":"" ?>/>
        No </label>
      </div>
    </div>
    ...
    <div class="form-group" id="Q8W2S2S1"
                ...
                if(isset($data['Q8W2S2']))
                  ...
                  >
      <label><span class="cube">6(b)(1)</span>If your school only stores rainwater, please select the use of stored rainwater: </label>
      <div class="form-group">
        <ul>
          <li>
            <label class="radio-inline text-gray">
    ...
    <div class="form-group" id="Q8W2S27"
                ...
                if(isset($data['Q8W2S2']))
                  ...
                  >
      <label><span class="cube">6(b)(3)</span>Does your school have groundwater recharge structure? </label>
      <div class="form-group">
        <label class="radio-inline text-gray">
    ...
    <div class="form-group" id="Q8W2S2S9"
               ...
               if(isset($data['Q8W2S2S7']))
                ...
                >
      <label><span class="cube">6(b)(3) ii</span>Please tick the type of groundwater recharge structure used in your school: </label>
      <div class="form-group">
        <ul>
          <li>
    ...
    <div class="form-group" id="Q8W2S2S10"
                ...
                if(isset($data['Q8W2S2']))
                  ...
                  >
      <label><span class="cube">6(b)(4)</span>If your school practices rainwater harvesting, then what is the ratio between storage and recharge </label>
      <div class="form-group">
        <ul>
          <li>
            <label class="radio-inline text-gray">
    ...
    <div class="form-group" id="Q8W2S4"
              ...
              if(isset($data['Q8W2']))
                ...
                >
      <label><span class="cube">6(d)</span>Please select (from the list given below) the rainwater harvesting structures present in your school: </label>
      <div class="form-group">
        <ul>
          <li>
    ...
    <div class="form-group" id="Q8W2S7"
              ...
              if(isset($data['Q8W2S61']))
                ...
                ?>
                >
      <label><span class="cube">6(f)(1)</span>Please specify when does your school clean the catchment and RWH system? </label>
      <div class="form-group">
        <ul>
          <li>
            <label class="radio-inline text-gray">
    ...
    <div class="form-group" id="Q8W2S8"
              ...
              if(isset($data['Q8W2']))
                ...
                >
      <label><span class="cube">6(g)</span>Does your school monitor the rainwater harvesting structure for its efficiency? </label>
      <div class="form-group">
        <label class="radio-inline text-gray">
    ...
    <div class="form-group" id="Q8W2S9"
              ...
              if(isset($data['Q8W2S8']))
                ...
                >
      <label><span class="cube">6(g)(1)</span>Please specify when does your school monitor the groundwater level? </label>
      <div class="form-group">
        <ul>
          <li>
            <label class="radio-inline text-gray">
    ...
    <div class="form-group" id="Q8W2S10"
              ...
              if(isset($data['Q8W2']))
                ...
                >
      <label><span class="cube">6(h)</span>What is the trend of groundwater level in your school across the year? </label>
      <div class="form-group">
        <ul>
          <li>
            <label class="radio-inline text-gray">
    ...
    <div class="form-group" id="Q8W2S13"
              ...
              if(isset($data['Q8W2']))
                ...
                >
      <label><span class="cube">6(i)</span>If your school's RWH structure is more than a year old, is there any improvement in the groundwater quality after the implementation of the RWH structure?</label>
      <div class="form-group">
        <label class="radio-inline text-gray">
    ...
    <div class="form-group" id="Q8W2S6"
              ...
              if(isset($data['Q8W2']))
                ...
                >
      <label><span class="cube">6(a)</span> Calculate your school’s rainwater harvesting potential (in litres).</label>
    ...
    <div class="form-group">
      ...
      Roof top potential (cu.m ) = Rooftop area (in sq m) x mm (if in mm then convert to m) of rainfall x 0.85<br>
      Paved potential (cu.m.) = Paved area (sq m) x mm (if in mm then convert to m) of rainfall x 0.70<br>
      Unpaved potential (cu.m.) = Unpaved area (sq m) x mm (if in mm then convert to m) of rainfall x 0.30<br>
      <b>Maximum rainwater harvesting potential of the school</b>= Maximum Rooftop potential ___(cu.m) + Maximum Paved potential__ (cu.m) + Maximum Unpaved potential ______(cu.m)<br>
      Run-off coefficient is the amount of rainwater retained in an area and mainly dependent on roof type and catchment.<br>
      <div class="form-group ">
        ...
        <br>
        Note: *For Average Rainfall Data refer to Knowledge Bank: <a href="http://www.greenschoolsprogramme.org" target="_blank">www.greenschoolsprogramme.org</a><br>
      </div>
    </div> <br>
    <div class="form-group">
      <label>
    ...
    <br>
    <div class="form-group">
      <label class="control-label"><span class="cube">7</span>Please share details about sanitation and hygiene practices in your school: </label>
      <div class="form-group">
    ...
    <br>
    <div class="form-group">
      <label><span class="cube">10</span>How many ablution taps (taps used for washing hands only) do you have?</label>
    ...
    <br>
    <div class="form-group">
      <label  class="control-label"><span class="cube">11</span>How many water closets (used for defecation and urination) do you have?</label>
      <div class="form-group row">
        <div class="col-xs-2">
      ...
      <div class="form-group">
        <label><span class="cube">12</span>How many urinals (strictly used for urination only) do you have?</label>
      ...
      <div class="form-group">
        <label><span class="cube">13</span>How many other water outlets (example: taps in play fields, sprinklers, swimming pool) do you have?</label>
    ...
    <div class="form-group">
      <label  class="control-label"><span class="cube">14</span>Is there a water storage system in place to supply water in the toilets?</label>
      <div class="form-group">
        <label class="radio-inline text-gray">
    ...
    <div class="form-group">
      <label  class="control-label"><span class="cube">15</span>Is the water supply sufficient?</label>
      <div class="form-group">
        <label class="radio-inline text-gray">
    ...
    <?php
        ...
        <?php }} else {?>
            ...
            <?php } ?>
    <label class="control-label"><span class="cube">16(a)</span>If yes, please specify</label>
      <div class="form-group">
        <ul>
          <li>
            <label class="radio-inline text-gray">
    ...
    <div class="form-group">
      <label  class="control-label"><span class="cube">17</span>Does your school treat wastewater?</label>
      <div class="form-group">
        <label class="radio-inline text-gray">
    ...
    <div class="form-group">
      <label  class="control-label"><span class="cube">18</span>Does your school reuse the treated wastewater?</label>
      <div class="form-group">
        <label class="radio-inline text-gray">
    ...
    <?php
        ...
        <?php }} else {?>
            ...
            <?php } ?>
      <label class="control-label"><span class="cube">18(a)</span>How does your school reuse wastewater?</label>
      <div class="form-group">
        <ul>
          <li>
            <label class="radio-inline text-gray">
          ...
          <li>
            <label class="radio-inline text-gray">
            <input type="radio" name="Q20W2" value="<?php echo set_value('Q20W2',2)?>" <?php if(isset($data['Q20W2'])) echo $data['Q20W2'] == 2?"checked":"" ?>>
            Flushing</label>
          </li>
          <li>
            <label class="radio-inline text-gray">
            <input type="radio" name="Q20W2" value="<?php echo set_value('Q20W2',3)?>" <?php if(isset($data['Q20W2'])) echo $data['Q20W2'] == 3?"checked":"" ?>>
    ...
    <?php
      ...
      <div class="form-group">
        <ul>
          <li>
            <label class="radio-inline text-gray">
            <input type="radio" name="Q20W3" value="<?php echo set_value('Q20W3',1)?>" <?php if(isset($data['Q20W3'])) echo $data['Q20W3'] == 1?"checked":"" ?>>
            Wastewater flows directly to the drains </label>
          </li>
          <li>
            <label class="radio-inline text-gray">
            <input type="radio" name="Q20W3" value="<?php echo set_value('Q20W3',2)?>" <?php if(isset($data['Q20W3'])) echo $data['Q20W3'] == 2?"checked":"" ?>>
            Used for groundwater recharge </label>
          </li>
          <li>
            <label class="radio-inline text-gray">
            <input type="radio" name="Q20W3" value="<?php echo set_value('Q20W3',3)?>" <?php if(isset($data['Q20W3'])) echo $data['Q20W3'] == 3?"checked":"" ?>>
    ...
    <div class="form-group">
      <label>Please upload a flow chart (hand drawn) of the wastewater treatment process.</label><br/>
      <button class="btn uploadbtn upload" data-id="Water Treatment Process" data-toggle="modal" data-target="#airModal" type="button">UPLOAD FILES</button>
      <br>
      </label>
    </div>
