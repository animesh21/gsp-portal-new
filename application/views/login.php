  ...
  <div class="main" role="main">
    <div id="jhead">
      <header class="hdr-hdr">
        <div class="container">
          <figure class="logo"><img src="<?php echo base_url(''); ?>assets/img/logo.png" class="img-responsive" id="logo" alt="CSE GSP"></figure>
          <img src="<?php echo base_url(''); ?>assets/img/top-bnr2.png" alt="" class="top-bnr img-responsive" id="image"> </div>
      </header>
    </div>
...
.mform { display: none; }
    ...
    <div class="home_container">
      <div class="mform" style="display: block;">
        <h1>Please Log In</h1>
        <p>The <a href="http://studio-tesseract.co/greenschool/" target="_blank">Green Schools Programme</a> audit is only open to registered schools. If you  have already registered, please log in using your registered email id and  password you would have received via email. </p>
        <p>If you would like to register, please visit our <a href="<?php echo base_url('login/register') ?>" target="_blank">registration page.</a></p>
        ...
        <div class="form-group"> <?php echo form_error('email'); ?>
          <input type="text" class="form-control" name="email" placeholder="Enter Coordinator’s Email" autofocus="" value="<?php echo set_value('email'); ?>" />
        </div>
        <div class="form-group"> <?php echo form_error('password'); ?>
          <input type="password" class="form-control" name="password" placeholder="Password" value="<?php echo set_value('password'); ?>" />
          <p> <a class="lptext" title="Forgot Password Form" href="javascript:void(0)" rel="shadowbox;" width="580" height="360" data-toggle="modal" data-target="#myModal">Forgot password?</a></p>
        </div>
        <div class="btn-group">
      ...
      <noscript>
      &lt;p class="disabled"&gt;This Audit requires Javascript to be enabled in your browser. Please enable Javascript and try again.&lt;/p&gt;
      </noscript>
    </div>
    <p class="m-browser">Please use a modern browser such as <a href="https://www.mozilla.org/en-US/firefox/new/" target="_blank">Firefox</a> or <a href="https://www.google.com/chrome/" target="_blank">Chrome</a> to take the audit. This audit requires Javascript to be enabled in your browser and will not function properly without it.</p>
  </div>
</div>
<!--</div>-->
<footer>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <input type="text" name="email_id" id="email_id" class="form-control" style="border-radius:0px; height:40px;" />
        </div>
      </div>
