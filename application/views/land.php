    ...
    <div class="content-form">
        ...
        <div class="intro"><h1>LAND</h1>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label"><span class="cube">1</span> Total Green Cover <a class="tt"
                                                                                                  data-tooltip="Ideally, total green landscaped area on-ground available in school should be 30 per cent of total site area (in square meters). Also, total green area on exposed roof &amp; terraces should be 50 per cent of the total area of exposed roof &amp; terrace (in square meters). "><span
                    ...
                    <label for="exampleInputEmail1">
                        <div class="question-text">
                            ...
                            <ol>
                                ...
                                <li> Once established, have the potential to out-compete native species in the wild.
                                </li>
                            </ol>
                        </div>
                    </label>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        (.doc, .docx), Image File (.jpg, .jpeg). File size per document should not exceed 500 KB.
                    </div>
                    <br/>
                    <button class="btn uploadbtn upload" data-id="Green Cover" data-toggle="modal"
