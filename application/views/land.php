    ...
    <div class="content-form">
        <div class="log-nav">
            <div class="welcome">Welcome, <span
                        style="font-weight:bold"><?php echo $this->session->userdata('USERNAME'); ?></span>
            </div>
            <ul>
                ...
                <li>
                    <a href="/audit2016/upload/templates/tfr_responsive/regist.php">Logout</a>
                </li>
                <li>|</li>
        ...
        <div id="pprg" class="newprog progress" style="text-align:center">
            <div id="samplt" class="fin-prog progress-bar" role="progressbar"
                 style="width:40%; height: 35px;">40%
            </div>
        </div>
        <div class="intro">
            <h1>LAND</h1>
            <div class="video"><a class="lptext" href="#" data-toggle="modal"
                            ...
                            style="width: 45px; height: 40px; margin-top:47px;"></a>
            </div>
        ...
        <div class="form-group1 row">
            ...
            <div class="col-xs-5">
                ...
                ?>
                <input class="form-control space-textbox" id="Q4L1"
                       onkeyup="BuildUpArea()"
        ...
        <div class="form-group1 row">
            <div class="col-xs-5">
                <label><strong class="bold">(i)</strong> Roof and terrace area
                </label>
            </div>
            <div class="col-xs-5">
            ...
            <table class="table" style="width:700px;">
                ...
                <tr>
                    ...
                    <td><input class="form-control" id="Q5L1S3" type="number"
                               ...
                               value="<?php echo set_value('Q5L1S3'); ?>"
                               readonly/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td><input class="form-control" id="Q5L2S3" type="number"
                               ...
                               value="<?php echo set_value('Q5L2S3'); ?>"
                               readonly/>
                    </td>
                </tr>
            </table>
