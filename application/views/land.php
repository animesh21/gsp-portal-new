...
<div class="container">
    <div class="content-form">
        ...
        <div class="form-group">
            ...
            <br>
            Your school gardener is certainly the best person to be a part of your audit team. Make sure your
            biology or geography teacher joins your team. Just like all other teams, five to 10 of your committed
            and interested schoolmates would make a strong team. Try and involve some students of the photography or
        ...
        <div class="form-group">
            <label>
                <div class="question-text">
                    <h6> Task 2: Measure the critical areas of your school campus</h6>
                    <strong>To find out the land/ site area of your school, you need to measure:</strong>
                    <p> 1. Ground coverage area includes all permanent structure building, such as
                        administration block, auditorium, school building, etc. It does not include floors.</p>
                    <p> 2. Green cover or green, landscaped area on ground includes areas covered by grass,
                        trees, lawn or horticulture, flower beds, grasscrete paver tiles, etc.</p>
                    <p> 3. Surface parking area refers to any parking lots directly on land.</p>
                    <p> 4. Play areas that are paved / concrete include outdoor playfields, such as basketball
                        courts, skating rinks, assembly grounds and swimming pools. </p>
                    <p> 5. Play area covered by grass on ground include grass tennis-courts and circket or
                        football grounds. </p>
                    <p> 6. Service area on ground is any area on ground that is not a permanent structure but is
                        dedicated to service, such as cooling towers for air conditioning, generators and
                        portable cabin for security guards, etc. </p>
                    <p> 7. Roof and terrace area: A roof is the covering on the uppermost part of a building. A
                        terrace is an outdoor, occupiable extension of a building above ground level.</p>
                    <p> 8. Green cover on terraces/ balconies includes terrace gardens but not potted
                        plants.</p>
                    <p> 9. Total built-up/constructed area refers to the total area of all floors of the
                        building, including ground floors of built-up spaces, which include classrooms, labs,
                        staff rooms, office area, auditoriums, corridors, and balconies and terraces, multiplied
                        by the number of floors.</p>
                    <p> 10. Other will include paved paths and other open area that your school has but is not
        ...
        <div class="form-group">
            <label><span class="cube">1A</span>Total green cover <a class="tt" data-tooltip="Ideally, green area on ground should be 35 per cent of the total site area, out of which 15 per cent should be from green landscape area on ground."><span
                            class="badge">?</span></a> </label>
        </div>
        <div class="form-group1 row">
            <div class="col-xs-5">
                <label><strong class="bold">(a)</strong> Ground coverage area</label>
            </div>
            <div class="col-xs-5">
        ...
        <div class="form-group1 row">
            <div class="col-xs-5">
                <label><strong class="bold">(c)</strong> Play area that is paved/concrete on ground</label>
            </div>
            <div class="col-xs-5">
        ...
        <div class="form-group1 row">
            <div class="col-xs-5">
                <label><strong class="bold">(d)</strong> Surface parking area</label>
            </div>
            <div class="col-xs-5">
        ...
        <div class="form-group1 row">
            <div class="col-xs-5">
                <label><strong class="bold">(ii)</strong> Green cover on exposed roof and terrace</label>
            </div>
            <div class="col-xs-5">
        ...
        <div class="form-group1 row">
            <div class="col-xs-5">
                <label><strong class="bold">(iii)</strong> Total built-up/constructed area</label>
            </div>
            <div class="col-xs-5">
        ...
        <div class="form-group1 row">
            ...
            <div class="col-xs-5">
                <input class="form-control space-textbox" id="Q4L12" type="number" min="0" name="Q4L12"
                       placeholder="<?php if (isset($data['Q4L12'])) echo $data['Q4L12']; else echo $placeholder_Default; ?>"
        ...
        <div class="form-group">
            <label for="exampleInputEmail1">
                <div class="question-text">
                    ...
                    <p> This task will help you to understand the number and variety of plants and animals that
                        your school campus supports. Identify and count the various species of plants and
                        animals in your school.</p>
                    <p><strong>To collect data:</strong></p>
                    <p> Make two teams of students. One for plant species and the other for animal species. Get
                        the school gardener and the biology teacher to accompany them. Count plant species and
                        animal species that are visible to the naked eye.</p>
                    <p> Native (definition): a species that occurs naturally within a region, either evolving
                        there or arriving and becoming established without human assistance</p>
                    <p> Exotic (definition): An exotic plant or animal, which is invasive, is a species that
        ...
        <div class="form-group">
            <label class="control-label"><span class="cube">2</span>How many species of plants and animals exist
            ...
            <table class="table" style="width:700px;">
                ...
                <tr>
                    ...
                    <td><input class="form-control" onKeyUp="computeAnimal()" id="Q5L1S1"
                               type="number" min="0" name="Q5L1S1"
                               placeholder="<?php if (isset($data['Q5L1S1'])) echo $data['Q5L1S1'] ?>"
                               value="<?php echo set_value('Q5L1S1'); ?>"/>
                    </td>
                    <td><input class="form-control" onKeyUp="computeAnimal()" id="Q5L1S2"
                               type="number" min="0" name="Q5L1S2"
                               placeholder="<?php if (isset($data['Q5L1S2'])) echo $data['Q5L1S2'] ?>"
                               value="<?php echo set_value('Q5L1S2'); ?>"/>
                    </td>
                    <td><input class="form-control" id="Q5L1S3" type="number" min="0"
                               name="Q5L1S3"
                               placeholder="<?php if (isset($data['Q5L1S3'])) echo $data['Q5L1S3'] ?>"
                               value="<?php echo set_value('Q5L1S3'); ?>" readonly/>
                    </td>
                </tr>
                <tr>
                    <td><label>Animals</label>
                    </td>
                    <td><input class="form-control" onKeyUp="computeAnimal()" id="Q5L2S1"
                               type="number" min="0" name="Q5L2S1"
                               placeholder="<?php if (isset($data['Q5L2S1'])) echo $data['Q5L2S1'] ?>"
                               value="<?php echo set_value('Q5L2S1'); ?>"/>
                    </td>
                    <td><input class="form-control" onKeyUp="computeAnimal()" id="Q5L2S2"
                               type="number" min="0" name="Q5L2S2"
                               placeholder="<?php if (isset($data['Q5L2S2'])) echo $data['Q5L2S2'] ?>"
                               value="<?php echo set_value('Q5L2S2'); ?>"/>
                    </td>
                    <td><input class="form-control" id="Q5L2S3" type="number" min="0"
                               name="Q5L2S3"
                               placeholder="<?php if (isset($data['Q5L2S3'])) echo $data['Q5L2S3'] ?>"
                               value="<?php echo set_value('Q5L2S3'); ?>" readonly/>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="form-group">
            <label class="control-label"><span class="cube">3</span>Do you use chemical-based pesticides in
        ...
        <div class="form-group">
            ...
            (.doc, .docx), Image File (.jpg, .jpeg). File size per document should not exceed 500 KB. </div>
...
<div id="videoModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content" style="background:transparent; border-radius:0px;">
            ...
            <iframe width="100%" height="330px" id="video" src="https://www.youtube.com/embed/todM6wToHHQ"
