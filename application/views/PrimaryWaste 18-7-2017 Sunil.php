  ...
  <div class="form-group row">
    ...
    <div class="col-xs-3">
      <input class="form-control space-textbox" id="ex3" type="text" name="Q3Wa10S3" placeholder="<?php if(isset($data['Q3Wa10S3'])) echo $data['Q3Wa10S3'] ?>" value="<?php echo set_value('Q3Wa10S3'); ?>"/>
            ...
            <div class="form-group">
              <label>Task 2: What is the waste segregation system in your school?</label>
              <br>
              ...
              <b>To collect data:</b> Students will have to survey the waste collection area and talk to the house-keeping staff to know whether waste is segregated in the school.
...
<div class="form-group">
  <label>Task 4: Does your school treat/recycle waste? </label>
  <br>
...
if(isset($data['Q8Wa1']))
  if($data['Q8Wa1'] == 'Y')
  {
    ...
    <div class="form-group row">
      <div class="col-xs-6">
        <label >Garden waste/ Horticultural waste 
        </label> 
      </div>
      <div class="col-xs-3">
...
<div class="col-xs-3">
    ...
    <div class="form-group row">
      <div class="col-xs-6">
        <label >Wood, glass, metal, classroom furniture 
        </label> 
      </div>
      <div class="col-xs-3">
    ...
    <div class="form-group row">
      <div class="col-xs-6 space-textbox">
        <label >Construction and Demolition (C & D) waste
        </label> 
      </div>
      <div class="col-xs-3">
...
if(isset($data['Q13Wa1']))
  ...
  <div class="form-group">
    <label>Task 5: How does your school dispose of waste?</label>
    <br>
  </div><br>
...
<div class="form-group">
  <label>Task 6: School’s initiatives</label>
  <br>
...
<div class="form-group" id="WastePolicy" style="display: none;">
  ...
  <input type="file" name="" class="org-btn"> 
</div>    
...
<input type="submit" class="submit button" id="movenextbtn" /></div>
<?php echo form_close(); ?>
