...
<div class="container">
  <div class="content-form">
      ...
      <div class="form-group">
        <ul>
          <li>
            ...
            <label class="text-gray">Ground waster (Borewell and handpump)</label>
          </li>
          <li>
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        <label class="radio-inline text-gray col-xs-10">Do you use soap to wash hands before and after using toilets</label>
        <label class="radio-inline text-gray">
