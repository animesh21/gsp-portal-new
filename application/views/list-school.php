...
<script type="text/javascript">
                ...
                $('#example1').dataTable({
                 "bProcessing": true,
                 "sAjaxSource": "<?php echo base_url("/download/getSchoolData");?>",
                 "aoColumns": [
				        { mData: 'sr_no'},
				        { mData: 'id' },
                        { mData: 'name' },
                        ...
                        "render": function(data,type,row,meta) { 
						   var a='<a class="btn btn-danger" href="<?php echo base_url("downloadLogin"); ?>" title="View Responses">View Record</a>'; 
                            return a;
							}
						}
                ]
