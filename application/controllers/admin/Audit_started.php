...
public function filter_email() {
   ...
   $byMail = $this->input->post('email');
    ...
    $query = "SELECT d.id, a.udise, a.userid, a.name, d.address1, d.address2, d.pincode, d.country_code, d.std, d.telephone, d.password, d.date_added, d.principle_name, d.mobile, d.coname, d.coemail, a.country, a.state, a.district, a.city, a.progress, a.Q1S1, a.Q2G1, a.Q9G1, $filed, b.name AS state_name, c.name AS district_name,a.remark FROM tbl_sendmail AS a LEFT JOIN states AS b ON a.state=b.id LEFT JOIN cities AS c ON a.district=c.id LEFT JOIN gsp_school AS d ON a.userid=d.userid  WHERE ";
    $conditions = array();
    //State
    if (!empty($byState)) {
