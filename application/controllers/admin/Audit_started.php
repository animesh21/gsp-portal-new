...
class Audit_started extends CI_Controller {
   ...
   public function filter_email() {
	...
	$byAlphabate = $this->input->post('alphabate');
     ...
     $query = "SELECT a.date_added,a.address1,a.address2,a.pincode,a.std,a.schoolemail,a.principle_name,a.coemail,a.comobile,a.password,a.mobile,a.principle_name,a.id,a.Q3G1,a.Q1S1,a.Q2G1,a.Q9G1, a.udise, a.userid,a.country, a.name, a.city, a.progress, $filed, b.name AS state_name, c.name AS district_name, a.remark, a.phase FROM gsp_school AS a LEFT JOIN states AS b ON a.state=b.id LEFT JOIN cities AS c ON a.district=c.id  WHERE"; 
	$conditions = array();
