...
$output = "";
$table = "lime_tokens_266617_2017"; // Enter Your Table Name 
...
$k ++;
   ...
   $output .='"'.$sql_statename['name'].'",';
    ...
    //$output .='"'.date('d-m-Y H:i:s', strtotime($row['datetime'])).'",';
		$output .='"'.date('Y-m-d', strtotime($row['datetime'])).'",';
    $output .='"'.$completeness.'%",';
    $output .="\n";
}
...
$filename = "Complete_RegData2017_('".date('d-m-Y')."').csv";
