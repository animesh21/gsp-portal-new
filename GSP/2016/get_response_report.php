...
function getResponseHtml($token)
{
//$token = $_REQUEST['id'];

$sql_data = mysql_fetch_assoc(mysql_query("SELECT * FROM lime_survey_266617 WHERE `token` = '" . $token . "'"));
...
$html .='</span></p>
	...
	<div class="address-wrap">
		...
		<div class="address">
			<p class="gsp-head">Green Schools Programme</p>
                                                        <p class="cse-head">Centre for Science and Environment</p>
...
$html .='<h2 class="heading section air page_break"><img src="images/air.png" width="94" height="94">Air</h2>';
...
if($sql_data['266617X4X2409SQ001_SQ001']!='' && $sql_data['266617X4X2409SQ001_SQ001']!='' )
{
$html .='<tr><td>1.</td><td>' . $sql_data['266617X4X2409SQ001_SQ001'] . '</td> <td>' . $sql_data['266617X4X2409SQ001_SQ001'] . '</td></tr>';
}
if($sql_data['266617X4X2409SQ002_SQ001']!='' && $sql_data['266617X4X2409SQ002_SQ002']!='' )
{
$html .='<tr><td>2.</td><td>' . $sql_data['266617X4X2409SQ002_SQ001'] . '</td> <td>' . $sql_data['266617X4X2409SQ002_SQ002'] . '</td></tr>';
}
if($sql_data['266617X4X2409SQ003_SQ001']!='' && $sql_data['266617X4X2409SQ003_SQ002']!='' )
{
...
if($sql_data['266617X4X2411SQ001_SQ001']!='')
{
...
if($sql_data['266617X4X2411SQ002_SQ001']!='')
{
...
if($sql_data['266617X4X2411SQ003_SQ001']!='')
{
...
if($sql_data['266617X4X2411SQ004_SQ001']!='')
{
...
if($sql_data['266617X4X2411SQ005_SQ001']!='')
{
...
if($sql_data['266617X4X2411SQ006_SQ001']!='')
{
...
if($sql_data['266617X4X2411SQ007_SQ001']!='')
{
...
if($sql_data['266617X4X2411SQ008_SQ001']!='')
{
...
if($sql_data['266617X4X2411SQ009_SQ001']!='')
{
...
if($sql_data['266617X4X2411SQ010_SQ001']!='')
{
...
$html .='</td>
                        ...
                        $html .='</ul>';
$html .='<h3 class="task">Task  3: How eco-friendly are the vehicles in your school?</h3>';
...
if ($sql_data['266617X4X2670_filecount'] > 0) {
    $q = 0;
    $html .='<li><div class="support_files_head">
    ...
    $html .='<li><div class="support_files">';
...
$html .='<h3 class="task">Task 4: How do you travel to school every day?</h3>';
$html .='<li>
...
$html .='<h3 class="task">Task 5: How good is the air you breathe in your school?</h3>';
				$html .='<ul class="list"><li>
...
$html .='<h2 class="heading section energy page_break"><img src="images/energy.png" width="94" height="94">Energy</h2>';
...
$html .='<div class="answer clearfix">
			...
			<table class="audit-team">
<tr><th>Sno.</th><th>Name</th> <th>Email</th></tr>';
if($sql_data['266617X8X2491SQ001_SQ001']!='' && $sql_data['266617X8X2491SQ001_SQ002']!='')
{
$html .='<tr><td>1.</td><td>' . $sql_data['266617X8X2491SQ001_SQ001'] . '</td> <td>' . $sql_data['266617X8X2491SQ001_SQ002'] . '</td></tr>';
}
if($sql_data['266617X8X2491SQ002_SQ001']!='' && $sql_data['266617X8X2491SQ002_SQ002']!='')
{
$html .='<tr><td>2.</td><td>' . $sql_data['266617X8X2491SQ002_SQ001'] . '</td> <td>' . $sql_data['266617X8X2491SQ002_SQ002'] . '</td></tr>';
}
if($sql_data['266617X8X2491SQ003_SQ001']!='' && $sql_data['266617X8X2491SQ003_SQ002']!='')
{
...
$html .='<table class="audit-team">
<tr><th>Sno.</th><th>Name</th> <th>Email</th> <th>Grade/Class</th></tr>';
if($sql_data['266617X8X2493SQ001_SQ001']!='')
{
...
if($sql_data['266617X8X2493SQ002_SQ001']!='')
{
...
if($sql_data['266617X8X2493SQ003_SQ001']!='')
{
...
if($sql_data['266617X8X2493SQ004_SQ001']!='')
{
...
if($sql_data['266617X8X2493SQ005_SQ001']!='')
{
...
if($sql_data['266617X8X2493SQ006_SQ001']!='')
{
...
if($sql_data['266617X8X2493SQ007_SQ001']!='')
{
...
if($sql_data['266617X8X2493SQ008_SQ001']!='')
{
...
if($sql_data['266617X8X2493SQ009_SQ001']!='')
{
...
if($sql_data['266617X8X2493SQ010_SQ001']!='')
{
...
$html .='<h3 class="task">Task 2: How much energy does your school consume?</h3>';	
	   $html .='<ul class="list">
			<li>
...
$html .='<li>
				<p class="orange"><span>4</span><span>What appliances does your school have?</span></p>
				<table class="table">
					<tr>
						<th></th>
						<th>Number</th>
...
$html .='<h3 class="task">Task 3: Is your school using any renewable sources of energy?</h3>';
...
if ($sql_data['266617X8X2634_filecount'] > 0) {
    $q = 0;
    $html .='<li><div class="support_files_head"><h5>Supporting Documents</h5></div>
		<ol class="support-docs">';
    if ($sql_data['266617X8X2634_filecount'] > 0) {
...
$html .='<h2 class="heading section food page_break"><img src="images/food.png" width="94" height="94">Food</h2>';
...
$html .='<div class="answer clearfix">
			...
			<table class="audit-team">
<tr><th>Sno.</th><th>Name</th> <th>Email</th></tr>';
if($sql_data['266617X36X2501SQ001_SQ001']!='' && $sql_data['266617X36X2501SQ001_SQ002']!='' )
{
$html .='<tr><td>1.</td><td>' . $sql_data['266617X36X2501SQ001_SQ001'] . '</td> <td>' . $sql_data['266617X36X2501SQ001_SQ002'] . '</td></tr>';
}
if($sql_data['266617X36X2501SQ002_SQ001']!='' && $sql_data['266617X36X2501SQ002_SQ002']!='' )
{
$html .='<tr><td>2.</td><td>' . $sql_data['266617X36X2501SQ002_SQ001'] . '</td> <td>' . $sql_data['266617X36X2501SQ002_SQ002'] . '</td></tr>';
}
if($sql_data['266617X36X2501SQ003_SQ001']!='' && $sql_data['266617X36X2501SQ003_SQ002']!='' )
{
...
if($sql_data['266617X36X2503SQ001_SQ001']!='')
{
...
if($sql_data['266617X36X2503SQ002_SQ001']!='')
{
...
if($sql_data['266617X36X2503SQ003_SQ001']!='')
{
...
if($sql_data['266617X36X2503SQ004_SQ001']!='')
{
...
if($sql_data['266617X36X2503SQ005_SQ001']!='')
{
...
if($sql_data['266617X36X2503SQ006_SQ001']!='')
{
...
if($sql_data['266617X36X2503SQ007_SQ001']!='')
{
...
if($sql_data['266617X36X2503SQ008_SQ001']!='')
{
...
if($sql_data['266617X36X2503SQ009_SQ001']!='')
{
...
if($sql_data['266617X36X2503SQ010_SQ001']!='')
{
...
$html .='<h3 class="task">Task 2: Find out about the food service in your school.</h3>';
$html .='<ul class="list">
			<li>
 ...
 */
$html .='<h3 class="task">Task 3: What kind of food is served/sold in your school</h3>';
$html .='<ul class="list"><li>
...
$html.='</ul>';
 $html .='<h3 class="task">Task 4: What kind of food does your school promote?</h3>';
$html .='<ul class="list"><li>
...
$html .='<h2 class="heading section land page_break"><img src="images/land.png" width="94" height="94">Land</h2>';
...
$html .='<div class="answer clearfix">
			...
			<table class="audit-team">
<tr><th>Sno.</th><th>Name</th> <th>Email</th></tr>';
if($sql_data['266617X7X2526SQ001_SQ001']!='' && $sql_data['266617X7X2526SQ001_SQ002']!='' )
{
$html .='<tr><td>1.</td><td>' . $sql_data['266617X7X2526SQ001_SQ001'] . '</td> <td>' . $sql_data['266617X7X2526SQ001_SQ002'] . '</td></tr>';
}
if($sql_data['266617X7X2526SQ002_SQ001']!='' && $sql_data['266617X7X2526SQ002_SQ002']!='' )
{
$html .='<tr><td>2.</td><td>' . $sql_data['266617X7X2526SQ002_SQ001'] . '</td> <td>' . $sql_data['266617X7X2526SQ002_SQ002'] . '</td></tr>';
}
if($sql_data['266617X7X2526SQ003_SQ001']!='' && $sql_data['266617X7X2526SQ003_SQ002']!='' )
{
...
$html .='<table class="audit-team">
<tr><th>Sno.</th><th>Name</th> <th>Email</th> <th>Grade/Class</th></tr>';
if($sql_data['266617X7X2540SQ001_SQ001']!='')
{
...
if($sql_data['266617X7X2540SQ002_SQ001']!='')
{
...
if($sql_data['266617X7X2540SQ003_SQ001']!='')
{
...
if($sql_data['266617X7X2540SQ004_SQ001']!='')
{
...
if($sql_data['266617X7X2540SQ005_SQ001']!='')
{
...
if($sql_data['266617X7X2540SQ006_SQ001']!='')
{
...
if($sql_data['266617X7X2540SQ007_SQ001']!='')
{
...
if($sql_data['266617X7X2540SQ008_SQ001']!='')
{
...
if($sql_data['266617X7X2540SQ009_SQ001']!='')
{
...
if($sql_data['266617X7X2540SQ010_SQ001']!='')
{
...
$html .='<h3 class="task">Task 4: Find out if your school uses pesticides</h3>           
			';
...
$html .='</ul>
	...
	$html .='<h2 class="heading section water page_break"><img src="images/water.png" width="94" height="94">Water</h2>';
...
$html .='<div class="answer clearfix">
			...
			<table class="audit-team">
<tr><th>Sno.</th><th>Name</th> <th>Email</th></tr>';
if($sql_data['266617X37X2406SQ001_SQ001']!='' && $sql_data['266617X37X2406SQ001_SQ002']!='' )
{
$html .='<tr><td>1.</td><td>' . $sql_data['266617X37X2406SQ001_SQ001'] . '</td> <td>' . $sql_data['266617X37X2406SQ001_SQ002'] . '</td></tr>';
}
if($sql_data['266617X37X2406SQ002_SQ001']!='' && $sql_data['266617X37X2406SQ002_SQ002']!='' )
{
$html .='<tr><td>2.</td><td>' . $sql_data['266617X37X2406SQ002_SQ001'] . '</td> <td>' . $sql_data['266617X37X2406SQ002_SQ002'] . '</td></tr>';
}
if($sql_data['266617X37X2406SQ003_SQ001']!='' && $sql_data['266617X37X2406SQ003_SQ002']!='' )
{
...
$html .='<table class="audit-team">
<tr><th>Sno.</th><th>Name</th> <th>Email</th> <th>Grade/Class</th></tr>';
if($sql_data['266617X37X2408SQ001_SQ001']!='')
{
...
if($sql_data['266617X37X2408SQ002_SQ001']!='')
{
...
if($sql_data['266617X37X2408SQ003_SQ001']!='')
{
...
if($sql_data['266617X37X2408SQ004_SQ001']!='')
{
...
if($sql_data['266617X37X2408SQ005_SQ001']!='')
{
...
if($sql_data['266617X37X2408SQ006_SQ001']!='')
{
...
if($sql_data['266617X37X2408SQ007_SQ001']!='')
{
...
if($sql_data['266617X37X2408SQ008_SQ001']!='')
{
...
if($sql_data['266617X37X2408SQ009_SQ001']!='')
{
...
if($sql_data['266617X37X2408SQ010_SQ001']!='')
{
...
$html .='<h3 class="task">Task 5: Does your school harvest rainwater?</h3>';
$html .='<ul class="list"><li>
...
$html .='<h3 class="task">Task 6: Are the plumbing and sanitation facilities in your school adequate?</h3>';
...
$html .='<h3 class="task">Task 7: Does your school reuse/recycle waste water?</h3>';
...
//Start Waste Section.	
	...
	$html .='<h2 class="heading section waste page_break"><img src="images/waste.png" width="94" height="94">Waste</h2>';
...
if($sql_data['266617X38X2607SQ001_SQ001']!='' && $sql_data['266617X38X2607SQ001_SQ002']!='' )
{
$html .='<tr><td>1.</td><td>' . $sql_data['266617X38X2607SQ001_SQ001'] . '</td> <td>' . $sql_data['266617X38X2607SQ001_SQ002'] . '</td></tr>';
}
if($sql_data['266617X38X2607SQ002_SQ001']!='' && $sql_data['266617X38X2607SQ002_SQ002']!='' )
{
$html .='<tr><td>2.</td><td>' . $sql_data['266617X38X2607SQ002_SQ001'] . '</td> <td>' . $sql_data['266617X38X2607SQ002_SQ002'] . '</td></tr>';
}
if($sql_data['266617X38X2607SQ003_SQ001']!='' && $sql_data['266617X38X2607SQ003_SQ002']!='' )
{
...
if($sql_data['266617X38X2621SQ001_SQ001']!='')
{
...
if($sql_data['266617X38X2621SQ002_SQ001']!='')
{
...
if($sql_data['266617X38X2621SQ003_SQ001']!='')
{
...
if($sql_data['266617X38X2621SQ004_SQ001']!='')
{
...
if($sql_data['266617X38X2621SQ005_SQ001']!='')
{
...
if($sql_data['266617X38X2621SQ006_SQ001']!='')
{
...
if($sql_data['266617X38X2621SQ007_SQ001']!='')
{
...
if($sql_data['266617X38X2621SQ008_SQ001']!='')
{
...
if($sql_data['266617X38X2621SQ009_SQ001']!='')
{
...
if($sql_data['266617X38X2621SQ010_SQ001']!='')
{
...
$html .='<ul class="list"><li><p class="orange"><span>4</span><span>  Does your school recycle any generated waste?</span></p>
		<p>';
...
$html .='<ul class="list"><li><p class="orange"><span>12</span><span> Does the school have a policy on waste? </span></p>
		<p>';
...
// Start Feedback Section.
	...
	$html .='<h2 class="heading section waste page_break"><img src="images/waste.png" width="94" height="94">Feedback</h2>';
...
$html .='<h5> Checklist of uploaded documents</h5>';
